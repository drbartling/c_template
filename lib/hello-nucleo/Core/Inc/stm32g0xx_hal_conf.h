...
#    define HSE_VALUE                                                          \
        (8000000UL) /*!< Value of the External oscillator in Hz                \
                     */
#endif              /* HSE_VALUE */
...
#    define HSI_VALUE                                                          \
        (16000000UL) /*!< Value of the Internal oscillator in                  \
                        Hz*/
#endif               /* HSI_VALUE */
...
#    define LSE_STARTUP_TIMEOUT                                                \
        (5000UL) /*!< Time out for LSE start up, in ms */
...
#        define EXTERNAL_I2S2_CLOCK_VALUE                                      \
            12288000U /*!< Value of the I2S2 External clock source in Hz*/
