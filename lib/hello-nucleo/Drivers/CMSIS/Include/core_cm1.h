...
#                warning                                                       \
                    "__CM1_REV not defined in device header file; using default!"
#            endif
...
#        define SCnSCB_ACTLR_ITCMUAEN_Msk                                      \
            (1UL << SCnSCB_ACTLR_ITCMUAEN_Pos) /*!< ACTLR: Instruction TCM     \
                                                  Upper Alias Enable Mask */

#        define SCnSCB_ACTLR_ITCMLAEN_Pos                                      \
            3U /*!< ACTLR: Instruction TCM Lower Alias Enable Position */
#        define SCnSCB_ACTLR_ITCMLAEN_Msk                                      \
            (1UL << SCnSCB_ACTLR_ITCMLAEN_Pos) /*!< ACTLR: Instruction TCM     \
                                                  Lower Alias Enable Mask */
