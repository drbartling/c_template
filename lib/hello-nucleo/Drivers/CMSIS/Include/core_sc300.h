...
#    define __SC300_CMSIS_VERSION                                              \
        ((__SC300_CMSIS_VERSION_MAIN << 16U)                                   \
         | __SC300_CMSIS_VERSION_SUB) /*!< \deprecated CMSIS HAL version       \
                                         number */
...
#                warning                                                       \
                    "__SC300_REV not defined in device header file; using default!"
#            endif
...
typedef struct {
    ...
    __IOM uint32_t SFCR; /*!< Offset: 0x290 (R/W)  Security Features Control
                            Register */
} SCB_Type;
