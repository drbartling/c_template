 ...
 */
void
HAL_PWREx_EnableBatteryCharging(uint32_t ResistorSelection)
{
    uint32_t tmpreg;
 ...
 */
void
HAL_PWREx_DisableBatteryCharging(void)
{
 ...
 */
void
HAL_PWREx_EnablePORMonitorSampling(void)
{
 ...
 */
void
HAL_PWREx_DisablePORMonitorSampling(void)
{
    PWR->CR3 &= ~PWR_CR3_ENB_ULP;
}
...
/**
  ...
  */
HAL_StatusTypeDef
HAL_PWREx_ConfigPVD(PWR_PVDTypeDef *sConfigPVD)
{
 ...
 */
HAL_StatusTypeDef
HAL_PWREx_ConfigPVM(PWR_PVMTypeDef *sConfigPVM)
{
 ...
 */
void
HAL_PWREx_EnableInternalWakeUpLine(void)
{
 ...
 */
void
HAL_PWREx_DisableInternalWakeUpLine(void)
{
 ...
 */
HAL_StatusTypeDef
HAL_PWREx_EnableGPIOPullUp(uint32_t GPIO, uint32_t GPIONumber)
{
    HAL_StatusTypeDef status = HAL_OK;
 ...
 */
HAL_StatusTypeDef
HAL_PWREx_DisableGPIOPullUp(uint32_t GPIO, uint32_t GPIONumber)
{
    HAL_StatusTypeDef status = HAL_OK;
 ...
 */
HAL_StatusTypeDef
HAL_PWREx_EnableGPIOPullDown(uint32_t GPIO, uint32_t GPIONumber)
{
    HAL_StatusTypeDef status = HAL_OK;
 ...
 */
HAL_StatusTypeDef
HAL_PWREx_DisableGPIOPullDown(uint32_t GPIO, uint32_t GPIONumber)
{
    HAL_StatusTypeDef status = HAL_OK;
 ...
 */
void
HAL_PWREx_EnablePullUpPullDownConfig(void)
{
 ...
 */
void
HAL_PWREx_DisablePullUpPullDownConfig(void)
{
 ...
 */
void
HAL_PWREx_EnableSRAMRetention(void)
{
 ...
 */
void
HAL_PWREx_DisableSRAMRetention(void)
{
 ...
 */
void
HAL_PWREx_EnableFlashPowerDown(uint32_t PowerMode)
{
 ...
 */
void
HAL_PWREx_DisableFlashPowerDown(uint32_t PowerMode)
{
    assert_param(IS_PWR_FLASH_POWERDOWN(PowerMode));
 ...
 */
uint32_t
HAL_PWREx_GetVoltageRange(void)
{
 ...
 */
HAL_StatusTypeDef
HAL_PWREx_ControlVoltageScaling(uint32_t VoltageScaling)
{
 ...
 */
void
HAL_PWREx_EnableLowPowerRunMode(void)
{
...
/**
  ...
  */
void
HAL_PWREx_EnterSHUTDOWNMode(void)
{
    /* Set Shutdown mode */
 ...
 */
void
HAL_PWREx_PVD_PVM_IRQHandler(void)
{
 ...
 */
__weak void
HAL_PWREx_PVD_PVM_Rising_Callback(void)
{
 ...
 */
__weak void
HAL_PWREx_PVD_PVM_Falling_Callback(void)
{
    /* NOTE : This function should not be modified; when the callback is needed,
 ...
 */
__weak void
HAL_PWREx_PVD_Rising_Callback(void)
{
    /* NOTE : This function should not be modified; when the callback is needed,
              the HAL_PWR_PVD_Rising_Callback can be implemented in the user
       file
 ...
 */
__weak void
HAL_PWREx_PVD_Falling_Callback(void)
{
    /* NOTE : This function should not be modified; when the callback is needed,
              the HAL_PWR_PVD_Falling_Callback can be implemented in the user
       file
