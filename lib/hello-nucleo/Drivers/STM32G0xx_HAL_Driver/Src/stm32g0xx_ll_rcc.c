...
#            define IS_LL_RCC_LPUART_CLKSOURCE(__VALUE__)                      \
                (((__VALUE__) == LL_RCC_LPUART1_CLKSOURCE)                     \
...
#            define IS_LL_RCC_LPTIM_CLKSOURCE(__VALUE__)                       \
                (((__VALUE__) == LL_RCC_LPTIM1_CLKSOURCE)                      \
                 || ((__VALUE__) == LL_RCC_LPTIM2_CLKSOURCE))
#        endif /* LPTIM1 || LPTIM2 */

#        if defined(RNG)
#            define IS_LL_RCC_RNG_CLKSOURCE(__VALUE__)                         \
                (((__VALUE__) == LL_RCC_RNG_CLKSOURCE))
#        endif /* RNG */

#        define IS_LL_RCC_ADC_CLKSOURCE(__VALUE__)                             \
            (((__VALUE__) == LL_RCC_ADC_CLKSOURCE))

#        if defined(STM32G0C1xx) || defined(STM32G0B1xx) || defined(STM32G0B0xx)
#            define IS_LL_RCC_I2S_CLKSOURCE(__VALUE__)                         \
                (((__VALUE__) == LL_RCC_I2S1_CLKSOURCE)                        \
...
#        if defined(CEC)
#            define IS_LL_RCC_CEC_CLKSOURCE(__VALUE__)                         \
                (((__VALUE__) == LL_RCC_CEC_CLKSOURCE))
#        endif /* CEC */

#        if defined(STM32G0C1xx) || defined(STM32G0B1xx) || defined(STM32G0B0xx)
#            define IS_LL_RCC_USB_CLKSOURCE(__VALUE__)                         \
                (((__VALUE__) == LL_RCC_USB_CLKSOURCE))
#        endif /* STM32G0C1xx || STM32G0B1xx || STM32G0B0xx */

#        if defined(FDCAN1) || defined(FDCAN2)
#            define IS_LL_RCC_FDCAN_CLKSOURCE(__VALUE__)                       \
                (((__VALUE__) == LL_RCC_FDCAN_CLKSOURCE))
#        endif /* FDCAN1 || FDCAN2 */
 ...
 */
uint32_t
LL_RCC_GetUSARTClockFreq(uint32_t USARTxSource)
{
 ...
 */
uint32_t
LL_RCC_GetI2CClockFreq(uint32_t I2CxSource)
{
 ...
 */
uint32_t
LL_RCC_GetI2SClockFreq(uint32_t I2SxSource)
{
 ...
 */
uint32_t
LL_RCC_GetLPUARTClockFreq(uint32_t LPUARTxSource)
{
 ...
 */
uint32_t
LL_RCC_GetLPTIMClockFreq(uint32_t LPTIMxSource)
{
 ...
 */
uint32_t
LL_RCC_GetTIMClockFreq(uint32_t TIMxSource)
{
    ...
    case LL_RCC_RNG_CLKSOURCE_PLL: /* PLL clock used as RNG clock source */
        if (LL_RCC_PLL_IsReady() == 1U) {
            if (LL_RCC_PLL_IsEnabledDomain_RNG() == 1U) {
                ...
                rngdiv = (1UL << ((READ_BIT(RCC->CCIPR, RCC_CCIPR_RNGDIV))
                                  >> RCC_CCIPR_RNGDIV_Pos));
                rng_frequency = (rng_frequency / rngdiv);
            }
        }
        break;

    case LL_RCC_RNG_CLKSOURCE_HSI_DIV8: /* HSI clock divided by 8 used as RNG
                                           clock source */
 ...
 */
uint32_t
LL_RCC_GetCECClockFreq(uint32_t CECxSource)
{
 ...
 */
uint32_t
LL_RCC_GetFDCANClockFreq(uint32_t FDCANxSource)
{
 ...
 */
uint32_t
LL_RCC_GetADCClockFreq(uint32_t ADCxSource)
{
 ...
 */
uint32_t
LL_RCC_GetUSBClockFreq(uint32_t USBxSource)
{
...
RCC_GetSystemClockFreq(void)
{
    ...
    default:
        hsidiv =
            (1UL << ((READ_BIT(RCC->CR, RCC_CR_HSIDIV)) >> RCC_CR_HSIDIV_Pos));
 ...
 */
static uint32_t
RCC_GetHCLKClockFreq(uint32_t SYSCLK_Frequency)
{
    /* HCLK clock frequency */
 ...
 */
static uint32_t
RCC_GetPCLK1ClockFreq(uint32_t HCLK_Frequency)
{
    /* PCLK1 clock frequency */
 ...
 */
static uint32_t
RCC_PLL_GetFreqDomain_SYS(void)
{
 ...
 */
static uint32_t
RCC_PLL_GetFreqDomain_ADC(void)
{
    uint32_t pllinputfreq;
    uint32_t pllsource;
 ...
 */
static uint32_t
RCC_PLL_GetFreqDomain_FDCAN(void)
{
    uint32_t pllinputfreq;
    uint32_t pllsource;
    ...
    */
    ...
    return __LL_RCC_CALC_PLLCLK_FDCAN_FREQ(
 ...
 */
static uint32_t
RCC_PLL_GetFreqDomain_I2S1(void)
{
    uint32_t pllinputfreq;
    uint32_t pllsource;
 ...
 */
static uint32_t
RCC_PLL_GetFreqDomain_I2S2(void)
{
    uint32_t pllinputfreq;
    uint32_t pllsource;
 ...
 */
static uint32_t
RCC_PLL_GetFreqDomain_RNG(void)
{
    uint32_t pllinputfreq;
    uint32_t pllsource;
 ...
 */
static uint32_t
RCC_PLL_GetFreqDomain_USB(void)
{
    uint32_t pllinputfreq;
    uint32_t pllsource;
 ...
 */
static uint32_t
RCC_PLL_GetFreqDomain_TIM1(void)
{
    uint32_t pllinputfreq;
    uint32_t pllsource;
 ...
 */
static uint32_t
RCC_PLL_GetFreqDomain_TIM15(void)
{
    uint32_t pllinputfreq;
    uint32_t pllsource;
    ...
    */
    ...
    return __LL_RCC_CALC_PLLCLK_TIM15_FREQ(
        pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLL_GetN(),
        LL_RCC_PLL_GetQ());
}
#        endif /* RCC_CCIPR_TIM15SEL */
