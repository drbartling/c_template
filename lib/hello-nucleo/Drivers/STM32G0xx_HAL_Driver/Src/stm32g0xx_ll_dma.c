 ...
 */
ErrorStatus
LL_DMA_DeInit(DMA_TypeDef *DMAx, uint32_t Channel)
{
 ...
 */
ErrorStatus
LL_DMA_Init(DMA_TypeDef *DMAx, uint32_t Channel,
            LL_DMA_InitTypeDef *DMA_InitStruct)
{
     ...
     * direction, data transfer mode, peripheral and memory increment mode, data
     * size alignment and  priority level with parameters :
     ...
     * ------------------------- Configure the peripheral or source base address
     * with parameter :
 ...
 */
void
LL_DMA_StructInit(LL_DMA_InitTypeDef *DMA_InitStruct)
{
