 ...
 */
void
HAL_FLASHEx_EnableDebugger(void)
{
 ...
 */
void
HAL_FLASHEx_DisableDebugger(void)
{
    FLASH->ACR &= ~FLASH_ACR_DBG_SWEN;
}
 ...
 */
uint32_t
HAL_FLASHEx_FlashEmptyCheck(void)
{
 ...
 */
void
HAL_FLASHEx_ForceFlashEmpty(uint32_t FlashEmpty)
{
    uint32_t acr;
 ...
 */
void
HAL_FLASHEx_EnableSecMemProtection(uint32_t Banks)
{
#        if defined(FLASH_DBANK_SUPPORT)
 ...
 */
static void
FLASH_MassErase(uint32_t Banks)
{
    /* Check the parameters */
    assert_param(IS_FLASH_BANK(Banks));
 ...
 */
void
FLASH_PageErase(uint32_t Banks, uint32_t Page)
{
    uint32_t tmp;
 ...
 */
static void
FLASH_OB_WRPConfig(uint32_t WRPArea, uint32_t WRPStartOffset,
                   uint32_t WRDPEndOffset)
{
    /* Check the parameters */
 ...
 */
static void
FLASH_OB_GetWRP(uint32_t WRPArea, uint32_t *WRPStartOffset,
                uint32_t *WRDPEndOffset)
{
    /* Check the parameters */
    assert_param(IS_OB_WRPAREA(WRPArea));
 ...
 */
static void
FLASH_OB_OptrConfig(uint32_t UserType, uint32_t UserConfig, uint32_t RDPLevel)
{
    uint32_t optr;
 ...
 */
static void
FLASH_OB_PCROP1AConfig(uint32_t PCROPConfig, uint32_t PCROP1AStartAddr,
                       uint32_t PCROP1AEndAddr)
{
...
#        endif /* FLASH_DBANK_SUPPORT */
    ...
    if ((PCROPConfig & OB_PCROP_ZONE_A) != 0x00U) {
        ...
        startoffset =
            ((PCROP1AStartAddr - ropbase) >> FLASH_PCROP_GRANULARITY_OFFSET);
        endoffset =
            ((PCROP1AEndAddr - ropbase) >> FLASH_PCROP_GRANULARITY_OFFSET);
 ...
 */
static void
FLASH_OB_PCROP1BConfig(uint32_t PCROP1BStartAddr, uint32_t PCROP1BEndAddr)
{
    uint32_t startoffset;
    uint32_t endoffset;
    uint32_t ropbase;
...
#        endif /* FLASH_DBANK_SUPPORT */
    ...
    /* Configure the Proprietary code readout protection offset */
    startoffset =
        ((PCROP1BStartAddr - ropbase) >> FLASH_PCROP_GRANULARITY_OFFSET);
 ...
 */
static void
FLASH_OB_GetPCROP1A(uint32_t *PCROPConfig, uint32_t *PCROP1AStartAddr,
                    uint32_t *PCROP1AEndAddr)
{
    uint32_t pcrop;
    uint32_t ropbase;
 ...
 */
static void
FLASH_OB_GetPCROP1B(uint32_t *PCROP1BStartAddr, uint32_t *PCROP1BEndAddr)
{
    uint32_t pcrop;
    uint32_t ropbase;
 ...
 */
static void
FLASH_OB_PCROP2AConfig(uint32_t PCROP2AStartAddr, uint32_t PCROP2AEndAddr)
{
    uint32_t startoffset;
    uint32_t endoffset;
    uint32_t ropbase;
    ...
    /* Configure the Proprietary code readout protection offset */
    startoffset =
        ((PCROP2AStartAddr - ropbase) >> FLASH_PCROP_GRANULARITY_OFFSET);
 ...
 */
static void
FLASH_OB_PCROP2BConfig(uint32_t PCROP2BStartAddr, uint32_t PCROP2BEndAddr)
{
    uint32_t startoffset;
    uint32_t endoffset;
    uint32_t ropbase;
    ...
    /* Configure the Proprietary code readout protection offset */
    startoffset =
        ((PCROP2BStartAddr - ropbase) >> FLASH_PCROP_GRANULARITY_OFFSET);
 ...
 */
static void
FLASH_OB_GetPCROP2A(uint32_t *PCROP2AStartAddr, uint32_t *PCROP2AEndAddr)
{
    uint32_t pcrop;
    uint32_t ropbase;
 ...
 */
static void
FLASH_OB_GetPCROP2B(uint32_t *PCROP2BStartAddr, uint32_t *PCROP2BEndAddr)
{
    uint32_t pcrop;
    uint32_t ropbase;
 ...
 */
static void
FLASH_OB_SecMemConfig(uint32_t BootEntry, uint32_t SecSize, uint32_t SecSize2)
{
    uint32_t secmem;
    ...
    FLASH->SECR =
        (secmem | BootEntry | SecSize | (SecSize2 << FLASH_SECR_SEC_SIZE2_Pos));
}
 ...
 */
static void
FLASH_OB_GetSecMem(uint32_t *BootEntry, uint32_t *SecSize, uint32_t *SecSize2)
{
 ...
 */
static void
FLASH_OB_SecMemConfig(uint32_t BootEntry, uint32_t SecSize)
{
    uint32_t secmem;
 ...
 */
static void
FLASH_OB_GetSecMem(uint32_t *BootEntry, uint32_t *SecSize)
{
    uint32_t secmem = FLASH->SECR;
