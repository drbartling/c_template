 ...
 */
HAL_StatusTypeDef
HAL_RS485Ex_Init(UART_HandleTypeDef *huart, uint32_t Polarity,
 ...
 */
__weak void
HAL_UARTEx_WakeupCallback(UART_HandleTypeDef *huart)
{
 ...
 */
__weak void
HAL_UARTEx_RxFifoFullCallback(UART_HandleTypeDef *huart)
{
    /* Prevent unused argument(s) compilation warning */
    UNUSED(huart);
 ...
 */
__weak void
HAL_UARTEx_TxFifoEmptyCallback(UART_HandleTypeDef *huart)
{
    /* Prevent unused argument(s) compilation warning */
    UNUSED(huart);
 ...
 */
HAL_StatusTypeDef
HAL_UARTEx_EnableFifoMode(UART_HandleTypeDef *huart)
{
    uint32_t tmpcr1;
 ...
 */
HAL_StatusTypeDef
HAL_UARTEx_DisableFifoMode(UART_HandleTypeDef *huart)
{
    uint32_t tmpcr1;
 ...
 */
HAL_StatusTypeDef
HAL_UARTEx_ReceiveToIdle(UART_HandleTypeDef *huart, uint8_t *pData,
 ...
 */
HAL_StatusTypeDef
HAL_UARTEx_ReceiveToIdle_DMA(UART_HandleTypeDef *huart, uint8_t *pData,
                             uint16_t Size)
{
    HAL_StatusTypeDef status;
 ...
 */
static void
UARTEx_Wakeup_AddressConfig(UART_HandleTypeDef *huart,
                            UART_WakeUpTypeDef  WakeUpSelection)
{
 ...
 */
static void
UARTEx_SetNbDataToProcess(UART_HandleTypeDef *huart)
{
