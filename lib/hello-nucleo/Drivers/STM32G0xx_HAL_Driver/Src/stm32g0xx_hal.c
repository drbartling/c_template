...
#    define __STM32G0xx_HAL_VERSION_RC                                         \
        (0x00U) /*!< [7:0]  release candidate                                  \
                 */
#    define __STM32G0xx_HAL_VERSION                                            \
        ((__STM32G0xx_HAL_VERSION_MAIN << 24U)                                 \
 ...
 */
void
HAL_DBGMCU_EnableDBGStopMode(void)
{
 ...
 */
void
HAL_DBGMCU_DisableDBGStopMode(void)
{
 ...
 */
void
HAL_DBGMCU_EnableDBGStandbyMode(void)
{
 ...
 */
void
HAL_DBGMCU_DisableDBGStandbyMode(void)
{
 ...
 */
void
HAL_SYSCFG_EnableIOAnalogSwitchBooster(void)
{
 ...
 */
void
HAL_SYSCFG_DisableIOAnalogSwitchBooster(void)
{
 ...
 */
void
HAL_SYSCFG_EnableRemap(uint32_t PinRemap)
{
    /* Check the parameter */
 ...
 */
void
HAL_SYSCFG_DisableRemap(uint32_t PinRemap)
{
    /* Check the parameter */
    assert_param(IS_HAL_REMAP_PIN(PinRemap));
 ...
 */
void
HAL_SYSCFG_EnableClampingDiode(uint32_t PinConfig)
{
    /* Check the parameter */
 ...
 */
void
HAL_SYSCFG_DisableClampingDiode(uint32_t PinConfig)
{
    /* Check the parameter */
    assert_param(IS_SYSCFG_CLAMPINGDIODE(PinConfig));
