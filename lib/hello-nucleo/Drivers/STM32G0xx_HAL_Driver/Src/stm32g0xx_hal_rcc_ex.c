 ...
 */
void
HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit)
{
    /* Set all possible values for the extended clock type
     * parameter------------*/
    PeriphClkInit->PeriphClockSelection =
        RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2S1
        | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_RTC;

#    if defined(RCC_CCIPR_LPTIM1SEL) && defined(RCC_CCIPR_LPTIM2SEL)
    PeriphClkInit->PeriphClockSelection |=
        RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_LPTIM1;
 ...
 */
void
HAL_RCCEx_EnableLSCO(uint32_t LSCOSource)
{
 ...
 */
void
HAL_RCCEx_CRSConfig(RCC_CRSInitTypeDef *pInit)
{
 ...
 */
void
HAL_RCCEx_CRSSoftwareSynchronizationGenerate(void)
{
 ...
 */
__weak void
HAL_RCCEx_CRS_SyncOkCallback(void)
{
 ...
 */
__weak void
HAL_RCCEx_CRS_SyncWarnCallback(void)
{
    /* NOTE : This function should not be modified, when the callback is needed,
 ...
 */
__weak void
HAL_RCCEx_CRS_ExpectedSyncCallback(void)
{
    /* NOTE : This function should not be modified, when the callback is needed,
 ...
 */
__weak void
HAL_RCCEx_CRS_ErrorCallback(uint32_t Error)
{
