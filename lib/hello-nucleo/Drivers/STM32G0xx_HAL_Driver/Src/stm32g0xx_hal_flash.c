 ...
 */
static void
FLASH_Program_DoubleWord(uint32_t Address, uint64_t Data)
{
    /* Set PG bit */
 ...
 * @retval None
 */
static __RAM_FUNC void
FLASH_Program_Fast(uint32_t Address, uint32_t DataAddress)
{
    uint8_t  index = 0;
