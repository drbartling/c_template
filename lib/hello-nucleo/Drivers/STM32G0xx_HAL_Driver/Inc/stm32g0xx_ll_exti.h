...
/* Private variables ---------------------------------------------------------*/
/* Private constants ---------------------------------------------------------*/
#    define LL_EXTI_REGISTER_PINPOS_SHFT                                       \
        16u /*!< Define used to shift pin position in EXTICR register */
...
#        if defined(STM32G081xx) || defined(STM32G071xx)                       \
            || defined(STM32G0C1xx) || defined(STM32G0B1xx)                    \
            || defined(STM32G0B0xx)
...
#    define LL_EXTI_LINE_ALL_0_31                                              \
        EXTI_IMR1_IM /*!< All Extended line not reserved*/
...
#    if defined(EXTI_IMR2_IM32) || defined(EXTI_IMR2_IM33)                     \
        || defined(EXTI_IMR2_IM34) || defined(EXTI_IMR2_IM35)                  \
        || defined(EXTI_IMR2_IM36)
#        define LL_EXTI_LINE_ALL_32_63                                         \
            EXTI_IMR2_IM /*!< All Extended line not reserved*/
#    endif /* EXTI_IMR2_IM32 || EXTI_IMR2_IM33 || EXTI_IMR2_IM34 ||            \
              EXTI_IMR2_IM35 || EXTI_IMR2_IM36 */
...
#        define LL_EXTI_CONFIG_PORTD                                           \
            (EXTI_EXTICR1_EXTI0_1 | EXTI_EXTICR1_EXTI0_0) /*!< EXTI PORT D */
#    endif                                                /*GPIOD_BASE*/
#    if defined(GPIOE_BASE)
#        define LL_EXTI_CONFIG_PORTE EXTI_EXTICR1_EXTI0_2 /*!< EXTI PORT E */
#    endif                                                /*GPIOE_BASE*/
#    define LL_EXTI_CONFIG_PORTF                                               \
        (EXTI_EXTICR1_EXTI0_2 | EXTI_EXTICR1_EXTI0_0) /*!< EXTI PORT F */
/**
 * @}
 */
 ...
 * @{
 */
#    define LL_EXTI_CONFIG_LINE0                                               \
        ((0uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U) /*!< EXTI_POSITION_0  |   \
                                                        EXTICR[0] */
#    define LL_EXTI_CONFIG_LINE1                                               \
        ((8uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U) /*!< EXTI_POSITION_8  |   \
                                                        EXTICR[0] */
#    define LL_EXTI_CONFIG_LINE2                                               \
        ((16uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U) /*!< EXTI_POSITION_16 |  \
                                                         EXTICR[0] */
#    define LL_EXTI_CONFIG_LINE3                                               \
        ((24uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U) /*!< EXTI_POSITION_24 |  \
                                                         EXTICR[0] */
#    define LL_EXTI_CONFIG_LINE4                                               \
        ((0uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U) /*!< EXTI_POSITION_0  |   \
                                                        EXTICR[1] */
#    define LL_EXTI_CONFIG_LINE5                                               \
        ((8uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U) /*!< EXTI_POSITION_8  |   \
                                                        EXTICR[1] */
#    define LL_EXTI_CONFIG_LINE6                                               \
        ((16uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U) /*!< EXTI_POSITION_16 |  \
                                                         EXTICR[1] */
#    define LL_EXTI_CONFIG_LINE7                                               \
        ((24uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U) /*!< EXTI_POSITION_24 |  \
                                                         EXTICR[1] */
#    define LL_EXTI_CONFIG_LINE8                                               \
        ((0uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U) /*!< EXTI_POSITION_0  |   \
                                                        EXTICR[2] */
#    define LL_EXTI_CONFIG_LINE9                                               \
        ((8uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U) /*!< EXTI_POSITION_8  |   \
                                                        EXTICR[2] */
#    define LL_EXTI_CONFIG_LINE10                                              \
        ((16uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U) /*!< EXTI_POSITION_16 |  \
                                                         EXTICR[2] */
#    define LL_EXTI_CONFIG_LINE11                                              \
        ((24uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U) /*!< EXTI_POSITION_24 |  \
                                                         EXTICR[2] */
#    define LL_EXTI_CONFIG_LINE12                                              \
        ((0uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U) /*!< EXTI_POSITION_0  |   \
                                                        EXTICR[3] */
#    define LL_EXTI_CONFIG_LINE13                                              \
        ((8uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U) /*!< EXTI_POSITION_8  |   \
                                                        EXTICR[3] */
#    define LL_EXTI_CONFIG_LINE14                                              \
        ((16uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U) /*!< EXTI_POSITION_16 |  \
                                                         EXTICR[3] */
#    define LL_EXTI_CONFIG_LINE15                                              \
        ((24uL << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U) /*!< EXTI_POSITION_24 |  \
                                                         EXTICR[3] */
/**
 * @}
 */
...
#        define LL_EXTI_MODE_IT_EVENT                                          \
            ((uint8_t)0x02U) /*!< Interrupt & Event Mode */
/**
 * @}
 */
...
#        define LL_EXTI_TRIGGER_RISING                                         \
            ((uint8_t)0x01U) /*!< Trigger Rising Mode */
#        define LL_EXTI_TRIGGER_FALLING                                        \
            ((uint8_t)0x02U) /*!< Trigger Falling Mode */
...
LL_EXTI_EnableIT_0_31(uint32_t ExtiLine)
{
    SET_BIT(EXTI->IMR1, ExtiLine);
}

#    if defined(STM32G081xx) || defined(STM32G071xx) || defined(STM32G0C1xx)   \
        || defined(STM32G0B1xx) || defined(STM32G0B0xx)
/**
 ...
 */
__STATIC_INLINE void
LL_EXTI_EnableIT_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_DisableIT_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_DisableIT_32_63(uint32_t ExtiLine)
{
...
LL_EXTI_IsEnabledIT_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_EXTI_IsEnabledIT_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_EnableEvent_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_EnableEvent_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_DisableEvent_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_DisableEvent_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_EXTI_IsEnabledEvent_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_EXTI_IsEnabledEvent_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_EnableRisingTrig_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_EnableRisingTrig_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_DisableRisingTrig_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_DisableRisingTrig_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_EXTI_IsEnabledRisingTrig_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_EnableFallingTrig_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_EnableFallingTrig_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_DisableFallingTrig_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_DisableFallingTrig_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_GenerateSWI_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_GenerateSWI_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_EXTI_IsActiveFallingFlag_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_EXTI_IsActiveFallingFlag_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_EXTI_ReadFallingFlag_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_EXTI_ReadFallingFlag_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_ClearFallingFlag_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_ClearFallingFlag_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_EXTI_IsActiveRisingFlag_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_EXTI_IsActiveRisingFlag_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_EXTI_ReadRisingFlag_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_EXTI_ReadRisingFlag_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_ClearRisingFlag_0_31(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_ClearRisingFlag_32_63(uint32_t ExtiLine)
{
 ...
 */
__STATIC_INLINE void
LL_EXTI_SetEXTISource(uint32_t Port, uint32_t Line)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_EXTI_GetEXTISource(uint32_t Line)
{
    return (
        READ_BIT(EXTI->EXTICR[Line & 0x03u],
                 (EXTI_EXTICR1_EXTI0 << (Line >> LL_EXTI_REGISTER_PINPOS_SHFT)))
