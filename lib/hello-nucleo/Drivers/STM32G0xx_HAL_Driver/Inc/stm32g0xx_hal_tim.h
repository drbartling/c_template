...
typedef struct {
    ...
    uint32_t RepetitionCounter; /*!< Specifies the repetition counter value.
                                   ...
                                   must be a number between Min_Data = 0x00 and
                                      Max_Data = 0xFF.
                                      Advanced timers: this parameter must be a
...
typedef struct {
    ...
    uint32_t MasterSlaveMode;      /*!< Master/slave mode selection
                                      ...
                                      the effect of      an event on the trigger
                                      input      (TRGI) is delayed to allow a      perfect
                                      synchronization between the current timer and
                                      its      slaves (through TRGO). It is not
                                      mandatory      in case of timer      synchronization
                                      mode. */
 ...
 */
typedef struct {
    uint32_t OffStateRunMode; /*!< TIM off state in run mode, This parameter can
                                 be a value of @ref
                                 TIM_OSSR_Off_State_Selection_for_Run_mode_state
                               */

    uint32_t
        OffStateIDLEMode; /*!< TIM off state in IDLE mode, This parameter
    ...
    uint32_t BreakFilter; /*!< Specifies the break input filter.This parameter
                             can be a number between Min_Data = 0x0 and Max_Data
                             = 0xF */
    ...
    uint32_t AutomaticOutput; /*!< TIM Automatic Output Enable state, This
...
typedef enum {
    ...
    HAL_TIM_CHANNEL_STATE_BUSY  = 0x02U, /*!< An internal process is ongoing on
                                            the TIM channel */
...
#endif /* USE_HAL_TIM_REGISTER_CALLBACKS */
{
    ...
    DMA_HandleTypeDef    *hdma[7]; /*!< DMA Handlers array
                                        This array is accessed by a @ref
                                      DMA_Handle_index */
    HAL_LockTypeDef                  Lock;  /*!< Locking object  */
    __IO HAL_TIM_StateTypeDef        State; /*!< TIM operation state */
    __IO HAL_TIM_ChannelStateTypeDef ChannelState[6]; /*!< TIM channel operation
                                                         state */
    __IO HAL_TIM_ChannelStateTypeDef ChannelNState[4]; /*!< TIM complementary
                                                          channel operation
                                                          state         */
    __IO HAL_TIM_DMABurstStateTypeDef DMABurstState;   /*!< DMA burst operation
                                                          state   */

#if (USE_HAL_TIM_REGISTER_CALLBACKS == 1)
    void (*Base_MspInitCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM
                                                                       Base Msp
                                                                       Init
                                                                       Callback
                                                                     */
    void (*Base_MspDeInitCallback)(
        struct __TIM_HandleTypeDef *htim);                          /*!< TIM
                                                                       ...
                                                                       Callback
                                                                     */
    void (*IC_MspInitCallback)(struct __TIM_HandleTypeDef *htim);   /*!< TIM IC
                                                                       Msp Init
                                                                       Callback   */
    void (*IC_MspDeInitCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM IC
                                                                       Msp
                                                                       DeInit
                                                                       Callback
                                                                     */
    void (*OC_MspInitCallback)(struct __TIM_HandleTypeDef *htim);   /*!< TIM OC
                                                                       Msp Init
                                                                       Callback   */
    void (*OC_MspDeInitCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM OC
                                                                       Msp
                                                                       DeInit
                                                                       Callback
                                                                     */
    void (*PWM_MspInitCallback)(struct __TIM_HandleTypeDef *htim);  /*!< TIM PWM
                                                                       Msp Init
                                                                       Callback
                                                                     */
    void (*PWM_MspDeInitCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM
                                                                        PWM Msp
                                                                        DeInit
                                                                        Callback
                                                                      */
    ...
    void (*OnePulse_MspDeInitCallback)(
        struct __TIM_HandleTypeDef *htim); /*!< TIM One Pulse Msp DeInit
                                              Callback                       */
    ...
    void (*HallSensor_MspInitCallback)(
        struct __TIM_HandleTypeDef *htim); /*!< TIM Hall Sensor Msp Init
                                              Callback                       */
    void (*HallSensor_MspDeInitCallback)(
        struct __TIM_HandleTypeDef *htim); /*!< TIM Hall Sensor Msp DeInit
                                              Callback                     */
    ...
    void (*PeriodElapsedHalfCpltCallback)(
        struct __TIM_HandleTypeDef *htim); /*!< TIM Period Elapsed half complete
                                              Callback               */
    void (*TriggerCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM Trigger
                                                                  Callback */
    void (*TriggerHalfCpltCallback)(
        struct __TIM_HandleTypeDef *htim);                        /*!< TIM
                                                                     ...
                                                                     Callback
                                                                   */
    void (*IC_CaptureCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM Input
                                                                     Capture
                                                                     Callback */
    void (*IC_CaptureHalfCpltCallback)(
        struct __TIM_HandleTypeDef *htim); /*!< TIM Input Capture half complete
                                              Callback                */
    ...
    void (*PWM_PulseFinishedHalfCpltCallback)(
        struct __TIM_HandleTypeDef *htim); /*!< TIM PWM Pulse Finished half
                                              complete Callback           */
    void (*ErrorCallback)(struct __TIM_HandleTypeDef *htim); /*!< TIM Error
                                                                Callback */
    ...
    void (*CommutationHalfCpltCallback)(
        struct __TIM_HandleTypeDef *htim);                    /*!<
                                                                 ...
                                                                 Callback
                                                               */
    void (*BreakCallback)(struct __TIM_HandleTypeDef *htim);  /*!< TIM Break
                                                                 Callback  */
    void (*Break2Callback)(struct __TIM_HandleTypeDef *htim); /*!< TIM Break2
                                                                 Callback */
#endif /* USE_HAL_TIM_REGISTER_CALLBACKS */
} TIM_HandleTypeDef;
...
typedef enum {
    ...
    ,
    HAL_TIM_ONE_PULSE_MSPINIT_CB_ID = 0x08U /*!< TIM One Pulse MspInit Callback
                                               ID                         */
    ,
    HAL_TIM_ONE_PULSE_MSPDEINIT_CB_ID = 0x09U /*!< TIM One Pulse MspDeInit
                                                 Callback ID */
    ,
    HAL_TIM_ENCODER_MSPINIT_CB_ID = 0x0AU /*!< TIM Encoder MspInit Callback ID
                                           */
    ,
    HAL_TIM_ENCODER_MSPDEINIT_CB_ID = 0x0BU /*!< TIM Encoder MspDeInit Callback
                                               ID                         */
    ,
    HAL_TIM_HALL_SENSOR_MSPINIT_CB_ID = 0x0CU /*!< TIM Hall Sensor MspDeInit
                                                 Callback ID */
    ,
    HAL_TIM_HALL_SENSOR_MSPDEINIT_CB_ID = 0x0DU /*!< TIM Hall Sensor MspDeInit
                                                   Callback ID */
    ,
    HAL_TIM_PERIOD_ELAPSED_CB_ID = 0x0EU /*!< TIM Period Elapsed Callback ID */
    ,
    HAL_TIM_PERIOD_ELAPSED_HALF_CB_ID = 0x0FU /*!< TIM Period Elapsed half
                                                 complete Callback ID */
    ,
    HAL_TIM_TRIGGER_CB_ID = 0x10U /*!< TIM Trigger Callback ID */
    ,
    HAL_TIM_TRIGGER_HALF_CB_ID = 0x11U /*!< TIM Trigger half complete Callback
                                          ID                      */

    ,
    HAL_TIM_IC_CAPTURE_CB_ID = 0x12U /*!< TIM Input Capture Callback ID */
    ,
    HAL_TIM_IC_CAPTURE_HALF_CB_ID = 0x13U /*!< TIM Input Capture half complete
                                             Callback ID                */
    ,
    HAL_TIM_OC_DELAY_ELAPSED_CB_ID = 0x14U /*!< TIM Output Compare Delay Elapsed
                                              Callback ID               */
    ,
    HAL_TIM_PWM_PULSE_FINISHED_CB_ID = 0x15U /*!< TIM PWM Pulse Finished
                                                Callback ID           */
    ,
    ...
    ,
    HAL_TIM_COMMUTATION_HALF_CB_ID = 0x19U /*!< TIM Commutation half complete
                                              Callback ID                  */
    ,
 ...
 */
typedef void (*pTIM_CallbackTypeDef)(TIM_HandleTypeDef *htim); /*!< pointer to
                                                                  the TIM
                                                                  callback
                                                                  function */
...
#define TIM_CLEARINPUTSOURCE_ETR                                               \
    0x20000000U /*!< OCREF_CLR is connected to ETRF input */
...
#    define TIM_CLEARINPUTSOURCE_COMP2                                         \
        TIM1_OR1_OCREF_CLR_0 /*!< OCREF_CLR_INT is connected to COMP2 output   \
                              */
#    define TIM_CLEARINPUTSOURCE_COMP3                                         \
        TIM1_OR1_OCREF_CLR_1 /*!< OCREF_CLR_INT is connected to COMP3 output   \
                              */
#elif defined(COMP1) && defined(COMP2)
#    define TIM_CLEARINPUTSOURCE_COMP1                                         \
        0x00000000U /*!< OCREF_CLR_INT is connected to COMP1 output */
#    define TIM_CLEARINPUTSOURCE_COMP2                                         \
        TIM1_OR1_OCREF_CLR /*!< OCREF_CLR_INT is connected to COMP2 output */
...
#define TIM_ENCODERMODE_TI12                                                   \
    (TIM_SMCR_SMS_1 | TIM_SMCR_SMS_0) /*!< Quadrature encoder mode 3, x4 mode, \
                                         counts up/down on both TI1FP1 and     \
                                         TI2FP2 edges depending on the level   \
                                         of the other input. */
/**
 * @}
 */
...
#define TIM_TRGO_OC2REF                                                        \
    (TIM_CR2_MMS_2 | TIM_CR2_MMS_0) /*!< OC2REF signal is used as trigger      \
                                       output(TRGO)                 */
#define TIM_TRGO_OC3REF                                                        \
    (TIM_CR2_MMS_2 | TIM_CR2_MMS_1) /*!< OC3REF signal is used as trigger      \
                                       output(TRGO)                 */
#define TIM_TRGO_OC4REF                                                        \
    (TIM_CR2_MMS_2 | TIM_CR2_MMS_1 | TIM_CR2_MMS_0) /*!< OC4REF signal is used \
                                                       as trigger output(TRGO) \
                                                     */
/**
 * @}
...
#define TIM_TRGO2_OC2REF                                                       \
    (TIM_CR2_MMS2_2 | TIM_CR2_MMS2_0) /*!< OC2REF signal is used as trigger    \
                                         output (TRGO2)                */
#define TIM_TRGO2_OC3REF                                                       \
    (TIM_CR2_MMS2_2 | TIM_CR2_MMS2_1) /*!< OC3REF signal is used as trigger    \
                                         output (TRGO2)                */
#define TIM_TRGO2_OC4REF                                                       \
    (TIM_CR2_MMS2_2 | TIM_CR2_MMS2_1 | TIM_CR2_MMS2_0) /*!< OC4REF signal is   \
                                                          used as trigger      \
                                                          output (TRGO2) */
#define TIM_TRGO2_OC5REF                                                       \
    TIM_CR2_MMS2_3 /*!< OC5REF signal is used as trigger output (TRGO2) */
#define TIM_TRGO2_OC6REF                                                       \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_0) /*!< OC6REF signal is used as trigger    \
                                         output (TRGO2)                */
...
#define TIM_TRGO2_OC6REF_RISINGFALLING                                         \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_1 | TIM_CR2_MMS2_0) /*!< OC6REF rising or   \
                                                          falling edges        \
                                                          generate pulses on   \
                                                          TRGO2        */
...
#define TIM_TRGO2_OC4REF_RISING_OC6REF_FALLING                                 \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 | TIM_CR2_MMS2_0) /*!< OC4REF rising or   \
                                                          OC6REF falling edges \
                                                          generate pulses on   \
                                                          TRGO2 */
...
#define TIM_TRGO2_OC5REF_RISING_OC6REF_FALLING                                 \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 | TIM_CR2_MMS2_1                          \
     | TIM_CR2_MMS2_0) /*!< OC5REF or OC6REF rising edges generate pulses on   \
                          TRGO2         */
/**
 * @}
 */
...
#define TIM_SLAVEMODE_EXTERNAL1                                                \
    (TIM_SMCR_SMS_2 | TIM_SMCR_SMS_1 | TIM_SMCR_SMS_0) /*!< External Clock     \
                                                          Mode 1         */
...
#define TIM_OCMODE_COMBINED_PWM2                                               \
    (TIM_CCMR1_OC1M_3 | TIM_CCMR1_OC1M_0 | TIM_CCMR1_OC1M_2) /*!< Combined PWM \
                                                                mode 2 */
#define TIM_OCMODE_ASSYMETRIC_PWM1                                             \
    (TIM_CCMR1_OC1M_3 | TIM_CCMR1_OC1M_1 | TIM_CCMR1_OC1M_2) /*!< Asymmetric   \
                                                                PWM mode 1 */
...
#if defined(USB_BASE)
#    define TIM_TS_ITR7                                                        \
        (TIM_SMCR_TS_0 | TIM_SMCR_TS_1 | TIM_SMCR_TS_3) /*!< Internal Trigger  \
                                                           7 (ITR7) */
#endif                                                  /* USB_BASE */
...
#define TIM_TS_ETRF                                                            \
    (TIM_SMCR_TS_0 | TIM_SMCR_TS_1 | TIM_SMCR_TS_2) /*!< Filtered External     \
                                                       Trigger input (ETRF) */
