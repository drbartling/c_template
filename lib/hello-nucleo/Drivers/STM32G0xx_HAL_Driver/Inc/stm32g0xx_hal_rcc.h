...
#define RCC_CLOCKTYPE_ALL                                                      \
    (RCC_CLOCKTYPE_SYSCLK | RCC_CLOCKTYPE_HCLK                                 \
     | RCC_CLOCKTYPE_PCLK1) /*!< All clocktype to configure */
/**
 * @}
 */
...
#    define IS_RCC_MCO(__MCOX__)                                               \
        (((__MCOX__) == RCC_MCO1) || ((__MCOX__) == RCC_MCO2))
#else
...
#        define IS_RCC_MCO2SOURCE(__SOURCE__)                                  \
            (((__SOURCE__) == RCC_MCO2SOURCE_NOCLOCK)                          \
...
#    define IS_RCC_MCO2DIV(__DIV__)                                            \
        (((__DIV__) == RCC_MCO2DIV_1) || ((__DIV__) == RCC_MCO2DIV_2)          \
...
typedef struct {
    ...
    uint32_t APB1CLKDivider; /*!< The APB1 clock (PCLK1) divider. This clock is
                                derived from the AHB clock (HCLK). This
                                parameter can be a value of @ref
...
#define RCC_LSE_BYPASS                                                         \
    (RCC_BDCR_LSEBYP | RCC_BDCR_LSEON) /*!< External clock source for LSE      \
                                          clock */
/**
 * @}
 */
...
#define RCC_HSICALIBRATION_DEFAULT                                             \
    64U /*!< Default HSI calibration trimming value */
/**
 * @}
 */
...
#define RCC_HSI_DIV8                                                           \
    (RCC_CR_HSIDIV_1 | RCC_CR_HSIDIV_0) /*!< HSI clock is divided by 8 */
#define RCC_HSI_DIV16 RCC_CR_HSIDIV_2   /*!< HSI clock is divided by 16 */
#define RCC_HSI_DIV32                                                          \
    (RCC_CR_HSIDIV_2 | RCC_CR_HSIDIV_0) /*!< HSI clock is divided by 32 */
#define RCC_HSI_DIV64                                                          \
    (RCC_CR_HSIDIV_2 | RCC_CR_HSIDIV_1) /*!< HSI clock is divided by 64 */
#define RCC_HSI_DIV128                                                         \
    (RCC_CR_HSIDIV_2 | RCC_CR_HSIDIV_1 | RCC_CR_HSIDIV_0) /*!< HSI clock is    \
                                                             divided by 128 */
/**
 * @}
 */
...
#define RCC_PLLM_DIV4                                                          \
    (RCC_PLLCFGR_PLLM_1 | RCC_PLLCFGR_PLLM_0) /*!< PLLM division factor = 4 */
#define RCC_PLLM_DIV5 RCC_PLLCFGR_PLLM_2      /*!< PLLM division factor = 5  */
#define RCC_PLLM_DIV6                                                          \
    (RCC_PLLCFGR_PLLM_2 | RCC_PLLCFGR_PLLM_0) /*!< PLLM division factor = 6 */
#define RCC_PLLM_DIV7                                                          \
    (RCC_PLLCFGR_PLLM_2 | RCC_PLLCFGR_PLLM_1) /*!< PLLM division factor = 7 */
#define RCC_PLLM_DIV8                                                          \
    (RCC_PLLCFGR_PLLM_2 | RCC_PLLCFGR_PLLM_1                                   \
     | RCC_PLLCFGR_PLLM_0) /*!< PLLM division factor = 8  */
/**
 * @}
 */
...
#define RCC_PLLP_DIV4                                                          \
    (RCC_PLLCFGR_PLLP_1 | RCC_PLLCFGR_PLLP_0) /*!< PLLP division factor = 4 */
#define RCC_PLLP_DIV5 RCC_PLLCFGR_PLLP_2      /*!< PLLP division factor = 5  */
#define RCC_PLLP_DIV6                                                          \
    (RCC_PLLCFGR_PLLP_2 | RCC_PLLCFGR_PLLP_0) /*!< PLLP division factor = 6 */
#define RCC_PLLP_DIV7                                                          \
    (RCC_PLLCFGR_PLLP_2 | RCC_PLLCFGR_PLLP_1) /*!< PLLP division factor = 7 */
#define RCC_PLLP_DIV8                                                          \
    (RCC_PLLCFGR_PLLP_2 | RCC_PLLCFGR_PLLP_1                                   \
     | RCC_PLLCFGR_PLLP_0)               /*!< PLLP division factor = 8  */
...
#define RCC_PLLP_DIV12                                                         \
    (RCC_PLLCFGR_PLLP_3 | RCC_PLLCFGR_PLLP_1                                   \
     | RCC_PLLCFGR_PLLP_0) /*!< PLLP division factor = 12 */
#define RCC_PLLP_DIV13                                                         \
    (RCC_PLLCFGR_PLLP_3 | RCC_PLLCFGR_PLLP_2) /*!< PLLP division factor = 13   \
                                               */
#define RCC_PLLP_DIV14                                                         \
    (RCC_PLLCFGR_PLLP_3 | RCC_PLLCFGR_PLLP_2                                   \
     | RCC_PLLCFGR_PLLP_0) /*!< PLLP division factor = 14 */
#define RCC_PLLP_DIV15                                                         \
    (RCC_PLLCFGR_PLLP_3 | RCC_PLLCFGR_PLLP_2                                   \
     | RCC_PLLCFGR_PLLP_1) /*!< PLLP division factor = 15 */
...
#define RCC_PLLP_DIV20                                                         \
    (RCC_PLLCFGR_PLLP_4 | RCC_PLLCFGR_PLLP_1                                   \
     | RCC_PLLCFGR_PLLP_0) /*!< PLLP division factor = 20 */
#define RCC_PLLP_DIV21                                                         \
    (RCC_PLLCFGR_PLLP_4 | RCC_PLLCFGR_PLLP_2) /*!< PLLP division factor = 21   \
                                               */
#define RCC_PLLP_DIV22                                                         \
    (RCC_PLLCFGR_PLLP_4 | RCC_PLLCFGR_PLLP_2                                   \
     | RCC_PLLCFGR_PLLP_0) /*!< PLLP division factor = 22 */
#define RCC_PLLP_DIV23                                                         \
    (RCC_PLLCFGR_PLLP_4 | RCC_PLLCFGR_PLLP_2                                   \
     | RCC_PLLCFGR_PLLP_1) /*!< PLLP division factor = 23 */
...
#define RCC_PLLP_DIV26                                                         \
    (RCC_PLLCFGR_PLLP_4 | RCC_PLLCFGR_PLLP_3                                   \
     | RCC_PLLCFGR_PLLP_0) /*!< PLLP division factor = 26 */
#define RCC_PLLP_DIV27                                                         \
    (RCC_PLLCFGR_PLLP_4 | RCC_PLLCFGR_PLLP_3                                   \
     | RCC_PLLCFGR_PLLP_1) /*!< PLLP division factor = 27 */
...
#define RCC_PLLP_DIV29                                                         \
    (RCC_PLLCFGR_PLLP_4 | RCC_PLLCFGR_PLLP_3                                   \
     | RCC_PLLCFGR_PLLP_2) /*!< PLLP division factor = 29 */
...
#define RCC_PLLP_DIV32                                                         \
    (RCC_PLLCFGR_PLLP_4 | RCC_PLLCFGR_PLLP_3 | RCC_PLLCFGR_PLLP_2              \
     | RCC_PLLCFGR_PLLP_1 | RCC_PLLCFGR_PLLP_0) /*!< PLLP division factor = 32 \
                                                 */
/**
 * @}
 */
...
#    define RCC_PLLQ_DIV4                                                      \
        (RCC_PLLCFGR_PLLQ_1 | RCC_PLLCFGR_PLLQ_0) /*!< PLLQ division factor =  \
                                                     4 */
#    define RCC_PLLQ_DIV5 RCC_PLLCFGR_PLLQ_2 /*!< PLLQ division factor = 5 */
#    define RCC_PLLQ_DIV6                                                      \
        (RCC_PLLCFGR_PLLQ_2 | RCC_PLLCFGR_PLLQ_0) /*!< PLLQ division factor =  \
                                                     6 */
#    define RCC_PLLQ_DIV7                                                      \
        (RCC_PLLCFGR_PLLQ_2 | RCC_PLLCFGR_PLLQ_1) /*!< PLLQ division factor =  \
                                                     7 */
#    define RCC_PLLQ_DIV8                                                      \
        (RCC_PLLCFGR_PLLQ_2 | RCC_PLLCFGR_PLLQ_1                               \
         | RCC_PLLCFGR_PLLQ_0) /*!< PLLQ division factor = 8 */
/**  * @}
 */
#endif /* RCC_PLLQ_SUPPORT */
...
#define RCC_PLLR_DIV4                                                          \
    (RCC_PLLCFGR_PLLR_1 | RCC_PLLCFGR_PLLR_0) /*!< PLLR division factor = 4 */
#define RCC_PLLR_DIV5 RCC_PLLCFGR_PLLR_2      /*!< PLLR division factor = 5 */
#define RCC_PLLR_DIV6                                                          \
    (RCC_PLLCFGR_PLLR_2 | RCC_PLLCFGR_PLLR_0) /*!< PLLR division factor = 6 */
#define RCC_PLLR_DIV7                                                          \
    (RCC_PLLCFGR_PLLR_2 | RCC_PLLCFGR_PLLR_1) /*!< PLLR division factor = 7 */
#define RCC_PLLR_DIV8                                                          \
    (RCC_PLLCFGR_PLLR_2 | RCC_PLLCFGR_PLLR_1                                   \
     | RCC_PLLCFGR_PLLR_0) /*!< PLLR division factor = 8 */
/**  * @}
 */
...
#if defined(RCC_PLLQ_SUPPORT)
#    define RCC_PLLQCLK                                                        \
        RCC_PLLCFGR_PLLQEN             /*!< PLLQCLK selection from main PLL */
#endif                                 /* RCC_PLLQ_SUPPORT */
...
#define RCC_SYSCLKSOURCE_PLLCLK                                                \
    RCC_CFGR_SW_1 /*!< PLL selection as system clock */
#define RCC_SYSCLKSOURCE_LSI                                                   \
    (RCC_CFGR_SW_1 | RCC_CFGR_SW_0) /*!< LSI selection as system clock */
...
#define RCC_SYSCLKSOURCE_STATUS_HSE                                            \
    RCC_CFGR_SWS_0 /*!< HSE used as system clock */
#define RCC_SYSCLKSOURCE_STATUS_PLLCLK                                         \
    RCC_CFGR_SWS_1 /*!< PLL used as system clock */
#define RCC_SYSCLKSOURCE_STATUS_LSI                                            \
    (RCC_CFGR_SWS_1 | RCC_CFGR_SWS_0) /*!< LSI used as system clock */
#define RCC_SYSCLKSOURCE_STATUS_LSE                                            \
    RCC_CFGR_SWS_2 /*!< LSE used as system clock */
/**
 * @}
 */
...
#define RCC_SYSCLK_DIV4                                                        \
    (RCC_CFGR_HPRE_3 | RCC_CFGR_HPRE_0) /*!< SYSCLK divided by 4 */
#define RCC_SYSCLK_DIV8                                                        \
    (RCC_CFGR_HPRE_3 | RCC_CFGR_HPRE_1) /*!< SYSCLK divided by 8 */
#define RCC_SYSCLK_DIV16                                                       \
    (RCC_CFGR_HPRE_3 | RCC_CFGR_HPRE_1 | RCC_CFGR_HPRE_0) /*!< SYSCLK divided  \
                                                             by 16 */
#define RCC_SYSCLK_DIV64                                                       \
    (RCC_CFGR_HPRE_3 | RCC_CFGR_HPRE_2) /*!< SYSCLK divided by 64 */
#define RCC_SYSCLK_DIV128                                                      \
    (RCC_CFGR_HPRE_3 | RCC_CFGR_HPRE_2 | RCC_CFGR_HPRE_0) /*!< SYSCLK divided  \
                                                             by 128 */
#define RCC_SYSCLK_DIV256                                                      \
    (RCC_CFGR_HPRE_3 | RCC_CFGR_HPRE_2 | RCC_CFGR_HPRE_1) /*!< SYSCLK divided  \
                                                             by 256 */
...
#define RCC_HCLK_DIV4                                                          \
    (RCC_CFGR_PPRE_2 | RCC_CFGR_PPRE_0) /*!< HCLK divided by 4 */
#define RCC_HCLK_DIV8                                                          \
    (RCC_CFGR_PPRE_2 | RCC_CFGR_PPRE_1) /*!< HCLK divided by 8 */
#define RCC_HCLK_DIV16                                                         \
    (RCC_CFGR_PPRE_2 | RCC_CFGR_PPRE_1 | RCC_CFGR_PPRE_0) /*!< HCLK divided by \
                                                             16 */
/**
 * @}
 */
...
#    define RCC_MCO1SOURCE_HSI48                                               \
        RCC_CFGR_MCOSEL_1 /*!< HSI48 selection as MCO1 source */
#endif                    /* RCC_HSI48_SUPPORT */
...
#define RCC_MCO1SOURCE_PLLCLK                                                  \
    (RCC_CFGR_MCOSEL_0 | RCC_CFGR_MCOSEL_2) /*!< PLLCLK selection as MCO1      \
                                               source */
...
#    define RCC_MCO1SOURCE_PLLPCLK                                             \
        RCC_CFGR_MCOSEL_3 /*!< PLLPCLK selection as MCO1 source */
#    define RCC_MCO1SOURCE_PLLQCLK                                             \
        (RCC_CFGR_MCOSEL_3 | RCC_CFGR_MCOSEL_0) /*!< PLLQCLK selection as MCO1 \
                                                   source */
#    define RCC_MCO1SOURCE_RTCCLK                                              \
        (RCC_CFGR_MCOSEL_3 | RCC_CFGR_MCOSEL_1) /*!< RTCCLK selection as MCO1  \
                                                   source */
#    define RCC_MCO1SOURCE_RTC_WKUP                                            \
        (RCC_CFGR_MCOSEL_3 | RCC_CFGR_MCOSEL_1                                 \
         | RCC_CFGR_MCOSEL_0) /*!< RTC_Wakeup selection as MCO1 source */
...
#define RCC_MCODIV_8                                                           \
    (RCC_CFGR_MCOPRE_1 | RCC_CFGR_MCOPRE_0) /*!< MCO divided by 8 */
#define RCC_MCODIV_16 RCC_CFGR_MCOPRE_2     /*!< MCO divided by 16 */
#define RCC_MCODIV_32                                                          \
    (RCC_CFGR_MCOPRE_2 | RCC_CFGR_MCOPRE_0) /*!< MCO divided by 32 */
#define RCC_MCODIV_64                                                          \
    (RCC_CFGR_MCOPRE_2 | RCC_CFGR_MCOPRE_1) /*!< MCO divided by 64 */
#define RCC_MCODIV_128                                                         \
    (RCC_CFGR_MCOPRE_2 | RCC_CFGR_MCOPRE_1 | RCC_CFGR_MCOPRE_0) /*!< MCO       \
                                                                   divided by  \
                                                                   128 */
#if defined(RCC_CFGR_MCOPRE_3)
#    define RCC_MCODIV_256 RCC_CFGR_MCOPRE_3 /*!< MCO divided by 256 */
#    define RCC_MCODIV_512                                                     \
        (RCC_CFGR_MCOPRE_3 | RCC_CFGR_MCOPRE_0) /*!< MCO divided by 512 */
#    define RCC_MCODIV_1024                                                    \
        (RCC_CFGR_MCOPRE_3 | RCC_CFGR_MCOPRE_1) /*!< MCO divided by 1024 */
#endif                                          /* RCC_CFGR_MCOSEL_3 */
/**
 * @}
 */
 ...
 * @{
 */
#    define RCC_MCO2SOURCE_NOCLOCK                                             \
        0x00000000U /*!< MCO2 output disabled, no clock on MCO2 */
#    define RCC_MCO2SOURCE_SYSCLK                                              \
        RCC_CFGR_MCO2SEL_0 /*!< SYSCLK selection as MCO2 source */
#    if defined(RCC_HSI48_SUPPORT)
#        define RCC_MCO2SOURCE_HSI48                                           \
            RCC_CFGR_MCO2SEL_1 /*!< HSI48 selection as MCO2 source */
#    endif                     /* RCC_HSI48_SUPPORT */
#    define RCC_MCO2SOURCE_HSI                                                 \
        (RCC_CFGR_MCO2SEL_1 | RCC_CFGR_MCO2SEL_0) /*!< HSI selection as MCO2   \
                                                     source */
#    define RCC_MCO2SOURCE_HSE                                                 \
        RCC_CFGR_MCO2SEL_2 /*!< HSE selection as MCO2 source */
#    define RCC_MCO2SOURCE_PLLCLK                                              \
        (RCC_CFGR_MCO2SEL_2 | RCC_CFGR_MCO2SEL_0) /*!< PLLCLK selection as     \
                                                     MCO2 source */
#    define RCC_MCO2SOURCE_LSI                                                 \
        (RCC_CFGR_MCO2SEL_2 | RCC_CFGR_MCO2SEL_1) /*!< LSI selection as MCO2   \
                                                     source */
#    define RCC_MCO2SOURCE_LSE                                                 \
        (RCC_CFGR_MCO2SEL_2 | RCC_CFGR_MCO2SEL_1                               \
         | RCC_CFGR_MCO2SEL_0) /*!< LSE selection as MCO2 source */
#    define RCC_MCO2SOURCE_PLLPCLK                                             \
        RCC_CFGR_MCO2SEL_3 /*!< PLLPCLK selection as MCO2 source */
#    define RCC_MCO2SOURCE_PLLQCLK                                             \
        (RCC_CFGR_MCO2SEL_3 | RCC_CFGR_MCO2SEL_0) /*!< PLLQCLK selection as    \
                                                     MCO2 source */
#    define RCC_MCO2SOURCE_RTCCLK                                              \
        (RCC_CFGR_MCO2SEL_3 | RCC_CFGR_MCO2SEL_1) /*!< RTCCLK selection as     \
                                                     MCO2 source */
#    define RCC_MCO2SOURCE_RTC_WKUP                                            \
        (RCC_CFGR_MCO2SEL_3 | RCC_CFGR_MCO2SEL_1                               \
         | RCC_CFGR_MCO2SEL_0) /*!< RTC_Wakeup selection as MCO2 source */
/**
 * @}
 */
...
#    define RCC_MCO2DIV_8                                                      \
        (RCC_CFGR_MCO2PRE_1 | RCC_CFGR_MCO2PRE_0) /*!< MCO2 divided by 8 */
#    define RCC_MCO2DIV_16 RCC_CFGR_MCO2PRE_2     /*!< MCO2 divided by 16 */
#    define RCC_MCO2DIV_32                                                     \
        (RCC_CFGR_MCO2PRE_2 | RCC_CFGR_MCO2PRE_0) /*!< MCO2 divided by 32 */
#    define RCC_MCO2DIV_64                                                     \
        (RCC_CFGR_MCO2PRE_2 | RCC_CFGR_MCO2PRE_1) /*!< MCO2 divided by 64 */
#    define RCC_MCO2DIV_128                                                    \
        (RCC_CFGR_MCO2PRE_2 | RCC_CFGR_MCO2PRE_1                               \
         | RCC_CFGR_MCO2PRE_0)                 /*!< MCO2 divided by 128 */
#    define RCC_MCO2DIV_256 RCC_CFGR_MCO2PRE_3 /*!< MCO2 divided by 256 */
#    define RCC_MCO2DIV_512                                                    \
        (RCC_CFGR_MCO2PRE_3 | RCC_CFGR_MCO2PRE_0) /*!< MCO2 divided by 512 */
#    define RCC_MCO2DIV_1024                                                   \
        (RCC_CFGR_MCO2PRE_3 | RCC_CFGR_MCO2PRE_1) /*!< MCO2 divided by 1024 */
/**
 * @}
 */
#endif /* RCC_MCO2_SUPPORT */
...
#    define RCC_FLAG_HSI48RDY                                                  \
        ((CR_REG_INDEX << 5U) | RCC_CR_HSI48RDY_Pos) /*!< HSI48 Ready flag */
#endif                                               /* RCC_HSI48_SUPPORT */
...
#define RCC_FLAG_LSECSSD                                                       \
    ((BDCR_REG_INDEX << 5U) | RCC_BDCR_LSECSSD_Pos) /*!< LSE Clock Security    \
...
#define RCC_FLAG_OBLRST                                                        \
    ((CSR_REG_INDEX << 5U) | RCC_CSR_OBLRSTF_Pos) /*!< Option Byte Loader      \
                                                     reset flag */
#define RCC_FLAG_PINRST                                                        \
    ((CSR_REG_INDEX << 5U) | RCC_CSR_PINRSTF_Pos) /*!< PIN reset flag */
#define RCC_FLAG_PWRRST                                                        \
    ((CSR_REG_INDEX << 5U) | RCC_CSR_PWRRSTF_Pos) /*!< BOR or POR/PDR reset    \
                                                     flag */
#define RCC_FLAG_SFTRST                                                        \
    ((CSR_REG_INDEX << 5U) | RCC_CSR_SFTRSTF_Pos) /*!< Software Reset flag */
#define RCC_FLAG_IWDGRST                                                       \
    ((CSR_REG_INDEX << 5U) | RCC_CSR_IWDGRSTF_Pos) /*!< Independent Watchdog   \
                                                      reset flag */
#define RCC_FLAG_WWDGRST                                                       \
    ((CSR_REG_INDEX << 5U) | RCC_CSR_WWDGRSTF_Pos) /*!< Window watchdog reset  \
                                                      flag */
...
#    define __HAL_RCC_GPIOE_CLK_DISABLE()                                      \
        CLEAR_BIT(RCC->IOPENR, RCC_IOPENR_GPIOEEN)
#endif /* GPIOE */
...
#endif /* USART4 */
#if defined(USART5)
#    define __HAL_RCC_USART5_CLK_DISABLE()                                     \
        CLEAR_BIT(RCC->APBENR1, RCC_APBENR1_USART5EN)
#endif /* USART5 */
#if defined(USART6)
#    define __HAL_RCC_USART6_CLK_DISABLE()                                     \
        CLEAR_BIT(RCC->APBENR1, RCC_APBENR1_USART6EN)
#endif /* USART6 */
#if defined(LPUART1)
#    define __HAL_RCC_LPUART1_CLK_DISABLE()                                    \
        CLEAR_BIT(RCC->APBENR1, RCC_APBENR1_LPUART1EN)
#endif /* LPUART1 */
#if defined(LPUART2)
#    define __HAL_RCC_LPUART2_CLK_DISABLE()                                    \
        CLEAR_BIT(RCC->APBENR1, RCC_APBENR1_LPUART2EN)
#endif /* LPUART2 */
...
#    define __HAL_RCC_I2C3_CLK_DISABLE()                                       \
        CLEAR_BIT(RCC->APBENR1, RCC_APBENR1_I2C3EN)
#endif /* I2C3 */
#if defined(CEC)
#    define __HAL_RCC_CEC_CLK_DISABLE()                                        \
        CLEAR_BIT(RCC->APBENR1, RCC_APBENR1_CECEN)
#endif /* CEC */
#if defined(UCPD1)
#    define __HAL_RCC_UCPD1_CLK_DISABLE()                                      \
        CLEAR_BIT(RCC->APBENR1, RCC_APBENR1_UCPD1EN)
#endif /* UCPD1 */
#if defined(UCPD2)
#    define __HAL_RCC_UCPD2_CLK_DISABLE()                                      \
        CLEAR_BIT(RCC->APBENR1, RCC_APBENR1_UCPD2EN)
#endif /* UCPD2 */
#if defined(STM32G0B0xx) || defined(STM32G0B1xx) || defined(STM32G0C1xx)
...
#    define __HAL_RCC_FDCAN_CLK_DISABLE()                                      \
        CLEAR_BIT(RCC->APBENR1, RCC_APBENR1_FDCANEN)
#endif /* FDCAN1 || FDCAN2 */
#define __HAL_RCC_DBGMCU_CLK_DISABLE()                                         \
    CLEAR_BIT(RCC->APBENR1, RCC_APBENR1_DBGEN)
#define __HAL_RCC_PWR_CLK_DISABLE() CLEAR_BIT(RCC->APBENR1, RCC_APBENR1_PWREN)
#if defined(DAC1)
#    define __HAL_RCC_DAC1_CLK_DISABLE()                                       \
        CLEAR_BIT(RCC->APBENR1, RCC_APBENR1_DAC1EN)
#endif /* DAC1 */
#if defined(LPTIM1)
#    define __HAL_RCC_LPTIM1_CLK_DISABLE()                                     \
        CLEAR_BIT(RCC->APBENR1, RCC_APBENR1_LPTIM1EN)
#endif /* LPTIM1 */
#if defined(LPTIM2)
#    define __HAL_RCC_LPTIM2_CLK_DISABLE()                                     \
        CLEAR_BIT(RCC->APBENR1, RCC_APBENR1_LPTIM2EN)
#endif /* LPTIM2 */
#define __HAL_RCC_SYSCFG_CLK_DISABLE()                                         \
    CLEAR_BIT(RCC->APBENR2, RCC_APBENR2_SYSCFGEN)
...
#    define __HAL_RCC_TIM15_CLK_DISABLE()                                      \
        CLEAR_BIT(RCC->APBENR2, RCC_APBENR2_TIM15EN)
#endif /* TIM15 */
#define __HAL_RCC_TIM16_CLK_DISABLE()                                          \
    CLEAR_BIT(RCC->APBENR2, RCC_APBENR2_TIM16EN)
#define __HAL_RCC_TIM17_CLK_DISABLE()                                          \
    CLEAR_BIT(RCC->APBENR2, RCC_APBENR2_TIM17EN)
...
#define __HAL_RCC_DMA1_IS_CLK_ENABLED()                                        \
    (READ_BIT(RCC->AHBENR, RCC_AHBENR_DMA1EN) != RESET)
#if defined(DMA2)
#    define __HAL_RCC_DMA2_IS_CLK_ENABLED()                                    \
        (READ_BIT(RCC->AHBENR, RCC_AHBENR_DMA2EN) != RESET)
#endif /* DMA2 */
#define __HAL_RCC_FLASH_IS_CLK_ENABLED()                                       \
    (READ_BIT(RCC->AHBENR, RCC_AHBENR_FLASHEN) != RESET)
#define __HAL_RCC_CRC_IS_CLK_ENABLED()                                         \
    (READ_BIT(RCC->AHBENR, RCC_AHBENR_CRCEN) != RESET)
#if defined(RNG)
#    define __HAL_RCC_RNG_IS_CLK_ENABLED()                                     \
        (READ_BIT(RCC->AHBENR, RCC_AHBENR_RNGEN) != RESET)
#endif /* RNG */
#if defined(AES)
#    define __HAL_RCC_AES_IS_CLK_ENABLED()                                     \
        (READ_BIT(RCC->AHBENR, RCC_AHBENR_AESEN) != RESET)
#endif /* AES */
...
#define __HAL_RCC_GPIOA_IS_CLK_ENABLED()                                       \
    (READ_BIT(RCC->IOPENR, RCC_IOPENR_GPIOAEN) != RESET)
#define __HAL_RCC_GPIOB_IS_CLK_ENABLED()                                       \
    (READ_BIT(RCC->IOPENR, RCC_IOPENR_GPIOBEN) != RESET)
#define __HAL_RCC_GPIOC_IS_CLK_ENABLED()                                       \
    (READ_BIT(RCC->IOPENR, RCC_IOPENR_GPIOCEN) != RESET)
#define __HAL_RCC_GPIOD_IS_CLK_ENABLED()                                       \
    (READ_BIT(RCC->IOPENR, RCC_IOPENR_GPIODEN) != RESET)
#if defined(GPIOE)
#    define __HAL_RCC_GPIOE_IS_CLK_ENABLED()                                   \
        (READ_BIT(RCC->IOPENR, RCC_IOPENR_GPIOEEN) != RESET)
#endif /* GPIOE */
#define __HAL_RCC_GPIOF_IS_CLK_ENABLED()                                       \
    (READ_BIT(RCC->IOPENR, RCC_IOPENR_GPIOFEN) != RESET)
...
#    define __HAL_RCC_LPUART1_IS_CLK_ENABLED()                                 \
        (READ_BIT(RCC->APBENR1, RCC_APBENR1_LPUART1EN) != 0U)
#endif /* LPUART1 */
#if defined(LPUART2)
#    define __HAL_RCC_LPUART2_IS_CLK_ENABLED()                                 \
...
#define __HAL_RCC_I2C2_IS_CLK_ENABLED()                                        \
    (READ_BIT(RCC->APBENR1, RCC_APBENR1_I2C2EN) != 0U)
#if defined(I2C3)
#    define __HAL_RCC_I2C3_IS_CLK_ENABLED()                                    \
        (READ_BIT(RCC->APBENR1, RCC_APBENR1_I2C3EN) != 0U)
#endif /* I2C3 */
#if defined(CEC)
#    define __HAL_RCC_CEC_IS_CLK_ENABLED()                                     \
        (READ_BIT(RCC->APBENR1, RCC_APBENR1_CECEN) != 0U)
#endif /* CEC */
#if defined(UCPD1)
#    define __HAL_RCC_UCPD1_IS_CLK_ENABLED()                                   \
        (READ_BIT(RCC->APBENR1, RCC_APBENR1_UCPD1EN) != 0U)
#endif /* UCPD1 */
#if defined(UCPD2)
#    define __HAL_RCC_UCPD2_IS_CLK_ENABLED()                                   \
        (READ_BIT(RCC->APBENR1, RCC_APBENR1_UCPD2EN) != 0U)
#endif /* UCPD2 */
#define __HAL_RCC_DBGMCU_IS_CLK_ENABLED()                                      \
    (READ_BIT(RCC->APBENR1, RCC_APBENR1_DBGEN) != 0U)
#define __HAL_RCC_PWR_IS_CLK_ENABLED()                                         \
    (READ_BIT(RCC->APBENR1, RCC_APBENR1_PWREN) != 0U)
#if defined(DAC1)
...
#    define __HAL_RCC_LPTIM2_IS_CLK_ENABLED()                                  \
        (READ_BIT(RCC->APBENR1, RCC_APBENR1_LPTIM2EN) != 0U)
#endif /* LPTIM2 */
#if defined(LPTIM1)
#    define __HAL_RCC_LPTIM1_IS_CLK_ENABLED()                                  \
        (READ_BIT(RCC->APBENR1, RCC_APBENR1_LPTIM1EN) != 0U)
#endif /* LPTIM1 */
#if defined(TIM2)
...
#endif /* LPUART1 */
#if defined(LPUART2)
#    define __HAL_RCC_LPUART2_IS_CLK_DISABLED()                                \
        (READ_BIT(RCC->APBENR1, RCC_APBENR1_LPUART2EN) == 0U)
#endif /* LPUART2 */
...
#endif /* UCPD1 */
#if defined(UCPD2)
#    define __HAL_RCC_UCPD2_IS_CLK_DISABLED()                                  \
        (READ_BIT(RCC->APBENR1, RCC_APBENR1_UCPD2EN) == 0U)
#endif /* UCPD2 */
...
#define __HAL_RCC_GPIOD_FORCE_RESET()                                          \
    SET_BIT(RCC->IOPRSTR, RCC_IOPRSTR_GPIODRST)
#if defined(GPIOE)
#    define __HAL_RCC_GPIOE_FORCE_RESET()                                      \
        SET_BIT(RCC->IOPRSTR, RCC_IOPRSTR_GPIOERST)
#endif /* GPIOE */
#define __HAL_RCC_GPIOF_FORCE_RESET()                                          \
    SET_BIT(RCC->IOPRSTR, RCC_IOPRSTR_GPIOFRST)
...
#define __HAL_RCC_GPIOD_RELEASE_RESET()                                        \
    CLEAR_BIT(RCC->IOPRSTR, RCC_IOPRSTR_GPIODRST)
#if defined(GPIOE)
#    define __HAL_RCC_GPIOE_RELEASE_RESET()                                    \
        CLEAR_BIT(RCC->IOPRSTR, RCC_IOPRSTR_GPIOERST)
#endif /* GPIOE */
#define __HAL_RCC_GPIOF_RELEASE_RESET()                                        \
    CLEAR_BIT(RCC->IOPRSTR, RCC_IOPRSTR_GPIOFRST)
...
#    define __HAL_RCC_TIM2_FORCE_RESET()                                       \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_TIM2RST)
#endif /* TIM2 */
#define __HAL_RCC_TIM3_FORCE_RESET()                                           \
    SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_TIM3RST)
#if defined(TIM4)
#    define __HAL_RCC_TIM4_FORCE_RESET()                                       \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_TIM4RST)
#endif /* TIM4 */
#define __HAL_RCC_TIM6_FORCE_RESET()                                           \
    SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_TIM6RST)
#define __HAL_RCC_TIM7_FORCE_RESET()                                           \
    SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_TIM7RST)
#if defined(CRS)
#    define __HAL_RCC_CRS_FORCE_RESET()                                        \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_CRSRST)
#endif /* CRS */
#define __HAL_RCC_SPI2_FORCE_RESET()                                           \
    SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_SPI2RST)
#if defined(SPI3)
#    define __HAL_RCC_SPI3_FORCE_RESET()                                       \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_SPI3RST)
#endif /* SPI3 */
...
#define __HAL_RCC_USART4_FORCE_RESET()                                         \
    SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_USART4RST)
#if defined(USART5)
#    define __HAL_RCC_USART5_FORCE_RESET()                                     \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_USART5RST)
#endif /* USART5 */
#if defined(USART6)
#    define __HAL_RCC_USART6_FORCE_RESET()                                     \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_USART6RST)
#endif /* USART6 */
#if defined(LPUART1)
#    define __HAL_RCC_LPUART1_FORCE_RESET()                                    \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_LPUART1RST)
#endif /* LPUART1 */
#if defined(LPUART2)
#    define __HAL_RCC_LPUART2_FORCE_RESET()                                    \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_LPUART2RST)
#endif /* LPUART2 */
...
#    define __HAL_RCC_I2C3_FORCE_RESET()                                       \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_I2C3RST)
#endif /* I2C3 */
#if defined(CEC)
#    define __HAL_RCC_CEC_FORCE_RESET()                                        \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_CECRST)
#endif /* CEC */
#if defined(UCPD1)
#    define __HAL_RCC_UCPD1_FORCE_RESET()                                      \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_UCPD1RST)
#endif /* UCPD1 */
#if defined(UCPD2)
#    define __HAL_RCC_UCPD2_FORCE_RESET()                                      \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_UCPD2RST)
#endif /* UCPD2 */
#if defined(STM32G0B0xx) || defined(STM32G0B1xx) || defined(STM32G0C1xx)
#    define __HAL_RCC_USB_FORCE_RESET()                                        \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_USBRST)
#endif /* STM32G0B0xx || STM32G0B1xx || STM32G0C1xx */
#if defined(FDCAN1) || defined(FDCAN2)
#    define __HAL_RCC_FDCAN_FORCE_RESET()                                      \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_FDCANRST)
#endif /* FDCAN1 || FDCAN2 */
#define __HAL_RCC_DBGMCU_FORCE_RESET()                                         \
    SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_DBGRST)
#define __HAL_RCC_PWR_FORCE_RESET() SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_PWRRST)
#if defined(DAC1)
#    define __HAL_RCC_DAC1_FORCE_RESET()                                       \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_DAC1RST)
#endif /* DAC1 */
#if defined(LPTIM2)
#    define __HAL_RCC_LPTIM2_FORCE_RESET()                                     \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_LPTIM2RST)
#endif /* LPTIM2 */
#if defined(LPTIM1)
#    define __HAL_RCC_LPTIM1_FORCE_RESET()                                     \
        SET_BIT(RCC->APBRSTR1, RCC_APBRSTR1_LPTIM1RST)
#endif /* LPTIM1 */
#define __HAL_RCC_APB1_RELEASE_RESET() WRITE_REG(RCC->APBRSTR1, 0x00000000U)
#if defined(TIM2)
#    define __HAL_RCC_TIM2_RELEASE_RESET()                                     \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_TIM2RST)
#endif /* TIM2 */
#define __HAL_RCC_TIM3_RELEASE_RESET()                                         \
    CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_TIM3RST)
#if defined(TIM4)
#    define __HAL_RCC_TIM4_RELEASE_RESET()                                     \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_TIM4RST)
#endif /* TIM4 */
#define __HAL_RCC_TIM6_RELEASE_RESET()                                         \
    CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_TIM6RST)
#define __HAL_RCC_TIM7_RELEASE_RESET()                                         \
    CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_TIM7RST)
#if defined(CRS)
#    define __HAL_RCC_CRS_RELEASE_RESET()                                      \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_CRSRST)
#endif /* CRS */
#define __HAL_RCC_SPI2_RELEASE_RESET()                                         \
    CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_SPI2RST)
#if defined(SPI3)
#    define __HAL_RCC_SPI3_RELEASE_RESET()                                     \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_SPI3RST)
#endif /* SPI3 */
...
#define __HAL_RCC_USART4_RELEASE_RESET()                                       \
    CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_USART4RST)
#if defined(USART5)
#    define __HAL_RCC_USART5_RELEASE_RESET()                                   \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_USART5RST)
#endif /* USART5 */
#if defined(USART6)
#    define __HAL_RCC_USART6_RELEASE_RESET()                                   \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_USART6RST)
#endif /* USART6 */
#if defined(LPUART1)
#    define __HAL_RCC_LPUART1_RELEASE_RESET()                                  \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_LPUART1RST)
#endif /* LPUART1 */
#if defined(LPUART2)
#    define __HAL_RCC_LPUART2_RELEASE_RESET()                                  \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_LPUART2RST)
#endif /* LPUART2 */
...
#    define __HAL_RCC_I2C3_RELEASE_RESET()                                     \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_I2C3RST)
#endif /* I2C3 */
#if defined(CEC)
#    define __HAL_RCC_CEC_RELEASE_RESET()                                      \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_CECRST)
#endif /* CEC */
#if defined(UCPD1)
#    define __HAL_RCC_UCPD1_RELEASE_RESET()                                    \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_UCPD1RST)
#endif /* UCPD1 */
#if defined(UCPD2)
#    define __HAL_RCC_UCPD2_RELEASE_RESET()                                    \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_UCPD2RST)
#endif /* UCPD2 */
#if defined(STM32G0B0xx) || defined(STM32G0B1xx) || defined(STM32G0C1xx)
#    define __HAL_RCC_USB_RELEASE_RESET()                                      \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_USBRST)
#endif /* STM32G0B0xx || STM32G0B1xx || STM32G0C1xx */
#if defined(FDCAN1) || defined(FDCAN2)
#    define __HAL_RCC_FDCAN_RELEASE_RESET()                                    \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_FDCANRST)
#endif /* FDCAN1 || FDCAN2 */
#define __HAL_RCC_DBGMCU_RELEASE_RESET()                                       \
    CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_DBGRST)
#define __HAL_RCC_PWR_RELEASE_RESET()                                          \
    CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_PWRRST)
#if defined(DAC1)
#    define __HAL_RCC_DAC1_RELEASE_RESET()                                     \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_DAC1RST)
#endif /* DAC1 */
#if defined(LPTIM2)
#    define __HAL_RCC_LPTIM2_RELEASE_RESET()                                   \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_LPTIM2RST)
#endif /* LPTIM2 */
#if defined(LPTIM1)
#    define __HAL_RCC_LPTIM1_RELEASE_RESET()                                   \
        CLEAR_BIT(RCC->APBRSTR1, RCC_APBRSTR1_LPTIM1RST)
#endif /* LPTIM1 */
/**
 * @}
 */
...
#define __HAL_RCC_SYSCFG_FORCE_RESET()                                         \
    SET_BIT(RCC->APBRSTR2, RCC_APBRSTR2_SYSCFGRST)
#define __HAL_RCC_TIM1_FORCE_RESET()                                           \
    SET_BIT(RCC->APBRSTR2, RCC_APBRSTR2_TIM1RST)
...
#define __HAL_RCC_TIM14_FORCE_RESET()                                          \
    SET_BIT(RCC->APBRSTR2, RCC_APBRSTR2_TIM14RST)
#if defined(TIM15)
#    define __HAL_RCC_TIM15_FORCE_RESET()                                      \
        SET_BIT(RCC->APBRSTR2, RCC_APBRSTR2_TIM15RST)
#endif /* TIM15 */
#define __HAL_RCC_TIM16_FORCE_RESET()                                          \
    SET_BIT(RCC->APBRSTR2, RCC_APBRSTR2_TIM16RST)
#define __HAL_RCC_TIM17_FORCE_RESET()                                          \
    SET_BIT(RCC->APBRSTR2, RCC_APBRSTR2_TIM17RST)
...
#define __HAL_RCC_SYSCFG_RELEASE_RESET()                                       \
    CLEAR_BIT(RCC->APBRSTR2, RCC_APBRSTR2_SYSCFGRST)
#define __HAL_RCC_TIM1_RELEASE_RESET()                                         \
    CLEAR_BIT(RCC->APBRSTR2, RCC_APBRSTR2_TIM1RST)
...
#define __HAL_RCC_DMA1_CLK_SLEEP_ENABLE()                                      \
    SET_BIT(RCC->AHBSMENR, RCC_AHBSMENR_DMA1SMEN)
#if defined(DMA2)
#    define __HAL_RCC_DMA2_CLK_SLEEP_ENABLE()                                  \
        SET_BIT(RCC->AHBSMENR, RCC_AHBSMENR_DMA2SMEN)
#endif /* DMA2 */
#define __HAL_RCC_FLASH_CLK_SLEEP_ENABLE()                                     \
    SET_BIT(RCC->AHBSMENR, RCC_AHBSMENR_FLASHSMEN)
#define __HAL_RCC_SRAM_CLK_SLEEP_ENABLE()                                      \
    SET_BIT(RCC->AHBSMENR, RCC_AHBSMENR_SRAMSMEN)
#define __HAL_RCC_CRC_CLK_SLEEP_ENABLE()                                       \
    SET_BIT(RCC->AHBSMENR, RCC_AHBSMENR_CRCSMEN)
#if defined(RNG)
#    define __HAL_RCC_RNG_CLK_SLEEP_ENABLE()                                   \
        SET_BIT(RCC->AHBSMENR, RCC_AHBSMENR_RNGSMEN)
#endif /* RNG */
#if defined(AES)
#    define __HAL_RCC_AES_CLK_SLEEP_ENABLE()                                   \
        SET_BIT(RCC->AHBSMENR, RCC_AHBSMENR_AESSMEN)
#endif /* AES */
#define __HAL_RCC_DMA1_CLK_SLEEP_DISABLE()                                     \
    CLEAR_BIT(RCC->AHBSMENR, RCC_AHBSMENR_DMA1SMEN)
#if defined(DMA2)
#    define __HAL_RCC_DMA2_CLK_SLEEP_DISABLE()                                 \
        CLEAR_BIT(RCC->AHBSMENR, RCC_AHBSMENR_DMA2SMEN)
#endif /* DMA2 */
#define __HAL_RCC_FLASH_CLK_SLEEP_DISABLE()                                    \
    CLEAR_BIT(RCC->AHBSMENR, RCC_AHBSMENR_FLASHSMEN)
#define __HAL_RCC_SRAM_CLK_SLEEP_DISABLE()                                     \
    CLEAR_BIT(RCC->AHBSMENR, RCC_AHBSMENR_SRAMSMEN)
#define __HAL_RCC_CRC_CLK_SLEEP_DISABLE()                                      \
    CLEAR_BIT(RCC->AHBSMENR, RCC_AHBSMENR_CRCSMEN)
#if defined(RNG)
#    define __HAL_RCC_RNG_CLK_SLEEP_DISABLE()                                  \
        CLEAR_BIT(RCC->AHBSMENR, RCC_AHBSMENR_RNGSMEN)
#endif /* RNG */
#if defined(AES)
#    define __HAL_RCC_AES_CLK_SLEEP_DISABLE()                                  \
        CLEAR_BIT(RCC->AHBSMENR, RCC_AHBSMENR_AESSMEN)
#endif /* AES */
...
#define __HAL_RCC_GPIOC_CLK_SLEEP_ENABLE()                                     \
    SET_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIOCSMEN)
#define __HAL_RCC_GPIOD_CLK_SLEEP_ENABLE()                                     \
    SET_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIODSMEN)
#if defined(GPIOE)
#    define __HAL_RCC_GPIOE_CLK_SLEEP_ENABLE()                                 \
        SET_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIOESMEN)
#endif /* GPIOE */
#define __HAL_RCC_GPIOF_CLK_SLEEP_ENABLE()                                     \
    SET_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIOFSMEN)

#define __HAL_RCC_GPIOA_CLK_SLEEP_DISABLE()                                    \
    CLEAR_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIOASMEN)
#define __HAL_RCC_GPIOB_CLK_SLEEP_DISABLE()                                    \
    CLEAR_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIOBSMEN)
#define __HAL_RCC_GPIOC_CLK_SLEEP_DISABLE()                                    \
    CLEAR_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIOCSMEN)
#define __HAL_RCC_GPIOD_CLK_SLEEP_DISABLE()                                    \
    CLEAR_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIODSMEN)
#if defined(GPIOE)
#    define __HAL_RCC_GPIOE_CLK_SLEEP_DISABLE()                                \
        CLEAR_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIOESMEN)
#endif /* GPIOE */
#define __HAL_RCC_GPIOF_CLK_SLEEP_DISABLE()                                    \
    CLEAR_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIOFSMEN)
/**
 *   @}
 */
...
#    define __HAL_RCC_TIM2_CLK_SLEEP_ENABLE()                                  \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_TIM2SMEN)
#endif /* TIM2 */
#define __HAL_RCC_TIM3_CLK_SLEEP_ENABLE()                                      \
    SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_TIM3SMEN)
#if defined(TIM4)
#    define __HAL_RCC_TIM4_CLK_SLEEP_ENABLE()                                  \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_TIM4SMEN)
#endif /* TIM4 */
#define __HAL_RCC_TIM6_CLK_SLEEP_ENABLE()                                      \
    SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_TIM6SMEN)
#define __HAL_RCC_TIM7_CLK_SLEEP_ENABLE()                                      \
    SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_TIM7SMEN)
#if defined(CRS)
#    define __HAL_RCC_CRS_CLK_SLEEP_ENABLE()                                   \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_CRSSMEN)
#endif /* CRS */
#define __HAL_RCC_RTCAPB_CLK_SLEEP_ENABLE()                                    \
    SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_RTCAPBSMEN)
#define __HAL_RCC_WWDG_CLK_SLEEP_ENABLE()                                      \
    SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_WWDGSMEN)
#define __HAL_RCC_SPI2_CLK_SLEEP_ENABLE()                                      \
    SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_SPI2SMEN)
#if defined(SPI3)
#    define __HAL_RCC_SPI3_CLK_SLEEP_ENABLE()                                  \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_SPI3SMEN)
#endif /* SPI3 */
#define __HAL_RCC_USART2_CLK_SLEEP_ENABLE()                                    \
    SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART2SMEN)
#define __HAL_RCC_USART3_CLK_SLEEP_ENABLE()                                    \
    SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART3SMEN)
#define __HAL_RCC_USART4_CLK_SLEEP_ENABLE()                                    \
    SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART4SMEN)
#if defined(USART5)
#    define __HAL_RCC_USART5_CLK_SLEEP_ENABLE()                                \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART5SMEN)
#endif /* USART5 */
#if defined(USART6)
#    define __HAL_RCC_USART6_CLK_SLEEP_ENABLE()                                \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART6SMEN)
#endif /* USART6 */
#if defined(LPUART1)
#    define __HAL_RCC_LPUART1_CLK_SLEEP_ENABLE()                               \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_LPUART1SMEN)
#endif /* LPUART1 */
#if defined(LPUART2)
#    define __HAL_RCC_LPUART2_CLK_SLEEP_ENABLE()                               \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_LPUART2SMEN)
#endif /* LPUART2 */
#define __HAL_RCC_I2C1_CLK_SLEEP_ENABLE()                                      \
    SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_I2C1SMEN)
#define __HAL_RCC_I2C2_CLK_SLEEP_ENABLE()                                      \
    SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_I2C2SMEN)
#if defined(I2C3)
...
#    define __HAL_RCC_CEC_CLK_SLEEP_ENABLE()                                   \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_CECSMEN)
#endif /* CEC */
#if defined(UCPD1)
#    define __HAL_RCC_UCPD1_CLK_SLEEP_ENABLE()                                 \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_UCPD1SMEN)
#endif /* UCPD1 */
#if defined(UCPD2)
#    define __HAL_RCC_UCPD2_CLK_SLEEP_ENABLE()                                 \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_UCPD2SMEN)
#endif /* UCPD2 */
#if defined(STM32G0B0xx) || defined(STM32G0B1xx) || defined(STM32G0C1xx)
#    define __HAL_RCC_USB_CLK_SLEEP_ENABLE()                                   \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USBSMEN)
#endif /* STM32G0B0xx || STM32G0B1xx || STM32G0C1xx */
#if defined(FDCAN1) || defined(FDCAN2)
#    define __HAL_RCC_FDCAN_CLK_SLEEP_ENABLE()                                 \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_FDCANSMEN)
#endif /* FDCAN1 || FDCAN2 */
#define __HAL_RCC_DBGMCU_CLK_SLEEP_ENABLE()                                    \
    SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_DBGSMEN)
#define __HAL_RCC_PWR_CLK_SLEEP_ENABLE()                                       \
    SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_PWRSMEN)
#if defined(DAC1)
#    define __HAL_RCC_DAC1_CLK_SLEEP_ENABLE()                                  \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_DAC1SMEN)
#endif /* DAC1 */
#if defined(LPTIM2)
#    define __HAL_RCC_LPTIM2_CLK_SLEEP_ENABLE()                                \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_LPTIM2SMEN)
#endif /* LPTIM2 */
#if defined(LPTIM1)
#    define __HAL_RCC_LPTIM1_CLK_SLEEP_ENABLE()                                \
        SET_BIT(RCC->APBSMENR1, RCC_APBSMENR1_LPTIM1SMEN)
#endif /* LPTIM1 */
#if defined(TIM2)
#    define __HAL_RCC_TIM2_CLK_SLEEP_DISABLE()                                 \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_TIM2SMEN)
#endif /* TIM2 */
#define __HAL_RCC_TIM3_CLK_SLEEP_DISABLE()                                     \
    CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_TIM3SMEN)
#if defined(TIM4)
...
#define __HAL_RCC_TIM6_CLK_SLEEP_DISABLE()                                     \
    CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_TIM6SMEN)
#define __HAL_RCC_TIM7_CLK_SLEEP_DISABLE()                                     \
    CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_TIM7SMEN)
#if defined(CRS)
#    define __HAL_RCC_CRS_CLK_SLEEP_DISABLE()                                  \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_CRSSMEN)
#endif /* CRS */
#define __HAL_RCC_RTCAPB_CLK_SLEEP_DISABLE()                                   \
    CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_RTCAPBSMEN)
#define __HAL_RCC_WWDG_CLK_SLEEP_DISABLE()                                     \
    CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_WWDGSMEN)
#define __HAL_RCC_SPI2_CLK_SLEEP_DISABLE()                                     \
    CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_SPI2SMEN)
#if defined(SPI3)
#    define __HAL_RCC_SPI3_CLK_SLEEP_DISABLE()                                 \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_SPI3SMEN)
#endif /* TIM2 */
#define __HAL_RCC_USART2_CLK_SLEEP_DISABLE()                                   \
    CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART2SMEN)
#define __HAL_RCC_USART3_CLK_SLEEP_DISABLE()                                   \
    CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART3SMEN)
#define __HAL_RCC_USART4_CLK_SLEEP_DISABLE()                                   \
    CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART4SMEN)
#if defined(USART5)
#    define __HAL_RCC_USART5_CLK_SLEEP_DISABLE()                               \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART5SMEN)
#endif /* USART5 */
#if defined(USART6)
#    define __HAL_RCC_USART6_CLK_SLEEP_DISABLE()                               \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART6SMEN)
#endif /* USART6 */
#if defined(LPUART1)
#    define __HAL_RCC_LPUART1_CLK_SLEEP_DISABLE()                              \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_LPUART1SMEN)
#endif /* LPUART1 */
#if defined(LPUART2)
#    define __HAL_RCC_LPUART2_CLK_SLEEP_DISABLE()                              \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_LPUART2SMEN)
#endif /* LPUART2 */
#define __HAL_RCC_I2C1_CLK_SLEEP_DISABLE()                                     \
    CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_I2C1SMEN)
#define __HAL_RCC_I2C2_CLK_SLEEP_DISABLE()                                     \
    CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_I2C2SMEN)
#if defined(I2C3)
#    define __HAL_RCC_I2C3_CLK_SLEEP_DISABLE()                                 \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_I2C3SMEN)
#endif /* I2C3 */
#if defined(CEC)
#    define __HAL_RCC_CEC_CLK_SLEEP_DISABLE()                                  \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_CECSMEN)
#endif /* CEC */
#if defined(UCPD1)
#    define __HAL_RCC_UCPD1_CLK_SLEEP_DISABLE()                                \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_UCPD1SMEN)
#endif /* UCPD1 */
#if defined(UCPD2)
#    define __HAL_RCC_UCPD2_CLK_SLEEP_DISABLE()                                \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_UCPD2SMEN)
#endif /* UCPD2 */
#if defined(STM32G0B0xx) || defined(STM32G0B1xx) || defined(STM32G0C1xx)
#    define __HAL_RCC_USB_CLK_SLEEP_DISABLE()                                  \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USBSMEN)
#endif /* STM32G0B0xx || STM32G0B1xx || STM32G0C1xx */
#if defined(FDCAN1) || defined(FDCAN2)
#    define __HAL_RCC_FDCAN_CLK_SLEEP_DISABLE()                                \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_FDCANSMEN)
#endif /* FDCAN1) || FDCAN2 */
#define __HAL_RCC_DBGMCU_CLK_SLEEP_DISABLE()                                   \
    CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_DBGSMEN)
#define __HAL_RCC_PWR_CLK_SLEEP_DISABLE()                                      \
    CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_PWRSMEN)
#if defined(DAC1)
#    define __HAL_RCC_DAC1_CLK_SLEEP_DISABLE()                                 \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_DAC1SMEN)
#endif /* DAC1 */
#if defined(LPTIM2)
#    define __HAL_RCC_LPTIM2_CLK_SLEEP_DISABLE()                               \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_LPTIM2SMEN)
#endif /* LPTIM2 */
#if defined(LPTIM1)
#    define __HAL_RCC_LPTIM1_CLK_SLEEP_DISABLE()                               \
        CLEAR_BIT(RCC->APBSMENR1, RCC_APBSMENR1_LPTIM1SMEN)
#endif /* LPTIM1 */
/**
 * @}
 */
...
#define __HAL_RCC_SYSCFG_CLK_SLEEP_ENABLE()                                    \
    SET_BIT(RCC->APBSMENR2, RCC_APBSMENR2_SYSCFGSMEN)
#define __HAL_RCC_TIM1_CLK_SLEEP_ENABLE()                                      \
    SET_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM1SMEN)
#define __HAL_RCC_SPI1_CLK_SLEEP_ENABLE()                                      \
    SET_BIT(RCC->APBSMENR2, RCC_APBSMENR2_SPI1SMEN)
#define __HAL_RCC_USART1_CLK_SLEEP_ENABLE()                                    \
    SET_BIT(RCC->APBSMENR2, RCC_APBSMENR2_USART1SMEN)
#define __HAL_RCC_TIM14_CLK_SLEEP_ENABLE()                                     \
    SET_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM14SMEN)
#if defined(TIM15)
#    define __HAL_RCC_TIM15_CLK_SLEEP_ENABLE()                                 \
        SET_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM15SMEN)
#endif /* TIM15 */
#define __HAL_RCC_TIM16_CLK_SLEEP_ENABLE()                                     \
    SET_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM16SMEN)
#define __HAL_RCC_TIM17_CLK_SLEEP_ENABLE()                                     \
    SET_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM17SMEN)
#define __HAL_RCC_ADC_CLK_SLEEP_ENABLE()                                       \
    SET_BIT(RCC->APBSMENR2, RCC_APBSMENR2_ADCSMEN)

#define __HAL_RCC_SYSCFG_CLK_SLEEP_DISABLE()                                   \
    CLEAR_BIT(RCC->APBSMENR2, RCC_APBSMENR2_SYSCFGSMEN)
#define __HAL_RCC_TIM1_CLK_SLEEP_DISABLE()                                     \
    CLEAR_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM1SMEN)
#define __HAL_RCC_SPI1_CLK_SLEEP_DISABLE()                                     \
    CLEAR_BIT(RCC->APBSMENR2, RCC_APBSMENR2_SPI1SMEN)
#define __HAL_RCC_USART1_CLK_SLEEP_DISABLE()                                   \
    CLEAR_BIT(RCC->APBSMENR2, RCC_APBSMENR2_USART1SMEN)
#define __HAL_RCC_TIM14_CLK_SLEEP_DISABLE()                                    \
    CLEAR_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM14SMEN)
#if defined(TIM15)
#    define __HAL_RCC_TIM15_CLK_SLEEP_DISABLE()                                \
        CLEAR_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM15SMEN)
#endif /* TIM15 */
#define __HAL_RCC_TIM16_CLK_SLEEP_DISABLE()                                    \
    CLEAR_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM16SMEN)
#define __HAL_RCC_TIM17_CLK_SLEEP_DISABLE()                                    \
    CLEAR_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM17SMEN)
#define __HAL_RCC_ADC_CLK_SLEEP_DISABLE()                                      \
    CLEAR_BIT(RCC->APBSMENR2, RCC_APBSMENR2_ADCSMEN)
...
#define __HAL_RCC_DMA1_IS_CLK_SLEEP_ENABLED()                                  \
    (READ_BIT(RCC->AHBSMENR, RCC_AHBSMENR_DMA1SMEN) != RESET)
#if defined(DMA2)
#    define __HAL_RCC_DMA2_IS_CLK_SLEEP_ENABLED()                              \
        (READ_BIT(RCC->AHBSMENR, RCC_AHBSMENR_DMA2SMEN) != RESET)
#endif /* DMA2 */
#define __HAL_RCC_FLASH_IS_CLK_SLEEP_ENABLED()                                 \
    (READ_BIT(RCC->AHBSMENR, RCC_AHBSMENR_FLASHSMEN) != RESET)
#define __HAL_RCC_SRAM_IS_CLK_SLEEP_ENABLED()                                  \
    (READ_BIT(RCC->AHBSMENR, RCC_AHBSMENR_SRAMSMEN) != RESET)
#define __HAL_RCC_CRC_IS_CLK_SLEEP_ENABLED()                                   \
    (READ_BIT(RCC->AHBSMENR, RCC_AHBSMENR_CRCSMEN) != RESET)
#if defined(RNG)
#    define __HAL_RCC_RNG_IS_CLK_SLEEP_ENABLED()                               \
        (READ_BIT(RCC->AHBSMENR, RCC_AHBSMENR_RNGSMEN) != RESET)
#endif /* RNG */
#if defined(AES)
#    define __HAL_RCC_AES_IS_CLK_SLEEP_ENABLED()                               \
        (READ_BIT(RCC->AHBSMENR, RCC_AHBSMENR_AESSMEN) != RESET)
#endif /* AES */
...
#define __HAL_RCC_FLASH_IS_CLK_SLEEP_DISABLED()                                \
    (READ_BIT(RCC->AHBSMENR, RCC_AHBSMENR_FLASHSMEN) == RESET)
#define __HAL_RCC_SRAM_IS_CLK_SLEEP_DISABLED()                                 \
    (READ_BIT(RCC->AHBSMENR, RCC_AHBSMENR_SRAMSMEN) == RESET)
...
#define __HAL_RCC_GPIOA_IS_CLK_SLEEP_ENABLED()                                 \
    (READ_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIOASMEN) != RESET)
#define __HAL_RCC_GPIOB_IS_CLK_SLEEP_ENABLED()                                 \
    (READ_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIOBSMEN) != RESET)
#define __HAL_RCC_GPIOC_IS_CLK_SLEEP_ENABLED()                                 \
    (READ_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIOCSMEN) != RESET)
#define __HAL_RCC_GPIOD_IS_CLK_SLEEP_ENABLED()                                 \
    (READ_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIODSMEN) != RESET)
#if defined(GPIOE)
#    define __HAL_RCC_GPIOE_IS_CLK_SLEEP_ENABLED()                             \
        (READ_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIOESMEN) != RESET)
#endif /* GPIOE */
#define __HAL_RCC_GPIOF_IS_CLK_SLEEP_ENABLED()                                 \
    (READ_BIT(RCC->IOPSMENR, RCC_IOPSMENR_GPIOFSMEN) != RESET)
...
#    define __HAL_RCC_TIM2_IS_CLK_SLEEP_ENABLED()                              \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_TIM2SMEN) != RESET)
#endif /* TIM2 */
#define __HAL_RCC_TIM3_IS_CLK_SLEEP_ENABLED()                                  \
    (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_TIM3SMEN) != RESET)
#if defined(TIM4)
#    define __HAL_RCC_TIM4_IS_CLK_SLEEP_ENABLED()                              \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_TIM4SMEN) != RESET)
#endif /* TIM4 */
#if defined(TIM6)
#    define __HAL_RCC_TIM6_IS_CLK_SLEEP_ENABLED()                              \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_TIM6SMEN) != RESET)
#endif /* TIM6 */
#if defined(TIM7)
#    define __HAL_RCC_TIM7_IS_CLK_SLEEP_ENABLED()                              \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_TIM7SMEN) != RESET)
#endif /* TIM7 */
#if defined(CRS)
#    define __HAL_RCC_CRS_IS_CLK_SLEEP_ENABLED()                               \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_CRSSMEN) != RESET)
#endif /* CRS */
#define __HAL_RCC_RTCAPB_IS_CLK_SLEEP_ENABLED()                                \
    (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_RTCAPBSMEN) != RESET)
#define __HAL_RCC_WWDG_IS_CLK_SLEEP_ENABLED()                                  \
    (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_WWDGSMEN) != RESET)
#define __HAL_RCC_SPI2_IS_CLK_SLEEP_ENABLED()                                  \
    (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_SPI2SMEN) != RESET)
#if defined(SPI3)
#    define __HAL_RCC_SPI3_IS_CLK_SLEEP_ENABLED()                              \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_SPI3SMEN) != RESET)
#endif /* SPI3 */
#define __HAL_RCC_USART2_IS_CLK_SLEEP_ENABLED()                                \
    (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART2SMEN) != RESET)
#if defined(USART3)
#    define __HAL_RCC_USART3_IS_CLK_SLEEP_ENABLED()                            \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART3SMEN) != RESET)
#endif /* USART3 */
#if defined(USART4)
#    define __HAL_RCC_USART4_IS_CLK_SLEEP_ENABLED()                            \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART4SMEN) != RESET)
#endif /* USART4 */
#if defined(USART5)
#    define __HAL_RCC_USART5_IS_CLK_SLEEP_ENABLED()                            \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART5SMEN) != RESET)
#endif /* USART5 */
#if defined(USART6)
#    define __HAL_RCC_USART6_IS_CLK_SLEEP_ENABLED()                            \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART6SMEN) != RESET)
#endif /* USART6 */
#if defined(LPUART1)
#    define __HAL_RCC_LPUART1_IS_CLK_SLEEP_ENABLED()                           \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_LPUART1SMEN) != RESET)
#endif /* LPUART1 */
#if defined(LPUART2)
#    define __HAL_RCC_LPUART2_IS_CLK_SLEEP_ENABLED()                           \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_LPUART2SMEN) != RESET)
#endif /* LPUART2 */
#define __HAL_RCC_I2C1_IS_CLK_SLEEP_ENABLED()                                  \
    (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_I2C1SMEN) != RESET)
#define __HAL_RCC_I2C2_IS_CLK_SLEEP_ENABLED()                                  \
    (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_I2C2SMEN) != RESET)
#if defined(I2C3)
#    define __HAL_RCC_I2C3_IS_CLK_SLEEP_ENABLED()                              \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_I2C3SMEN) != RESET)
#endif /* I2C3 */
#if defined(CEC)
#    define __HAL_RCC_CEC_IS_CLK_SLEEP_ENABLED()                               \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_CECSMEN) != RESET)
#endif /* CEC */
#if defined(UCPD1)
#    define __HAL_RCC_UCPD1_IS_CLK_SLEEP_ENABLED()                             \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_UCPD1SMEN) != RESET)
#endif /* UCPD1 */
#if defined(UCPD2)
#    define __HAL_RCC_UCPD2_IS_CLK_SLEEP_ENABLED()                             \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_UCPD2SMEN) != RESET)
#endif /* UCPD2 */
#if defined(STM32G0B0xx) || defined(STM32G0B1xx) || defined(STM32G0C1xx)
#    define __HAL_RCC_USB_IS_CLK_SLEEP_ENABLED()                               \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USBSMEN) != RESET)
#endif /* STM32G0B0xx || STM32G0B1xx || STM32G0C1xx */
#if defined(FDCAN1) || defined(FDCAN2)
#    define __HAL_RCC_FDCAN_IS_CLK_SLEEP_ENABLED()                             \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_FDCANSMEN) != RESET)
#endif /* FDCAN1 || FDCAN2 */
#define __HAL_RCC_DBGMCU_IS_CLK_SLEEP_ENABLED()                                \
    (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_DBGSMEN) != RESET)
#define __HAL_RCC_PWR_IS_CLK_SLEEP_ENABLED()                                   \
    (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_PWRSMEN) != RESET)
#if defined(DAC1)
#    define __HAL_RCC_DAC1_IS_CLK_SLEEP_ENABLED()                              \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_DAC1SMEN) != RESET)
#endif /* DAC1 */
#if defined(LPTIM2)
#    define __HAL_RCC_LPTIM2_IS_CLK_SLEEP_ENABLED()                            \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_LPTIM2SMEN) != RESET)
#endif /* LPTIM2 */
#if defined(LPTIM1)
#    define __HAL_RCC_LPTIM1_IS_CLK_SLEEP_ENABLED()                            \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_LPTIM1SMEN) != RESET)
#endif /* LPTIM1 */
#if defined(TIM2)
...
#endif /* USART3 */
#if defined(USART4)
#    define __HAL_RCC_USART4_IS_CLK_SLEEP_DISABLED()                           \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART4SMEN) == RESET)
#endif /* USART4 */
#if defined(USART5)
#    define __HAL_RCC_USART5_IS_CLK_SLEEP_DISABLED()                           \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART5SMEN) == RESET)
#endif /* USART5 */
#if defined(USART6)
#    define __HAL_RCC_USART6_IS_CLK_SLEEP_DISABLED()                           \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_USART6SMEN) == RESET)
#endif /* USART6 */
#if defined(LPUART1)
...
#endif /* LPUART1 */
#if defined(LPUART2)
#    define __HAL_RCC_LPUART2_IS_CLK_SLEEP_DISABLED()                          \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_LPUART2SMEN) == RESET)
#endif /* LPUART2 */
...
#endif /* I2C3 */
#if defined(CEC)
#    define __HAL_RCC_CEC_IS_CLK_SLEEP_DISABLED()                              \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_CECSMEN) == RESET)
#endif /* CEC */
#if defined(UCPD1)
...
#endif /* UCPD1 */
#if defined(UCPD2)
#    define __HAL_RCC_UCPD2_IS_CLK_SLEEP_DISABLED()                            \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_UCPD2SMEN) == RESET)
#endif /* UCPD2 */
#if defined(STM32G0B0xx) || defined(STM32G0B1xx) || defined(STM32G0C1xx)
...
#    define __HAL_RCC_FDCAN_IS_CLK_SLEEP_DISABLED()                            \
        (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_FDCANSMEN) == RESET)
#endif /* FDCAN1 || FDCAN2 */
#define __HAL_RCC_DBGMCU_IS_CLK_SLEEP_DISABLED()                               \
    (READ_BIT(RCC->APBSMENR1, RCC_APBSMENR1_DBGSMEN) == RESET)
...
#define __HAL_RCC_SYSCFG_IS_CLK_SLEEP_ENABLED()                                \
    (READ_BIT(RCC->APBSMENR2, RCC_APBSMENR2_SYSCFGSMEN) != RESET)
#define __HAL_RCC_TIM1_IS_CLK_SLEEP_ENABLED()                                  \
    (READ_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM1SMEN) != RESET)
#define __HAL_RCC_SPI1_IS_CLK_SLEEP_ENABLED()                                  \
    (READ_BIT(RCC->APBSMENR2, RCC_APBSMENR2_SPI1SMEN) != RESET)
#define __HAL_RCC_USART1_IS_CLK_SLEEP_ENABLED()                                \
    (READ_BIT(RCC->APBSMENR2, RCC_APBSMENR2_USART1SMEN) != RESET)
#define __HAL_RCC_TIM14_IS_CLK_SLEEP_ENABLED()                                 \
    (READ_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM14SMEN) != RESET)
#if defined(TIM15)
#    define __HAL_RCC_TIM15_IS_CLK_SLEEP_ENABLED()                             \
        (READ_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM15SMEN) != RESET)
#endif /* TIM15 */
#define __HAL_RCC_TIM16_IS_CLK_SLEEP_ENABLED()                                 \
    (READ_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM16SMEN) != RESET)
#define __HAL_RCC_TIM17_IS_CLK_SLEEP_ENABLED()                                 \
    (READ_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM17SMEN) != RESET)
#define __HAL_RCC_ADC_IS_CLK_SLEEP_ENABLED()                                   \
    (READ_BIT(RCC->APBSMENR2, RCC_APBSMENR2_ADCSMEN) != RESET)
...
#define __HAL_RCC_USART1_IS_CLK_SLEEP_DISABLED()                               \
    (READ_BIT(RCC->APBSMENR2, RCC_APBSMENR2_USART1SMEN) == RESET)
#define __HAL_RCC_TIM14_IS_CLK_SLEEP_DISABLED()                                \
    (READ_BIT(RCC->APBSMENR2, RCC_APBSMENR2_TIM14SMEN) == RESET)
#if defined(TIM15)
...
#define __HAL_RCC_HSI_CALIBRATIONVALUE_ADJUST(__HSICALIBRATIONVALUE__)         \
    MODIFY_REG(RCC->ICSCR, RCC_ICSCR_HSITRIM,                                  \
               (uint32_t)(__HSICALIBRATIONVALUE__) << RCC_ICSCR_HSITRIM_Pos)
...
#define __HAL_RCC_GET_RTC_SOURCE()                                             \
    ((uint32_t)(READ_BIT(RCC->BDCR, RCC_BDCR_RTCSEL)))
...
#    define __HAL_RCC_PLL_CONFIG(__PLLSOURCE__, __PLLM__, __PLLN__, __PLLP__,  \
        ...
        MODIFY_REG(RCC->PLLCFGR,                                               \
                   ...
                   ((uint32_t)(__PLLSOURCE__) | (uint32_t)(__PLLM__)           \
                    ...
                    | (uint32_t)(__PLLP__) | (uint32_t)(__PLLQ__)              \
                    | (uint32_t)(__PLLR__)))
#else
#    define __HAL_RCC_PLL_CONFIG(__PLLSOURCE__, __PLLM__, __PLLN__, __PLLP__,  \
                                 __PLLR__)                                     \
...
#    define __HAL_RCC_GET_FLAG(__FLAG__)                                       \
        (((((((__FLAG__) >> 5U) == CR_REG_INDEX)                               \
                ...
                : ((((__FLAG__) >> 5U) == BDCR_REG_INDEX)                      \
                       ? RCC->BDCR                                             \
                       : ((((__FLAG__) >> 5U) == CSR_REG_INDEX) ? RCC->CSR     \
                                                                : RCC->CIFR))) \
           & (1U << ((__FLAG__)&RCC_FLAG_MASK)))                               \
          != RESET)                                                            \
             ? 1U                                                              \
