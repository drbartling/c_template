 ...
 */
#    define LL_CRS_ReadReg(__INSTANCE__, __REG__)                              \
...
LL_CRS_EnableFreqErrorCounter(void)
{
 ...
 */
__STATIC_INLINE void
LL_CRS_DisableFreqErrorCounter(void)
{
 ...
 */
__STATIC_INLINE void
LL_CRS_EnableAutoTrimming(void)
{
 ...
 */
__STATIC_INLINE void
LL_CRS_DisableAutoTrimming(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_CRS_IsEnabledAutoTrimming(void)
{
 ...
 */
__STATIC_INLINE void
LL_CRS_SetHSI48SmoothTrimming(uint32_t Value)
{
 ...
 */
__STATIC_INLINE void
LL_CRS_SetReloadCounter(uint32_t Value)
{
 ...
 */
__STATIC_INLINE void
LL_CRS_SetFreqErrorLimit(uint32_t Value)
{
 ...
 */
__STATIC_INLINE void
LL_CRS_SetSyncDivider(uint32_t Divider)
{
 ...
 */
__STATIC_INLINE void
LL_CRS_SetSyncSignalSource(uint32_t Source)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_CRS_GetSyncSignalSource(void)
{
 ...
 */
__STATIC_INLINE void
LL_CRS_SetSyncPolarity(uint32_t Polarity)
{
 ...
 */
__STATIC_INLINE void
LL_CRS_GenerateEvent_SWSYNC(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_CRS_GetFreqErrorDirection(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_CRS_GetFreqErrorCapture(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_CRS_IsActiveFlag_SYNCOK(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_CRS_IsActiveFlag_ESYNC(void)
{
    return ((READ_BIT(CRS->ISR, CRS_ISR_ESYNCF) == (CRS_ISR_ESYNCF)) ? 1UL
                                                                     : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_CRS_IsActiveFlag_SYNCERR(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_CRS_IsActiveFlag_SYNCMISS(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_CRS_IsActiveFlag_TRIMOVF(void)
{
 ...
 */
__STATIC_INLINE void
LL_CRS_ClearFlag_SYNCWARN(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_CRS_IsEnabledIT_SYNCOK(void)
{
 ...
 */
__STATIC_INLINE void
LL_CRS_DisableIT_SYNCWARN(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_CRS_IsEnabledIT_SYNCWARN(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_CRS_IsEnabledIT_ESYNC(void)
{
    return ((READ_BIT(CRS->CR, CRS_CR_ESYNCIE) == (CRS_CR_ESYNCIE)) ? 1UL
                                                                    : 0UL);
}
