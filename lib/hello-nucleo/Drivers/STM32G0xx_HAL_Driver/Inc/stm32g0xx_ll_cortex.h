...
#    define LL_MPU_CTRL_HFNMI_PRIVDEF                                          \
        (MPU_CTRL_HFNMIENA_Msk | MPU_CTRL_PRIVDEFENA_Msk) /*!< Enable NMI and  \
                                                             privileged SW     \
                                                             access */
/**
 * @}
...
#    define LL_MPU_REGION_SIZE_256B                                            \
        (0x07U << MPU_RASR_SIZE_Pos) /*!< 256B Size of the MPU protection      \
                                        region */
#    define LL_MPU_REGION_SIZE_512B                                            \
        (0x08U << MPU_RASR_SIZE_Pos) /*!< 512B Size of the MPU protection      \
                                        region */
#    define LL_MPU_REGION_SIZE_1KB                                             \
        (0x09U << MPU_RASR_SIZE_Pos) /*!< 1KB Size of the MPU protection       \
                                        region */
#    define LL_MPU_REGION_SIZE_2KB                                             \
        (0x0AU << MPU_RASR_SIZE_Pos) /*!< 2KB Size of the MPU protection       \
                                        region */
#    define LL_MPU_REGION_SIZE_4KB                                             \
        (0x0BU << MPU_RASR_SIZE_Pos) /*!< 4KB Size of the MPU protection       \
                                        region */
#    define LL_MPU_REGION_SIZE_8KB                                             \
        (0x0CU << MPU_RASR_SIZE_Pos) /*!< 8KB Size of the MPU protection       \
                                        region */
#    define LL_MPU_REGION_SIZE_16KB                                            \
        (0x0DU << MPU_RASR_SIZE_Pos) /*!< 16KB Size of the MPU protection      \
                                        region */
#    define LL_MPU_REGION_SIZE_32KB                                            \
        (0x0EU << MPU_RASR_SIZE_Pos) /*!< 32KB Size of the MPU protection      \
                                        region */
#    define LL_MPU_REGION_SIZE_64KB                                            \
        (0x0FU << MPU_RASR_SIZE_Pos) /*!< 64KB Size of the MPU protection      \
                                        region */
#    define LL_MPU_REGION_SIZE_128KB                                           \
        (0x10U << MPU_RASR_SIZE_Pos) /*!< 128KB Size of the MPU protection     \
                                        region */
#    define LL_MPU_REGION_SIZE_256KB                                           \
        (0x11U << MPU_RASR_SIZE_Pos) /*!< 256KB Size of the MPU protection     \
                                        region */
#    define LL_MPU_REGION_SIZE_512KB                                           \
        (0x12U << MPU_RASR_SIZE_Pos) /*!< 512KB Size of the MPU protection     \
                                        region */
#    define LL_MPU_REGION_SIZE_1MB                                             \
        (0x13U << MPU_RASR_SIZE_Pos) /*!< 1MB Size of the MPU protection       \
                                        region */
#    define LL_MPU_REGION_SIZE_2MB                                             \
        (0x14U << MPU_RASR_SIZE_Pos) /*!< 2MB Size of the MPU protection       \
                                        region */
#    define LL_MPU_REGION_SIZE_4MB                                             \
        (0x15U << MPU_RASR_SIZE_Pos) /*!< 4MB Size of the MPU protection       \
                                        region */
#    define LL_MPU_REGION_SIZE_8MB                                             \
        (0x16U << MPU_RASR_SIZE_Pos) /*!< 8MB Size of the MPU protection       \
                                        region */
#    define LL_MPU_REGION_SIZE_16MB                                            \
        (0x17U << MPU_RASR_SIZE_Pos) /*!< 16MB Size of the MPU protection      \
                                        region */
#    define LL_MPU_REGION_SIZE_32MB                                            \
        (0x18U << MPU_RASR_SIZE_Pos) /*!< 32MB Size of the MPU protection      \
                                        region */
#    define LL_MPU_REGION_SIZE_64MB                                            \
        (0x19U << MPU_RASR_SIZE_Pos) /*!< 64MB Size of the MPU protection      \
                                        region */
#    define LL_MPU_REGION_SIZE_128MB                                           \
        (0x1AU << MPU_RASR_SIZE_Pos) /*!< 128MB Size of the MPU protection     \
                                        region */
#    define LL_MPU_REGION_SIZE_256MB                                           \
        (0x1BU << MPU_RASR_SIZE_Pos) /*!< 256MB Size of the MPU protection     \
                                        region */
#    define LL_MPU_REGION_SIZE_512MB                                           \
        (0x1CU << MPU_RASR_SIZE_Pos) /*!< 512MB Size of the MPU protection     \
                                        region */
#    define LL_MPU_REGION_SIZE_1GB                                             \
        (0x1DU << MPU_RASR_SIZE_Pos) /*!< 1GB Size of the MPU protection       \
                                        region */
#    define LL_MPU_REGION_SIZE_2GB                                             \
        (0x1EU << MPU_RASR_SIZE_Pos) /*!< 2GB Size of the MPU protection       \
                                        region */
#    define LL_MPU_REGION_SIZE_4GB                                             \
        (0x1FU << MPU_RASR_SIZE_Pos) /*!< 4GB Size of the MPU protection       \
                                        region */
/**
 * @}
 */
...
LL_SYSTICK_IsActiveCounterFlag(void)
{
...
LL_SYSTICK_SetClkSource(uint32_t Source)
{
 ...
 */
__STATIC_INLINE void
LL_LPM_DisableSleepOnExit(void)
{
 ...
 */
__STATIC_INLINE void
LL_LPM_DisableEventOnPend(void)
{
 ...
 */
__STATIC_INLINE void
LL_MPU_Enable(uint32_t Options)
{
    /* Enable the MPU*/
 ...
 */
__STATIC_INLINE void
LL_MPU_EnableRegion(uint32_t Region)
{
    /* Set Region number */
 ...
 */
__STATIC_INLINE void
LL_MPU_ConfigRegion(uint32_t Region, uint32_t SubRegionDisable,
 ...
 */
__STATIC_INLINE void
LL_MPU_DisableRegion(uint32_t Region)
{
    /* Set Region number */
    WRITE_REG(MPU->RNR, Region);
