...
typedef struct {
    uint32_t SyncSignalID; /*!< Specifies the synchronization signal gating the
                             DMA request in periodic mode. This parameter can be
                             a value of @ref DMAEx_DMAMUX_SyncSignalID_selection
                           */

    uint32_t SyncPolarity; /*!< Specifies the polarity of the signal on which
                             the DMA request is synchronized. This parameter can
                             be a value of @ref
    ...
    FunctionalState EventEnable; /*!< Specifies if an event shall be generated
                                   once the RequestNumber is reached. This
                                   parameter can take the value ENABLE or
                                   DISABLE */

    uint32_t RequestNumber; /*!< Specifies the number of DMA request that will
                              be authorized after a sync event This parameter
                              must be a number between Min_Data = 1 and Max_Data
                              = 32 */
...
typedef struct {
    ...
    uint32_t RequestNumber; /*!< Specifies the number of DMA request that will
                              be generated after a signal event This parameter
                              must be a number between Min_Data = 1 and Max_Data
                              = 32 */
...
#    define HAL_DMAMUX1_SYNC_LPTIM1_OUT                                        \
        LL_DMAMUX_SYNC_LPTIM1_OUT /*!< Synchronization signal from LPTIM1      \
                                     Output */
#endif                            /* LPTIM1 */
#if defined(LPTIM2)
#    define HAL_DMAMUX1_SYNC_LPTIM2_OUT                                        \
        LL_DMAMUX_SYNC_LPTIM2_OUT /*!< Synchronization signal from LPTIM2      \
                                     Output */
#endif                            /* LPTIM2 */
#define HAL_DMAMUX1_SYNC_TIM14_OC                                              \
    LL_DMAMUX_SYNC_TIM14_OC /*!< Synchronization signal from TIM14 OC */
...
#    define HAL_DMAMUX1_REQ_GEN_LPTIM1_OUT                                     \
        LL_DMAMUX_REQ_GEN_LPTIM1_OUT /*!< Request signal generation from       \
                                        LPTIM1 Output */
#endif                               /* LPTIM1 */
#if defined(LPTIM2)
#    define HAL_DMAMUX1_REQ_GEN_LPTIM2_OUT                                     \
        LL_DMAMUX_REQ_GEN_LPTIM2_OUT /*!< Request signal generation from       \
                                        LPTIM2 Output */
#endif                               /* LPTIM2 */
#define HAL_DMAMUX1_REQ_GEN_TIM14_OC                                           \
    LL_DMAMUX_REQ_GEN_TIM14_OC /*!< Request signal generation from TIM14 OC */
