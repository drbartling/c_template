...
#define UART_TXFIFO_THRESHOLD_3_4                                              \
    (USART_CR3_TXFTCFG_0 | USART_CR3_TXFTCFG_1) /*!< TX FIFO reaches 3/4 of    \
                                                   its depth */
...
#define UART_RXFIFO_THRESHOLD_3_4                                              \
    (USART_CR3_RXFTCFG_0 | USART_CR3_RXFTCFG_1) /*!< RX FIFO reaches 3/4 of    \
                                                   its depth */
...
#elif defined(STM32G041xx) || defined(STM32G031xx) || defined(STM32G051xx)     \
    || defined(STM32G061xx)
/** @brief  Report the UART clock source.
 * @param  __HANDLE__ specifies the UART Handle.
 * @param  __CLOCKSOURCE__ output variable.
