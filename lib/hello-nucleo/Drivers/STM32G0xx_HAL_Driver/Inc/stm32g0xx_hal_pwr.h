...
#define PWR_WAKEUP_PIN1                                                        \
    PWR_CR3_EWUP1 /*!< Wakeup pin 1 (with high level detection) */
#define PWR_WAKEUP_PIN2                                                        \
    PWR_CR3_EWUP2 /*!< Wakeup pin 2 (with high level detection) */
#if defined(PWR_CR3_EWUP3)
#    define PWR_WAKEUP_PIN3                                                    \
        PWR_CR3_EWUP3 /*!< Wakeup pin 3 (with high level detection) */
#endif                /* PWR_CR3_EWUP3 */
#define PWR_WAKEUP_PIN4                                                        \
    PWR_CR3_EWUP4 /*!< Wakeup pin 4 (with high level detection) */
#if defined(PWR_CR3_EWUP5)
#    define PWR_WAKEUP_PIN5                                                    \
        PWR_CR3_EWUP5 /*!< Wakeup pin 5 (with high level detection) */
#endif                /* PWR_CR3_EWUP5 */
#define PWR_WAKEUP_PIN6                                                        \
    PWR_CR3_EWUP6 /*!< Wakeup pin 6 (with high level detection) */
...
#define PWR_WAKEUP_PIN1_LOW                                                    \
    ((PWR_CR4_WP1 << PWR_WUP_POLARITY_SHIFT)                                   \
     | PWR_CR3_EWUP1) /*!< Wakeup pin 1 (with low level detection) */
#define PWR_WAKEUP_PIN2_LOW                                                    \
    ((PWR_CR4_WP2 << PWR_WUP_POLARITY_SHIFT)                                   \
     | PWR_CR3_EWUP2) /*!< Wakeup pin 2 (with low level detection) */
#if defined(PWR_CR3_EWUP3)
#    define PWR_WAKEUP_PIN3_LOW                                                \
        ((PWR_CR4_WP3 << PWR_WUP_POLARITY_SHIFT)                               \
         | PWR_CR3_EWUP3) /*!< Wakeup pin 3 (with low level detection) */
#endif                    /* PWR_CR3_EWUP3 */
#define PWR_WAKEUP_PIN4_LOW                                                    \
    ((PWR_CR4_WP4 << PWR_WUP_POLARITY_SHIFT)                                   \
     | PWR_CR3_EWUP4) /*!< Wakeup pin 4 (with low level detection) */
#if defined(PWR_CR3_EWUP5)
#    define PWR_WAKEUP_PIN5_LOW                                                \
        ((PWR_CR4_WP5 << PWR_WUP_POLARITY_SHIFT)                               \
         | PWR_CR3_EWUP5) /*!< Wakeup pin 5 (with low level detection) */
#endif                    /* PWR_CR3_EWUP5 */
#define PWR_WAKEUP_PIN6_LOW                                                    \
    ((PWR_CR4_WP6 << PWR_WUP_POLARITY_SHIFT)                                   \
     | PWR_CR3_EWUP6) /*!< Wakeup pin 6 (with low level detection) */
/**
 * @}
 */
 ...
 * @{
 */
#define PWR_LOWPOWERMODE_STOP0                                                 \
    (0x00000000u) /*!< Stop 0: stop mode with main regulator */
#define PWR_LOWPOWERMODE_STOP1                                                 \
    (PWR_CR1_LPMS_0) /*!< Stop 1: stop mode with low power regulator */
#define PWR_LOWPOWERMODE_STANDBY                                               \
    (PWR_CR1_LPMS_0 | PWR_CR1_LPMS_1) /*!< Standby mode */
...
#define PWR_SLEEPENTRY_WFE                                                     \
    ((uint8_t)0x02u) /*!< Wait For Event instruction to enter Sleep mode */
/**
 * @}
 */
...
#define PWR_STOPENTRY_WFE                                                      \
    ((uint8_t)0x02u) /*!< Wait For Event instruction to enter Stop mode */
/**
 * @}
 */
 ...
 * @{
 */
#define PWR_FLAG_WUF1                                                          \
    (0x00010000u | PWR_SR1_WUF1) /*!< Wakeup event on wakeup pin 1 */
#define PWR_FLAG_WUF2                                                          \
    (0x00010000u | PWR_SR1_WUF2) /*!< Wakeup event on wakeup pin 2 */
#if defined(PWR_CR3_EWUP3)
#    define PWR_FLAG_WUF3                                                      \
        (0x00010000u | PWR_SR1_WUF3) /*!< Wakeup event on wakeup pin 3 */
#endif                               /* PWR_CR3_EWUP3 */
#define PWR_FLAG_WUF4                                                          \
    (0x00010000u | PWR_SR1_WUF4) /*!< Wakeup event on wakeup pin 4 */
#if defined(PWR_CR3_EWUP5)
#    define PWR_FLAG_WUF5                                                      \
        (0x00010000u | PWR_SR1_WUF5) /*!< Wakeup event on wakeup pin 5 */
#endif                               /* PWR_CR3_EWUP5 */
#define PWR_FLAG_WUF6                                                          \
    (0x00010000u | PWR_SR1_WUF6) /*!< Wakeup event on wakeup pin 6 */
#define PWR_FLAG_WUF                                                           \
    (0x00010000u | PWR_SR1_WUF) /*!< Wakeup event on all wakeup pin  */
#define PWR_FLAG_SB (0x00010000u | PWR_SR1_SBF) /*!< Standby flag */
#define PWR_FLAG_WUFI                                                          \
    (0x00010000u | PWR_SR1_WUFI) /*!< Wakeup on internal wakeup line */
#define PWR_FLAG_FLASH_READY                                                   \
    (0x00020000u | PWR_SR2_FLASH_RDY) /*!< Flash ready */
#define PWR_FLAG_REGLPS                                                        \
    (0x00020000u | PWR_SR2_REGLPS) /*!< Regulator Low Power started */
#define PWR_FLAG_REGLPF                                                        \
    (0x00020000u | PWR_SR2_REGLPF) /*!< Regulator Low Power flag */
#if defined(PWR_PVD_SUPPORT)
#    define PWR_FLAG_PVDO                                                      \
        (0x00020000u | PWR_SR2_PVDO) /*!< Power Voltage Detector output */
#endif                               /* PWR_PVD_SUPPORT */
#if defined(PWR_PVM_SUPPORT)
#    define PWR_FLAG_PVMO_USB                                                  \
        (0x00020000u | PWR_SR2_PVMO_USB) /*!< Power Voltage Monitoring output  \
                                          */
...
#define __HAL_PWR_GET_FLAG(__FLAG__)                                           \
    (((__FLAG__)&0x00010000u) ? ((PWR->SR1 & ((__FLAG__) & ~0x00030000u))      \
...
#define PWR_WUP_POLARITY_SHIFT                                                 \
    0x08u /*!< Internal constant used to retrieve wakeup pin polariry */
/**
 * @}
 */
