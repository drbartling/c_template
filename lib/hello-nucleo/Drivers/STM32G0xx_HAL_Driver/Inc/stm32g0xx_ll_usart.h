...
typedef struct {
    ...
    uint32_t TransferDirection; /*!< Specifies whether the Receive and/or
                                   Transmit mode is enabled or disabled. This
                                   parameter can be a value of @ref
                                   USART_LL_EC_DIRECTION.

                                     This feature can be modified afterwards
                                   using unitary function @ref
                                   LL_USART_SetTransferDirection().*/

    uint32_t HardwareFlowControl; /*!< Specifies whether the hardware flow
                                     control mode is enabled or disabled. This
                                     parameter can be a value of @ref
...
typedef struct {
    ...
    uint32_t LastBitClockPulse; /*!< Specifies whether the clock pulse
                                   corresponding to the last transmitted data
                                   bit (MSB) has to be output on the SCLK pin in
                                   synchronous mode. This parameter can be a
                                   value of @ref USART_LL_EC_LASTCLKPULSE.

                                     USART HW configuration can be modified
                                   afterwards using unitary functions @ref
                                   LL_USART_SetLastClkPulseOutput(). For more
                                   details, refer to description of this
                                   function. */
...
#    define LL_USART_ICR_RTOCF                                                 \
        USART_ICR_RTOCF /*!< Receiver timeout clear flag */
...
#    define LL_USART_ICR_CMCF                                                  \
        USART_ICR_CMCF /*!< Character match clear flag                         \
                        */
...
#    define LL_USART_ISR_UDR                                                   \
        USART_ISR_UDR /*!< SPI Slave underrun error flag                       \
                       */
...
#    define LL_USART_ISR_TCBGT                                                 \
        USART_ISR_TCBGT /*!< Transmission complete before guard time           \
                           completion flag */
...
#    define LL_USART_CR3_TCBGTIE                                               \
        USART_CR3_TCBGTIE /*!< Transmission complete before guard time         \
                             interrupt enable */
...
#    define LL_USART_DIRECTION_TX_RX                                           \
        (USART_CR1_TE | USART_CR1_RE) /*!< Transmitter and Receiver are        \
                                         enabled */
/**
 * @}
 */
...
#        define LL_USART_CLOCK_DISABLE                                         \
            0x00000000U /*!< Clock signal not provided */
#        define LL_USART_CLOCK_ENABLE                                          \
            USART_CR2_CLKEN /*!< Clock signal provided */
/**
 * @}
 */
#    endif /*USE_FULL_LL_DRIVER*/
...
#    define LL_USART_LASTCLKPULSE_NO_OUTPUT                                    \
        0x00000000U /*!< The clock pulse of the last data bit is not output to \
                       the SCLK pin */
#    define LL_USART_LASTCLKPULSE_OUTPUT                                       \
        USART_CR2_LBCL /*!< The clock pulse of the last data bit is output to  \
                          the SCLK pin */
/**
 * @}
 */
...
#    define LL_USART_PHASE_1EDGE                                               \
        0x00000000U /*!< The first clock transition is the first data capture  \
                       edge */
#    define LL_USART_PHASE_2EDGE                                               \
        USART_CR2_CPHA /*!< The second clock transition is the first data      \
                          capture edge */
/**
 * @}
 */
 ...
 * @{
 */
#    define LL_USART_PRESCALER_DIV1                                            \
        0x00000000U /*!< Input clock not divided   */
...
#    define LL_USART_PRESCALER_DIV6                                            \
        (USART_PRESC_PRESCALER_1 | USART_PRESC_PRESCALER_0) /*!< Input clock   \
                                                               divided by 6 */
#    define LL_USART_PRESCALER_DIV8                                            \
        (USART_PRESC_PRESCALER_2) /*!< Input clock divided by 8  */
#    define LL_USART_PRESCALER_DIV10                                           \
        (USART_PRESC_PRESCALER_2 | USART_PRESC_PRESCALER_0) /*!< Input clock   \
                                                               divided by 10   \
                                                             */
#    define LL_USART_PRESCALER_DIV12                                           \
        (USART_PRESC_PRESCALER_2 | USART_PRESC_PRESCALER_1) /*!< Input clock   \
                                                               divided by 12   \
                                                             */
...
#    define LL_USART_PRESCALER_DIV64                                           \
        (USART_PRESC_PRESCALER_3 | USART_PRESC_PRESCALER_0) /*!< Input clock   \
                                                               divided by 64   \
                                                             */
#    define LL_USART_PRESCALER_DIV128                                          \
        (USART_PRESC_PRESCALER_3 | USART_PRESC_PRESCALER_1) /*!< Input clock   \
                                                               divided by 128  \
                                                             */
...
#    define LL_USART_AUTOBAUD_DETECT_ON_STARTBIT                               \
        0x00000000U /*!< Measurement of the start bit is used to detect the    \
                       baud rate */
...
#    define LL_USART_HWCONTROL_RTS                                             \
        USART_CR3_RTSE /*!< RTS output enabled, data is only requested when    \
                          there is space in the receive buffer */
#    define LL_USART_HWCONTROL_CTS                                             \
        USART_CR3_CTSE /*!< CTS mode enabled, data is only transmitted when    \
                          the nCTS input is asserted (tied to 0) */
#    define LL_USART_HWCONTROL_RTS_CTS                                         \
        (USART_CR3_RTSE | USART_CR3_CTSE) /*!< CTS and RTS hardware flow       \
                                             control enabled */
/**
 * @}
 */
...
#    define LL_USART_IRDA_POWER_NORMAL                                         \
        0x00000000U /*!< IrDA normal power mode */
 ...
 * @{
 */
#    define LL_USART_DE_POLARITY_HIGH                                          \
        0x00000000U /*!< DE signal is active high */
#    define LL_USART_DE_POLARITY_LOW                                           \
 ...
 */
#    define LL_USART_ReadReg(__INSTANCE__, __REG__)                            \
 ...
 * case
 */
#    define __LL_USART_DIV_SAMPLING8(__PERIPHCLK__, __PRESCALER__,             \
                                     __BAUDRATE__)                             \
 ...
 * case
 */
#    define __LL_USART_DIV_SAMPLING16(__PERIPHCLK__, __PRESCALER__,            \
                                      __BAUDRATE__)                            \
...
LL_USART_Enable(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_Disable(USART_TypeDef *USARTx)
{
...
LL_USART_IsEnabled(const USART_TypeDef *USARTx)
{
    return ((READ_BIT(USARTx->CR1, USART_CR1_UE) == (USART_CR1_UE)) ? 1UL
                                                                    : 0UL);
}
 ...
 */
__STATIC_INLINE void
LL_USART_EnableFIFO(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableFIFO(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsEnabledFIFO(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetTXFIFOThreshold(USART_TypeDef *USARTx, uint32_t Threshold)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetRXFIFOThreshold(USART_TypeDef *USARTx, uint32_t Threshold)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ConfigFIFOsThreshold(USART_TypeDef *USARTx, uint32_t TXThreshold,
 ...
 */
__STATIC_INLINE void
LL_USART_EnableInStopMode(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableInStopMode(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableDirectionRx(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableDirectionRx(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableDirectionTx(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableDirectionTx(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetParity(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetWakeUpMethod(USART_TypeDef *USARTx, uint32_t Method)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetWakeUpMethod(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetDataWidth(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableMuteMode(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableMuteMode(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetOverSampling(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetClockPhase(USART_TypeDef *USARTx, uint32_t ClockPhase)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetClockPhase(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetClockPolarity(USART_TypeDef *USARTx, uint32_t ClockPolarity)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ConfigClock(USART_TypeDef *USARTx, uint32_t Phase, uint32_t Polarity,
                     uint32_t LBCPOutput)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetPrescaler(USART_TypeDef *USARTx, uint32_t PrescalerValue)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetPrescaler(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableSCLKOutput(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableSCLKOutput(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ConfigCharacter(USART_TypeDef *USARTx, uint32_t DataWidth,
 ...
 */
__STATIC_INLINE void
LL_USART_SetTXRXSwap(USART_TypeDef *USARTx, uint32_t SwapConfig)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetTXRXSwap(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetRXPinLevel(USART_TypeDef *USARTx, uint32_t PinInvMethod)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetRXPinLevel(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetTXPinLevel(USART_TypeDef *USARTx, uint32_t PinInvMethod)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetTXPinLevel(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetBinaryDataLogic(USART_TypeDef *USARTx, uint32_t DataLogic)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetTransferBitOrder(USART_TypeDef *USARTx, uint32_t BitOrder)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableAutoBaudRate(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableAutoBaudRate(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetAutoBaudRateMode(USART_TypeDef *USARTx, uint32_t AutoBaudRateMode)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetAutoBaudRateMode(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableRxTimeout(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableRxTimeout(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ConfigNodeAddress(USART_TypeDef *USARTx, uint32_t AddressLen,
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetNodeAddress(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableRTSHWFlowCtrl(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableRTSHWFlowCtrl(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableCTSHWFlowCtrl(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableCTSHWFlowCtrl(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetHWFlowCtrl(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableOneBitSamp(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableOneBitSamp(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableOverrunDetect(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableOverrunDetect(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetWKUPType(USART_TypeDef *USARTx, uint32_t Type)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetWKUPType(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetBaudRate(USART_TypeDef *USARTx, uint32_t PeriphClk,
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetBaudRate(const USART_TypeDef *USARTx, uint32_t PeriphClk,
                     uint32_t PrescalerValue, uint32_t OverSampling)
{
    uint32_t usartdiv;
 ...
 */
__STATIC_INLINE void
LL_USART_SetRxTimeout(USART_TypeDef *USARTx, uint32_t Timeout)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetRxTimeout(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetBlockLength(USART_TypeDef *USARTx, uint32_t BlockLength)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_GetBlockLength(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIrda(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIrda(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsEnabledIrda(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetIrdaPowerMode(USART_TypeDef *USARTx, uint32_t PowerMode)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetIrdaPrescaler(USART_TypeDef *USARTx, uint32_t PrescalerValue)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableSmartcardNACK(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableSmartcardNACK(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableSmartcard(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableSmartcard(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetSmartcardAutoRetryCount(USART_TypeDef *USARTx,
 ...
 */
__STATIC_INLINE void
LL_USART_SetSmartcardPrescaler(USART_TypeDef *USARTx, uint32_t PrescalerValue)
{
    MODIFY_REG(USARTx->GTPR, USART_GTPR_PSC, (uint16_t)PrescalerValue);
}
 ...
 */
__STATIC_INLINE void
LL_USART_SetSmartcardGuardTime(USART_TypeDef *USARTx, uint32_t GuardTime)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableHalfDuplex(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableHalfDuplex(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableSPISlave(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableSPISlave(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableSPISlaveSelect(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableSPISlaveSelect(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetLINBrkDetectionLen(USART_TypeDef *USARTx, uint32_t LINBDLength)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableLIN(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableLIN(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsEnabledLIN(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetDEDeassertionTime(USART_TypeDef *USARTx, uint32_t Time)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetDEAssertionTime(USART_TypeDef *USARTx, uint32_t Time)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableDEMode(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableDEMode(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsEnabledDEMode(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_SetDESignalPolarity(USART_TypeDef *USARTx, uint32_t Polarity)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ConfigAsyncMode(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ConfigSyncMode(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ConfigLINMode(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ConfigHalfDuplexMode(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ConfigSmartcardMode(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ConfigIrdaMode(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ConfigMultiProcessMode(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsActiveFlag_PE(const USART_TypeDef *USARTx)
{
    return ((READ_BIT(USARTx->ISR, USART_ISR_PE) == (USART_ISR_PE)) ? 1UL
                                                                    : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsActiveFlag_FE(const USART_TypeDef *USARTx)
{
    return ((READ_BIT(USARTx->ISR, USART_ISR_FE) == (USART_ISR_FE)) ? 1UL
                                                                    : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsActiveFlag_NE(const USART_TypeDef *USARTx)
{
    return ((READ_BIT(USARTx->ISR, USART_ISR_NE) == (USART_ISR_NE)) ? 1UL
                                                                    : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsActiveFlag_TC(const USART_TypeDef *USARTx)
{
    return ((READ_BIT(USARTx->ISR, USART_ISR_TC) == (USART_ISR_TC)) ? 1UL
                                                                    : 0UL);
}
...
{
    return (
        (READ_BIT(USARTx->ISR, USART_ISR_TXE_TXFNF) == (USART_ISR_TXE_TXFNF))
            ? 1UL
            : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsActiveFlag_CM(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ClearFlag_PE(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ClearFlag_FE(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ClearFlag_NE(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ClearFlag_ORE(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ClearFlag_IDLE(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ClearFlag_TXFE(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ClearFlag_TCBGT(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ClearFlag_LBD(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ClearFlag_nCTS(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ClearFlag_RTO(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ClearFlag_EOB(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ClearFlag_UDR(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ClearFlag_CM(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_ClearFlag_WKUP(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_IDLE(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_RXNE_RXFNE(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_TC(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_TXE_TXFNF(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_PE(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_CM(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_RTO(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_EOB(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_TXFE(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_RXFF(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_LBD(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_ERROR(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_CTS(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_WKUP(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_TXFT(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_TCBGT(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableIT_RXFT(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_IDLE(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_RXNE_RXFNE(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_TC(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_TXE_TXFNF(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_PE(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_CM(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_RTO(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_EOB(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_TXFE(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_RXFF(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_LBD(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_ERROR(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_CTS(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_WKUP(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_TXFT(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_TCBGT(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableIT_RXFT(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsEnabledIT_TC(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsEnabledIT_PE(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsEnabledIT_CM(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsEnabledIT_RTO(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsEnabledIT_EOB(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsEnabledIT_LBD(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_IsEnabledIT_CTS(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableDMAReq_RX(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableDMAReq_RX(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableDMAReq_TX(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_EnableDMADeactOnRxErr(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_DisableDMADeactOnRxErr(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_USART_DMA_GetRegAddr(const USART_TypeDef *USARTx, uint32_t Direction)
{
...
LL_USART_ReceiveData9(const USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_TransmitData9(USART_TypeDef *USARTx, uint16_t Value)
{
 ...
 */
__STATIC_INLINE void
LL_USART_RequestAutoBaudRate(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_RequestBreakSending(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_RequestEnterMuteMode(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_RequestRxDataFlush(USART_TypeDef *USARTx)
{
 ...
 */
__STATIC_INLINE void
LL_USART_RequestTxDataFlush(USART_TypeDef *USARTx)
{
