...
#    define LL_UTILS_PACKAGETYPE_QFP100                                        \
        0x00000000U /*!< LQFP100  package type */
#    define LL_UTILS_PACKAGETYPE_QFN32_GP                                      \
        0x00000001U /*!< LQFP32/UFQFPN32 General purpose (GP) */
#    define LL_UTILS_PACKAGETYPE_QFN32_N                                       \
        0x00000002U /*!< LQFP32/UFQFPN32 N-version */
#    define LL_UTILS_PACKAGETYPE_QFN48_GP                                      \
        0x00000004U /*!< LQFP48/UFQPN48 General purpose (GP) */
#    define LL_UTILS_PACKAGETYPE_QFN48_N                                       \
        0x00000005U /*!< LQFP48/UFQPN48 N-version */
#    define LL_UTILS_PACKAGETYPE_WLCSP52 0x00000006U /*!< WLCSP52 */
#    define LL_UTILS_PACKAGETYPE_QFN64_GP                                      \
        0x00000007U /*!< LQFP64 General purpose (GP) */
...
#    define LL_UTILS_PACKAGETYPE_QFP80                                         \
        0x0000000BU /*!< LQFP80  package type                                  \
                     */
#    define LL_UTILS_PACKAGETYPE_BGA100                                        \
        0x0000000CU /*!< UBGA100  package type */
#elif defined(STM32G061xx) || defined(STM32G051xx) || defined(STM32G050xx)     \
    || defined(STM32G041xx) || defined(STM32G031xx) || defined(STM32G030xx)
#    define LL_UTILS_PACKAGETYPE_SO8 0x00000001U /*!< SO8 package type */
#    define LL_UTILS_PACKAGETYPE_WLCSP18                                       \
        0x00000002U /*!< WLCSP18 package type */
#    define LL_UTILS_PACKAGETYPE_TSSOP20                                       \
        0x00000003U /*!< TSSOP20 package type */
#    define LL_UTILS_PACKAGETYPE_QFP28                                         \
        0x00000004U /*!< UFQFPN28 package type                                 \
                     */
#    define LL_UTILS_PACKAGETYPE_QFN32                                         \
        0x00000005U /*!< UFQFPN32 / LQFP32 package type */
#    define LL_UTILS_PACKAGETYPE_QFN48                                         \
        0x00000007U /*!< UFQFPN48 / LQFP48 package type */
#elif defined(STM32G081xx) || defined(STM32G071xx) || defined(STM32G070xx)
#    define LL_UTILS_PACKAGETYPE_QFN28_GP                                      \
        0x00000000U /*!< UFQFPN28 general purpose (GP) package type */
#    define LL_UTILS_PACKAGETYPE_QFN28_PD                                      \
        0x00000001U /*!< UFQFPN28 Power Delivery (PD) */
#    define LL_UTILS_PACKAGETYPE_QFN32_GP                                      \
        0x00000004U /*!< UFQFPN32 / LQFP32 general purpose (GP) package type   \
                     */
#    define LL_UTILS_PACKAGETYPE_QFN32_PD                                      \
        0x00000005U /*!< UFQFPN32 / LQFP32 Power Delivery (PD) package type */
#    define LL_UTILS_PACKAGETYPE_QFN48                                         \
        0x00000008U /*!< UFQFPN48 / LQFP488 package type */
...
LL_InitTick(uint32_t HCLKFrequency, uint32_t Ticks)
{
    /* Configure the SysTick to have interrupt in 1ms time base */
    SysTick->LOAD = (uint32_t)((HCLKFrequency / Ticks) - 1UL); /* set reload
                                                                  register */
