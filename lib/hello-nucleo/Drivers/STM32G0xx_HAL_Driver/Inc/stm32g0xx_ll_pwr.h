...
#        define LL_PWR_PVDLLEVEL_3                                             \
            (PWR_CR2_PVDFT_1 | PWR_CR2_PVDFT_0)      /* VPVD2 > 2.52 V */
#        define LL_PWR_PVDLLEVEL_4 (PWR_CR2_PVDFT_2) /* VPVD3 > 2.64 V */
#        define LL_PWR_PVDLLEVEL_5                                             \
            (PWR_CR2_PVDFT_2 | PWR_CR2_PVDFT_0) /* VPVD4 > 2.81 V */
#        define LL_PWR_PVDLLEVEL_6                                             \
            (PWR_CR2_PVDFT_2 | PWR_CR2_PVDFT_1) /* VPVD5 > 2.91 V */
...
#        define LL_PWR_PVDHLEVEL_3                                             \
            (PWR_CR2_PVDRT_1 | PWR_CR2_PVDRT_0)      /* VPVD2 > 2.62 V */
#        define LL_PWR_PVDHLEVEL_4 (PWR_CR2_PVDRT_2) /* VPVD3 > 2.74 V */
#        define LL_PWR_PVDHLEVEL_5                                             \
            (PWR_CR2_PVDRT_2 | PWR_CR2_PVDRT_0) /* VPVD4 > 2.91 V */
#        define LL_PWR_PVDHLEVEL_6                                             \
            (PWR_CR2_PVDRT_2 | PWR_CR2_PVDRT_1) /* VPVD5 > 3.01 V */
#        define LL_PWR_PVDHLEVEL_7                                             \
            (PWR_CR2_PVDRT_2 | PWR_CR2_PVDRT_1                                 \
             | PWR_CR2_PVDRT_0) /* External input analog voltage   (Compare    \
...
#        define LL_PWR_PVM_USB                                                 \
            PWR_CR2_PVMEN_USB /*!< Peripheral Voltage Monitoring enable for    \
                                 USB peripheral: Enable to keep the USB        \
                                 peripheral voltage monitoring under control   \
                                 (power domain Vddio2) */
/**
 * @}
 */
 ...
 * @retval None
 */
#    define LL_PWR_WriteReg(__REG__, __VALUE__)                                \
...
LL_PWR_SetRegulVoltageScaling(uint32_t VoltageScaling)
{
...
LL_PWR_GetRegulVoltageScaling(void)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_EnableLowPowerRunMode(void)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_DisableLowPowerRunMode(void)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_EnterLowPowerRunMode(void)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_ExitLowPowerRunMode(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsEnabledBkUpAccess(void)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_EnableFlashPowerDownInLPSleep(void)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_DisableFlashPowerDownInLPSleep(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsEnableFlashPowerDownInLPSleep(void)
{
    return ((READ_BIT(PWR->CR1, PWR_CR1_FPD_LPSLP) == (PWR_CR1_FPD_LPSLP))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE void
LL_PWR_EnableFlashPowerDownInLPRun(void)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_DisableFlashPowerDownInLPRun(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsEnableFlashPowerDownInLPRun(void)
{
    return ((READ_BIT(PWR->CR1, PWR_CR1_FPD_LPRUN) == (PWR_CR1_FPD_LPRUN))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE void
LL_PWR_EnableFlashPowerDownInStop(void)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_DisableFlashPowerDownInStop(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsEnableFlashPowerDownInStop(void)
{
    return ((READ_BIT(PWR->CR1, PWR_CR1_FPD_STOP) == (PWR_CR1_FPD_STOP)) ? 1UL
                                                                         : 0UL);
}
 ...
 */
__STATIC_INLINE void
LL_PWR_EnablePVM(uint32_t PeriphVoltage)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_DisablePVM(uint32_t PeriphVoltage)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsEnabledPVM(uint32_t PeriphVoltage)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_SetPowerMode(uint32_t LowPowerMode)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_SetPVDHighLevel(uint32_t PVDHighLevel)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_SetPVDLowLevel(uint32_t PVDLowLevel)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_EnableSRAMRetention(void)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_DisableSRAMRetention(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsEnabledSRAMRetention(void)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_EnableLPMUResetSamplingMode(void)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_DisableLPMUResetSamplingMode(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsEnableLPMUResetSamplingMode(void)
{
    return ((READ_BIT(PWR->CR3, PWR_CR3_ENB_ULP) == (PWR_CR3_ENB_ULP)) ? 1UL
                                                                       : 0UL);
}
 ...
 */
__STATIC_INLINE void
LL_PWR_DisableWakeUpPin(uint32_t WakeUpPin)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsEnabledWakeUpPin(uint32_t WakeUpPin)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_SetBattChargResistor(uint32_t Resistor)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_GetBattChargResistor(void)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_EnableBatteryCharging(void)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_DisableBatteryCharging(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsEnabledBatteryCharging(void)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_SetWakeUpPinPolarityLow(uint32_t WakeUpPin)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_SetWakeUpPinPolarityHigh(uint32_t WakeUpPin)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsWakeUpPinPolarityLow(uint32_t WakeUpPin)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_EnableGPIOPullUp(uint32_t GPIO, uint32_t GPIONumber)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_DisableGPIOPullUp(uint32_t GPIO, uint32_t GPIONumber)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsEnabledGPIOPullUp(uint32_t GPIO, uint32_t GPIONumber)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_EnableGPIOPullDown(uint32_t GPIO, uint32_t GPIONumber)
{
 ...
 */
__STATIC_INLINE void
LL_PWR_DisableGPIOPullDown(uint32_t GPIO, uint32_t GPIONumber)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsEnabledGPIOPullDown(uint32_t GPIO, uint32_t GPIONumber)
{
    return (
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsActiveFlag_InternWU(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsActiveFlag_PVMOUSB(void)
{
    return ((READ_BIT(PWR->SR2, PWR_SR2_PVMO_USB) == (PWR_SR2_PVMO_USB)) ? 1UL
                                                                         : 0UL);
}
#    endif /* PWR_PVM_SUPPORT */
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsActiveFlag_REGLPF(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsActiveFlag_REGLPS(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_PWR_IsActiveFlag_FLASH_RDY(void)
{
    return ((READ_BIT(PWR->SR2, PWR_SR2_FLASH_RDY) == (PWR_SR2_FLASH_RDY))
                ? 1UL
                : 0UL);
}
