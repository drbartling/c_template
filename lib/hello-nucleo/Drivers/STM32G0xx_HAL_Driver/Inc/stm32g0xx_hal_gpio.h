...
#define GPIO_MODE_IT_FALLING                                                   \
    (MODE_INPUT | EXTI_IT | TRIGGER_FALLING) /*!< External Interrupt Mode with \
...
#define GPIO_MODE_EVT_FALLING                                                  \
    (MODE_INPUT | EXTI_EVT | TRIGGER_FALLING) /*!< External Event Mode with    \
                                                 Falling edge trigger          \
                                                 detection            */
#define GPIO_MODE_EVT_RISING_FALLING                                           \
    (MODE_INPUT | EXTI_EVT | TRIGGER_RISING                                    \
     | TRIGGER_FALLING) /*!< External Event Mode with Rising/Falling edge      \
                           trigger detection     */
/**
 * @}
 */
 ...
 */
#define __HAL_GPIO_EXTI_GET_RISING_IT(__EXTI_LINE__)                           \
 ...
 * @retval None
 */
#define __HAL_GPIO_EXTI_CLEAR_RISING_IT(__EXTI_LINE__)                         \
    (EXTI->RPR1 = (__EXTI_LINE__))
 ...
 * @retval The new state of __EXTI_LINE__ (SET or RESET).
 */
#define __HAL_GPIO_EXTI_GET_FALLING_IT(__EXTI_LINE__)                          \
 ...
 * @retval None
 */
#define __HAL_GPIO_EXTI_CLEAR_FALLING_IT(__EXTI_LINE__)                        \
    (EXTI->FPR1 = (__EXTI_LINE__))
