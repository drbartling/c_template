 ...
 * @{
 */
#    define LL_SYSCFG_PIN_RMP_PA11                                             \
        SYSCFG_CFGR1_PA11_RMP /*!< PA11 pad behaves as PA9 pin */
#    define LL_SYSCFG_PIN_RMP_PA12                                             \
        SYSCFG_CFGR1_PA12_RMP /*!< PA12 pad behaves as PA10 pin */
/**
 * @}
 */
...
#        define LL_SYSCFG_IR_MOD_TIM16                                         \
            (SYSCFG_CFGR1_IR_MOD_0                                             \
             & SYSCFG_CFGR1_IR_MOD_1) /*!< 00: Timer16 is selected as IRDA     \
                                         Modulation enveloppe source */
#        define LL_SYSCFG_IR_MOD_USART1                                        \
            (SYSCFG_CFGR1_IR_MOD_0) /*!< 01: USART1 is selected as IRDA        \
                                       Modulation enveloppe source */
#        if defined(USART4)
#            define LL_SYSCFG_IR_MOD_USART4                                    \
                (SYSCFG_CFGR1_IR_MOD_1) /*!< 10: USART4 is selected as IRDA    \
                                           Modulation enveloppe source */
#        else
#            define LL_SYSCFG_IR_MOD_USART2                                    \
                (SYSCFG_CFGR1_IR_MOD_1) /*!< 10: USART2 is selected as IRDA    \
                                           Modulation enveloppe source */
#        endif                          /* USART4 */
/**
 * @}
 ...
 * @{
 */
#        define LL_SYSCFG_IR_POL_NOT_INVERTED                                  \
            0x00000000U /*!< 0: Output of IRDA (IROut) not inverted */
#        define LL_SYSCFG_IR_POL_INVERTED                                      \
            (SYSCFG_CFGR1_IR_POL) /*!< 1: Output of IRDA (IROut) inverted */
/**
 * @}
 */
 ...
 * @{
 */
#        define LL_SYSCFG_CFGR1_BOOSTEN                                        \
 ...
 * @{
 */
#        define LL_SYSCFG_UCPD1_STROBE                                         \
            SYSCFG_CFGR1_UCPD1_STROBE /*!< UCPD1 STROBE sw configuration */
#        define LL_SYSCFG_UCPD2_STROBE                                         \
            SYSCFG_CFGR1_UCPD2_STROBE /*!< UCPD2 STROBE sw configuration */
/**
 * @}
 */
...
#    define LL_SYSCFG_I2C_FASTMODEPLUS_PB6                                     \
        SYSCFG_CFGR1_I2C_PB6_FMP /*!< I2C PB6 Fast mode plus */
#    define LL_SYSCFG_I2C_FASTMODEPLUS_PB7                                     \
        SYSCFG_CFGR1_I2C_PB7_FMP /*!< I2C PB7 Fast mode plus */
#    define LL_SYSCFG_I2C_FASTMODEPLUS_PB8                                     \
        SYSCFG_CFGR1_I2C_PB8_FMP /*!< I2C PB8 Fast mode plus */
#    define LL_SYSCFG_I2C_FASTMODEPLUS_PB9                                     \
        SYSCFG_CFGR1_I2C_PB9_FMP /*!< I2C PB9 Fast mode plus */
#    if defined(SYSCFG_CFGR1_I2C1_FMP)
#        define LL_SYSCFG_I2C_FASTMODEPLUS_I2C1                                \
            SYSCFG_CFGR1_I2C1_FMP /*!< Enable I2C1 Fast mode Plus  */
#    endif                        /*SYSCFG_CFGR1_I2C1_FMP*/
#    if defined(SYSCFG_CFGR1_I2C2_FMP)
#        define LL_SYSCFG_I2C_FASTMODEPLUS_I2C2                                \
            SYSCFG_CFGR1_I2C2_FMP /*!< Enable I2C2 Fast mode plus  */
...
#            define LL_SYSCFG_I2C_FASTMODEPLUS_I2C3                            \
                SYSCFG_CFGR1_I2C3_FMP /*!< Enable I2C3 Fast mode plus  */
...
#        define LL_SYSCFG_TIMBREAK_PVD                                         \
            SYSCFG_CFGR2_PVDL /*!< Enables and locks the PVD connection        \
                              ...
                              the PVDE and PLS bits of the Power Control       \
                              Interface */
...
#    define LL_SYSCFG_TIMBREAK_LOCKUP                                          \
        SYSCFG_CFGR2_CLL /*!< Enables and locks the LOCKUP (Hardfault) output  \
                            of CortexM0 with Break Input of TIM1/15/16/17 */
/**
 * @}
 */
 ...
 * @{
 */
#        define LL_SYSCFG_CFGR2_PA1_CDEN                                       \
            SYSCFG_CFGR2_PA1_CDEN /*!< Enables Clamping diode of PA1 */
#        define LL_SYSCFG_CFGR2_PA3_CDEN                                       \
            SYSCFG_CFGR2_PA3_CDEN /*!< Enables Clamping diode of PA3 */
#        define LL_SYSCFG_CFGR2_PA5_CDEN                                       \
            SYSCFG_CFGR2_PA5_CDEN /*!< Enables Clamping diode of PA5 */
#        define LL_SYSCFG_CFGR2_PA6_CDEN                                       \
            SYSCFG_CFGR2_PA6_CDEN /*!< Enables Clamping diode of PA6 */
#        define LL_SYSCFG_CFGR2_PA13_CDEN                                      \
            SYSCFG_CFGR2_PA13_CDEN /*!< Enables Clamping diode of PA13 */
#        define LL_SYSCFG_CFGR2_PB0_CDEN                                       \
            SYSCFG_CFGR2_PB0_CDEN /*!< Enables Clamping diode of PB0 */
#        define LL_SYSCFG_CFGR2_PB1_CDEN                                       \
            SYSCFG_CFGR2_PB1_CDEN /*!< Enables Clamping diode of PB1 */
#        define LL_SYSCFG_CFGR2_PB2_CDEN                                       \
            SYSCFG_CFGR2_PB2_CDEN /*!< Enables Clamping diode of PB2 */
/**
 * @}
 */
...
#        define LL_DBGMCU_APB1_GRP1_TIM2_STOP                                  \
            DBG_APB_FZ1_DBG_TIM2_STOP /*!< TIM2 counter stopped when core is   \
                                         halted */
#    endif                            /*DBG_APB_FZ1_DBG_TIM2_STOP*/
#    define LL_DBGMCU_APB1_GRP1_TIM3_STOP                                      \
        DBG_APB_FZ1_DBG_TIM3_STOP /*!< TIM3 counter stopped when core is       \
                                     halted */
#    if defined(STM32G0C1xx) || defined(STM32G0B1xx) || defined(STM32G0B0xx)
#        define LL_DBGMCU_APB1_GRP1_TIM4_STOP                                  \
            DBG_APB_FZ1_DBG_TIM4_STOP /*!< TIM4 counter stopped when core is   \
                                         halted */
#    endif /* STM32G0C1xx || STM32G0B1xx || STM32G0B0xx */
#    if defined(DBG_APB_FZ1_DBG_TIM6_STOP)
#        define LL_DBGMCU_APB1_GRP1_TIM6_STOP                                  \
            DBG_APB_FZ1_DBG_TIM6_STOP /*!< TIM6 counter stopped when core is   \
                                         halted */
#    endif                            /*DBG_APB_FZ1_DBG_TIM6_STOP*/
#    if defined(DBG_APB_FZ1_DBG_TIM7_STOP)
#        define LL_DBGMCU_APB1_GRP1_TIM7_STOP                                  \
            DBG_APB_FZ1_DBG_TIM7_STOP /*!< TIM7 counter stopped when core is   \
                                         halted  */
#    endif                            /*DBG_APB_FZ1_DBG_TIM7_STOP*/
#    define LL_DBGMCU_APB1_GRP1_RTC_STOP                                       \
        DBG_APB_FZ1_DBG_RTC_STOP /*!< RTC Calendar frozen when core is halted  \
                                  */
#    define LL_DBGMCU_APB1_GRP1_WWDG_STOP                                      \
        DBG_APB_FZ1_DBG_WWDG_STOP /*!< Debug Window Watchdog stopped when Core \
                                     is halted */
...
#        define LL_DBGMCU_APB1_GRP1_I2C2_STOP                                  \
            DBG_APB_FZ1_DBG_I2C2_SMBUS_TIMEOUT_STOP /*!< I2C2 SMBUS timeout    \
                                                       mode stopped when Core  \
                                                       is halted */
#    endif /* STM32G0C1xx || STM32G0B1xx || STM32G0B0xx */
#    if defined(DBG_APB_FZ1_DBG_LPTIM2_STOP)
#        define LL_DBGMCU_APB1_GRP1_LPTIM2_STOP                                \
            DBG_APB_FZ1_DBG_LPTIM2_STOP /*!< LPTIM2 counter stopped when Core  \
                                           is halted */
#    endif                              /* DBG_APB_FZ1_DBG_LPTIM2_STOP */
#    if defined(DBG_APB_FZ1_DBG_LPTIM1_STOP)
#        define LL_DBGMCU_APB1_GRP1_LPTIM1_STOP                                \
            DBG_APB_FZ1_DBG_LPTIM1_STOP /*!< LPTIM1 counter stopped when Core  \
                                           is halted */
...
#    define LL_DBGMCU_APB2_GRP1_TIM1_STOP                                      \
        DBG_APB_FZ2_DBG_TIM1_STOP /*!< TIM1 counter stopped when core is       \
                                     halted */
#    if defined(DBG_APB_FZ2_DBG_TIM14_STOP)
#        define LL_DBGMCU_APB2_GRP1_TIM14_STOP                                 \
            DBG_APB_FZ2_DBG_TIM14_STOP /*!< TIM14 counter stopped when core is \
                                          halted */
#    endif                             /* DBG_APB_FZ2_DBG_TIM14_STOP */
#    if defined(DBG_APB_FZ2_DBG_TIM15_STOP)
#        define LL_DBGMCU_APB2_GRP1_TIM15_STOP                                 \
            DBG_APB_FZ2_DBG_TIM15_STOP /*!< TIM15 counter stopped when core is \
                                          halted  */
#    endif                             /*DBG_APB_FZ2_DBG_TIM15_STOP*/
#    define LL_DBGMCU_APB2_GRP1_TIM16_STOP                                     \
        DBG_APB_FZ2_DBG_TIM16_STOP /*!< TIM16 counter stopped when core is     \
                                      halted */
#    define LL_DBGMCU_APB2_GRP1_TIM17_STOP                                     \
        DBG_APB_FZ2_DBG_TIM17_STOP /*!< TIM17 counter stopped when core is     \
                                      halted */
/**
 * @}
 */
...
#        define LL_VREFBUF_VOLTAGE_SCALE0                                      \
            0x00000000U /*!< Voltage reference scale 0 (VREF_OUT1) */
...
#    define LL_FLASH_LATENCY_1                                                 \
        FLASH_ACR_LATENCY_0 /*!< FLASH One Latency cycle */
#    define LL_FLASH_LATENCY_2                                                 \
        FLASH_ACR_LATENCY_1 /*!< FLASH Two wait states                         \
                             */
#    define LL_FLASH_LATENCY_3                                                 \
        (FLASH_ACR_LATENCY_1 | FLASH_ACR_LATENCY_0) /*!< FLASH Three wait      \
                                                       states */
/**
 * @}
 */
...
LL_SYSCFG_SetRemapMemory(uint32_t Memory)
{
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_EnablePinRemap(uint32_t PinRemap)
{
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DisablePinRemap(uint32_t PinRemap)
{
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_EnableAnalogBooster(void)
{
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DisableAnalogBooster(void)
{
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_EnableFastModePlus(uint32_t ConfigFastModePlus)
{
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DisableFastModePlus(uint32_t ConfigFastModePlus)
{
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DisableDBATT(uint32_t ConfigDeadBattery)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_WWDG(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_PVMOUT(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[1], SYSCFG_ITLINE1_SR_PVMOUT)
             == (SYSCFG_ITLINE1_SR_PVMOUT))
                ? 1UL
                : 0UL);
}
...
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[2], SYSCFG_ITLINE2_SR_RTC)
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_TAMPER(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[2], SYSCFG_ITLINE2_SR_TAMPER)
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_FLASH_ECC(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[3], SYSCFG_ITLINE3_SR_FLASH_ECC)
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_CRS(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI0(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI1(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI2(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI3(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI4(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI5(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI6(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI7(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI8(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI9(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI10(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI11(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI12(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI13(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI14(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_EXTI15(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_UCPD1(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[8], SYSCFG_ITLINE8_SR_UCPD1)
             == (SYSCFG_ITLINE8_SR_UCPD1))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_UCPD2(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[8], SYSCFG_ITLINE8_SR_UCPD2)
             == (SYSCFG_ITLINE8_SR_UCPD2))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_USB(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[8], SYSCFG_ITLINE8_SR_USB)
             == (SYSCFG_ITLINE8_SR_USB))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_DMAMUX(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[11], SYSCFG_ITLINE11_SR_DMAMUX1)
...
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[11], SYSCFG_ITLINE11_SR_DMA2_CH1)
             == (SYSCFG_ITLINE11_SR_DMA2_CH1))
                ? 1UL
                : 0UL);
}
...
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[11], SYSCFG_ITLINE11_SR_DMA2_CH2)
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_ADC(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_COMP1(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_COMP2(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_COMP3(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[12], SYSCFG_ITLINE12_SR_COMP3)
             == (SYSCFG_ITLINE12_SR_COMP3))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_TIM2(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_TIM3(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_TIM4(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[16], SYSCFG_ITLINE16_SR_TIM4_GLB)
             == (SYSCFG_ITLINE16_SR_TIM4_GLB))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_DAC(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_TIM6(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_LPTIM1(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[17], SYSCFG_ITLINE17_SR_LPTIM1_GLB)
             == (SYSCFG_ITLINE17_SR_LPTIM1_GLB))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_TIM7(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_LPTIM2(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[18], SYSCFG_ITLINE18_SR_LPTIM2_GLB)
             == (SYSCFG_ITLINE18_SR_LPTIM2_GLB))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_TIM14(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_TIM15(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_TIM16(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_FDCAN1_IT0(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[21], SYSCFG_ITLINE21_SR_FDCAN1_IT0)
             == (SYSCFG_ITLINE21_SR_FDCAN1_IT0))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_FDCAN2_IT0(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[21], SYSCFG_ITLINE21_SR_FDCAN2_IT0)
             == (SYSCFG_ITLINE21_SR_FDCAN2_IT0))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_TIM17(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_FDCAN1_IT1(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[22], SYSCFG_ITLINE22_SR_FDCAN1_IT1)
             == (SYSCFG_ITLINE22_SR_FDCAN1_IT1))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_FDCAN2_IT1(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[22], SYSCFG_ITLINE22_SR_FDCAN2_IT1)
             == (SYSCFG_ITLINE22_SR_FDCAN2_IT1))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_I2C1(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_I2C2(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_I2C3(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[24], SYSCFG_ITLINE24_SR_I2C3_GLB)
             == (SYSCFG_ITLINE24_SR_I2C3_GLB))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_SPI1(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_SPI2(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_SPI3(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[26], SYSCFG_ITLINE26_SR_SPI3)
             == (SYSCFG_ITLINE26_SR_SPI3))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_LPUART2(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[28], SYSCFG_ITLINE28_SR_LPUART2_GLB)
             == (SYSCFG_ITLINE28_SR_LPUART2_GLB))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_LPUART1(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[29], SYSCFG_ITLINE29_SR_LPUART1_GLB)
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_CEC(void)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_AES(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[31], SYSCFG_ITLINE31_SR_AES)
             == (SYSCFG_ITLINE31_SR_AES))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_RNG(void)
{
    return ((READ_BIT(SYSCFG->IT_LINE_SR[31], SYSCFG_ITLINE31_SR_RNG)
             == (SYSCFG_ITLINE31_SR_RNG))
                ? 1UL
                : 0UL);
}
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_SetTIMBreakInputs(uint32_t Break)
{
...
#    else
    MODIFY_REG(SYSCFG->CFGR2,
               SYSCFG_CFGR2_CLL | SYSCFG_CFGR2_SPL | SYSCFG_CFGR2_ECCL, Break);
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_GetTIMBreakInputs(void)
{
#    if defined(SYSCFG_CFGR2_PVDL)
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsActiveFlag_SP(void)
{
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_EnableClampingDiode(uint32_t ConfigClampingDiode)
{
 ...
 */
__STATIC_INLINE void
LL_SYSCFG_DisableClampingDiode(uint32_t ConfigClampingDiode)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_SYSCFG_IsEnabledClampingDiode(uint32_t ConfigClampingDiode)
{
    return (
        (READ_BIT(SYSCFG->CFGR2, ConfigClampingDiode) == (ConfigClampingDiode))
            ? 1UL
            : 0UL);
}
#    endif /* SYSCFG_CDEN_SUPPORT */
 ...
 */
__STATIC_INLINE uint32_t
LL_DBGMCU_GetRevisionID(void)
{
    return (uint32_t)(READ_BIT(DBG->IDCODE, DBG_IDCODE_REV_ID)
 ...
 */
__STATIC_INLINE void
LL_DBGMCU_EnableDBGStopMode(void)
{
 ...
 */
__STATIC_INLINE void
LL_DBGMCU_DisableDBGStopMode(void)
{
 ...
 */
__STATIC_INLINE void
LL_DBGMCU_APB1_GRP1_UnFreezePeriph(uint32_t Periphs)
{
 ...
 */
__STATIC_INLINE void
LL_DBGMCU_APB2_GRP1_UnFreezePeriph(uint32_t Periphs)
{
 ...
 */
__STATIC_INLINE void
LL_VREFBUF_SetVoltageScaling(uint32_t Scale)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_VREFBUF_GetVoltageScaling(void)
{
 ...
 */
__STATIC_INLINE void
LL_VREFBUF_SetTrimming(uint32_t Value)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_FLASH_IsPrefetchEnabled(void)
{
 ...
 */
__STATIC_INLINE void
LL_FLASH_DisableInstCache(void)
{
 ...
 */
__STATIC_INLINE void
LL_FLASH_EnableInstCacheReset(void)
{
 ...
 */
__STATIC_INLINE void
LL_FLASH_DisableInstCacheReset(void)
{
