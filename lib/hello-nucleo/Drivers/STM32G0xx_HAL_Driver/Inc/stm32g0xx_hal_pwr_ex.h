...
typedef struct {
    uint32_t PVMType; /*!< PVMType: Specifies which voltage is monitored and
                         against which threshold. This parameter can be a value
                         of @ref PWREx_PVM_Type.
                           @arg @ref PWR_PVM_USB Peripheral Voltage Monitoring
                         USB enable */

    uint32_t Mode; /*!< Mode: Specifies the operating mode for the selected
...
typedef struct {
    ...
    uint32_t Mode; /*!< Mode: Specifies the operating mode for the selected
                      pins. This parameter can be a value of @ref PWR_PVD_Mode.
                    */
} PWR_PVDTypeDef;
 ...
 * @{
 */
#    define PWR_PVDLEVEL_RISING_0                                              \
        (0x00000000u) /*!< PVD threshold level 0 for rising detection */
#    define PWR_PVDLEVEL_RISING_1                                              \
        (PWR_CR2_PVDRT_0) /*!< PVD threshold level 1 for rising detection */
#    define PWR_PVDLEVEL_RISING_2                                              \
        (PWR_CR2_PVDRT_1) /*!< PVD threshold level 2 for rising detection */
#    define PWR_PVDLEVEL_RISING_3                                              \
        (PWR_CR2_PVDRT_0 | PWR_CR2_PVDRT_1) /*!< PVD threshold level 3 for     \
                                               rising detection */
#    define PWR_PVDLEVEL_RISING_4                                              \
        (PWR_CR2_PVDRT_2) /*!< PVD threshold level 4 for rising detection */
#    define PWR_PVDLEVEL_RISING_5                                              \
        (PWR_CR2_PVDRT_2 | PWR_CR2_PVDRT_0) /*!< PVD threshold level 5 for     \
                                               rising detection */
#    define PWR_PVDLEVEL_RISING_6                                              \
        (PWR_CR2_PVDRT_2 | PWR_CR2_PVDRT_1) /*!< PVD threshold level 6 for     \
                                               rising detection */
#    define PWR_PVDLEVEL_FALLING_0                                             \
        (0x00000000u) /*!< PVD threshold level 0 for falling detection */
#    define PWR_PVDLEVEL_FALLING_1                                             \
        (PWR_CR2_PVDFT_0) /*!< PVD threshold level 1 for falling detection */
#    define PWR_PVDLEVEL_FALLING_2                                             \
        (PWR_CR2_PVDFT_1) /*!< PVD threshold level 2 for falling detection */
#    define PWR_PVDLEVEL_FALLING_3                                             \
        (PWR_CR2_PVDFT_0 | PWR_CR2_PVDFT_1) /*!< PVD threshold level 3 for     \
                                               falling detection */
#    define PWR_PVDLEVEL_FALLING_4                                             \
        (PWR_CR2_PVDFT_2) /*!< PVD threshold level 4 for falling detection */
#    define PWR_PVDLEVEL_FALLING_5                                             \
        (PWR_CR2_PVDFT_2 | PWR_CR2_PVDFT_0) /*!< PVD threshold level 5 for     \
                                               falling detection */
#    define PWR_PVDLEVEL_FALLING_6                                             \
        (PWR_CR2_PVDFT_2 | PWR_CR2_PVDFT_1) /*!< PVD threshold level 6 for     \
                                               falling detection */
#    define PWR_PVDLEVEL_0                                                     \
        (PWR_PVDLEVEL_RISING_0 | PWR_PVDLEVEL_FALLING_0) /*!< same PVD         \
                                                            threshold level 0  \
                                                            on rising &        \
                                                            falling */
#    define PWR_PVDLEVEL_1                                                     \
        (PWR_PVDLEVEL_RISING_1 | PWR_PVDLEVEL_FALLING_1) /*!< same PVD         \
                                                            threshold level 1  \
                                                            on rising &        \
                                                            falling */
#    define PWR_PVDLEVEL_2                                                     \
        (PWR_PVDLEVEL_RISING_2 | PWR_PVDLEVEL_FALLING_2) /*!< same PVD         \
                                                            threshold level 2  \
                                                            on rising &        \
                                                            falling */
#    define PWR_PVDLEVEL_3                                                     \
        (PWR_PVDLEVEL_RISING_3 | PWR_PVDLEVEL_FALLING_3) /*!< same PVD         \
                                                            threshold level 3  \
                                                            on rising &        \
                                                            falling */
#    define PWR_PVDLEVEL_4                                                     \
        (PWR_PVDLEVEL_RISING_4 | PWR_PVDLEVEL_FALLING_4) /*!< same PVD         \
                                                            threshold level 4  \
                                                            on rising &        \
                                                            falling */
#    define PWR_PVDLEVEL_5                                                     \
        (PWR_PVDLEVEL_RISING_5 | PWR_PVDLEVEL_FALLING_5) /*!< same PVD         \
                                                            threshold level 5  \
                                                            on rising &        \
                                                            falling */
#    define PWR_PVDLEVEL_6                                                     \
        (PWR_PVDLEVEL_RISING_6 | PWR_PVDLEVEL_FALLING_6) /*!< same PVD         \
                                                            threshold level 6  \
                                                            on rising &        \
                                                            falling */
#    define PWR_PVDLEVEL_7                                                     \
        (PWR_CR2_PVDRT_2 | PWR_CR2_PVDRT_1                                     \
         | PWR_CR2_PVDRT_0) /*!< External input analog voltage (compared       \
...
#    define PWR_PVD_MODE_EVENT_RISING_FALLING                                  \
        (0x00020003u) /*!< Event Mode with Rising/Falling edge trigger         \
                         detection */
/**
 * @}
 */
...
#    define PWR_EXTI_LINE_PVD                                                  \
        (EXTI_IMR1_IM16) /*!< External interrupt line 16 connected to PVD */
/**
 * @}
 */
...
#    define PWR_EVENT_LINE_PVD                                                 \
        (EXTI_EMR1_EM16) /*!< Event line 16 connected to PVD */
/**
 * @}
 */
#endif /* PWR_PVD_SUPPORT */
 ...
 */
#    define PWR_PVM_USB                                                        \
        PWR_CR2_PVMEN_USB /*!< Peripheral Voltage Monitoring enable for USB    \
                             peripheral: Enable to keep the USB peripheral     \
                             voltage monitoring under control (power domain    \
                             Vddio2) */
/**
 * @}
 */
...
#    define PWR_PVM_MODE_NORMAL                                                \
        ((uint32_t)0x00000000) /*!< basic mode is used */
 ...
 * @{
 */
#    define PWR_EXTI_LINE_PVM                                                  \
        (EXTI_IMR2_IM34) /*!< External interrupt line 34 connected to PVM */
/**
 * @}
 */
...
#    define PWR_EVENT_LINE_PVM                                                 \
        (EXTI_EMR2_EM34) /*!< Event line 34 connected to PVM */
/**
 * @}
 */
#endif /* PWR_PVM_SUPPORT */
 ...
 * @{
 */
#define PWR_FLASHPD_LPRUN                                                      \
    PWR_CR1_FPD_LPRUN /*!< Enable Flash power down in low power run mode */
#define PWR_FLASHPD_LPSLEEP                                                    \
    PWR_CR1_FPD_LPSLP /*!< Enable Flash power down in low power sleep mode */
#define PWR_FLASHPD_STOP                                                       \
    PWR_CR1_FPD_STOP /*!< Enable Flash power down in stop mode */
/**
 * @}
 */
...
#define PWR_REGULATOR_VOLTAGE_SCALE1                                           \
    PWR_CR1_VOS_0 /*!< Voltage scaling range 1 */
 ...
 */
#if defined(PWR_PVM_SUPPORT)
#    define PWR_FLAG_PVMOUSB                                                   \
        (0x00020000u | PWR_SR2_PVMO_USB) /*!< USB Peripheral Voltage           \
                                            Monitoring output */
#endif                                   /* PWR_PVM_SUPPORT */
/**
 * @}
...
#    define __HAL_PWR_PVD_EXTI_GET_FALLING_FLAG()                              \
        (EXTI->FPR1 & PWR_EXTI_LINE_PVD)

/**
 * @brief Clear the PVD EXTI interrupt Rising flag.
 * @retval None
 */
#    define __HAL_PWR_PVD_EXTI_CLEAR_RISING_FLAG()                             \
 ...
 * @retval None
 */
#    define __HAL_PWR_PVD_EXTI_CLEAR_FALLING_FLAG()                            \
 ...
 * @retval None
 */
#    define __HAL_PWR_PVM_EXTI_ENABLE_IT()                                     \
        SET_BIT(EXTI->IMR2, PWR_EXTI_LINE_PVM)

/**
 * @brief Disable the PVM Extended Interrupt Line.
 * @retval None
 */
#    define __HAL_PWR_PVM_EXTI_DISABLE_IT()                                    \
        CLEAR_BIT(EXTI->IMR2, PWR_EXTI_LINE_PVM)

/**
 * @brief Enable the PVM Event Line.
 * @retval None
 */
#    define __HAL_PWR_PVM_EXTI_ENABLE_EVENT()                                  \
        SET_BIT(EXTI->EMR2, PWR_EVENT_LINE_PVM)

/**
 * @brief Disable the PVM Event Line.
 * @retval None
 */
#    define __HAL_PWR_PVM_EXTI_DISABLE_EVENT()                                 \
        CLEAR_BIT(EXTI->EMR2, PWR_EVENT_LINE_PVM)
...
#    define __HAL_PWR_PVM_EXTI_ENABLE_RISING_EDGE()                            \
        SET_BIT(EXTI->RTSR2, PWR_EXTI_LINE_PVM)

/**
 * @brief Disable the PVM Extended Interrupt Rising Trigger.
 * @retval None
 */
#    define __HAL_PWR_PVM_EXTI_DISABLE_RISING_EDGE()                           \
        CLEAR_BIT(EXTI->RTSR2, PWR_EXTI_LINE_PVM)

/**
 * @brief Enable the PVM Extended Interrupt Falling Trigger.
 * @retval None
 */
#    define __HAL_PWR_PVM_EXTI_ENABLE_FALLING_EDGE()                           \
        SET_BIT(EXTI->FTSR2, PWR_EXTI_LINE_PVM)

/**
 * @brief Disable the PVM Extended Interrupt Falling Trigger.
 * @retval None
 */
#    define __HAL_PWR_PVM_EXTI_DISABLE_FALLING_EDGE()                          \
        CLEAR_BIT(EXTI->FTSR2, PWR_EXTI_LINE_PVM)
 ...
 * @retval None
 */
#    define __HAL_PWR_PVM_EXTI_GENERATE_SWIT()                                 \
        SET_BIT(EXTI->SWIER2, PWR_EXTI_LINE_PVM)

/**
 * @brief Check whether or not the PVM EXTI interrupt Rising flag is set.
 * @retval EXTI PVM Line Status.
 */
#    define __HAL_PWR_PVM_EXTI_GET_RISING_FLAG()                               \
        (EXTI->RPR2 & PWR_EXTI_LINE_PVM)

/**
 * @brief Check whether or not the PVM EXTI interrupt Falling flag is set.
 * @retval EXTI PVM Line Status.
 */
#    define __HAL_PWR_PVM_EXTI_GET_FALLING_FLAG()                              \
        (EXTI->FPR2 & PWR_EXTI_LINE_PVM)

/**
 * @brief Clear the PVM EXTI interrupt Rising flag.
 * @retval None
 */
#    define __HAL_PWR_PVM_EXTI_CLEAR_RISING_FLAG()                             \
        WRITE_REG(EXTI->RPR2, PWR_EXTI_LINE_PVM)

/**
 * @brief Clear the PVM EXTI interrupt Falling flag.
 * @retval None
 */
#    define __HAL_PWR_PVM_EXTI_CLEAR_FALLING_FLAG()                            \
        WRITE_REG(EXTI->FPR2, PWR_EXTI_LINE_PVM)
#endif /* PWR_PVM_SUPPORT */
/**
 * @}
 */
...
#    define IS_PWR_GPIO(__GPIO__)                                              \
        (((__GPIO__) == PWR_GPIO_A) || ((__GPIO__) == PWR_GPIO_B)              \
         || ((__GPIO__) == PWR_GPIO_C) || ((__GPIO__) == PWR_GPIO_D)           \
         || ((__GPIO__) == PWR_GPIO_E) || ((__GPIO__) == PWR_GPIO_F))
#else
#    define IS_PWR_GPIO(__GPIO__)                                              \
        (((__GPIO__) == PWR_GPIO_A) || ((__GPIO__) == PWR_GPIO_B)              \
         || ((__GPIO__) == PWR_GPIO_C) || ((__GPIO__) == PWR_GPIO_D)           \
...
#define IS_PWR_FLASH_POWERDOWN(__MODE__)                                       \
    ((((__MODE__)                                                              \
       & (PWR_FLASHPD_LPRUN | PWR_FLASHPD_LPSLEEP | PWR_FLASHPD_STOP))         \
      != 0x00u)                                                                \
     && (((__MODE__)                                                           \
          & ~(PWR_FLASHPD_LPRUN | PWR_FLASHPD_LPSLEEP | PWR_FLASHPD_STOP))     \
         == 0x00u))
...
#    define IS_PWR_PVD_LEVEL(LEVEL)                                            \
        (((LEVEL) & ~(PWR_CR2_PVDRT | PWR_CR2_PVDFT)) == 0x00000000u)
