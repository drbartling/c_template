...
typedef struct __DMA_HandleTypeDef {
    ...
    DMAMUX_ChannelStatus_TypeDef *DMAmuxChannelStatus; /*!< DMAMUX Channels
                                                          Status Base Address */

    uint32_t DMAmuxChannelStatusMask; /*!< DMAMUX Channel Status Mask */

    DMAMUX_RequestGen_TypeDef *DMAmuxRequestGen; /*!< DMAMUX request generator
                                                    Base Address */

    DMAMUX_RequestGenStatus_TypeDef *DMAmuxRequestGenStatus; /*!< DMAMUX request
                                                                generator
                                                                Address      */

    uint32_t DMAmuxRequestGenStatusMask; /*!< DMAMUX request generator Status
                                            mask  */
} DMA_HandleTypeDef;
/**
 * @}
...
#endif                        /* AES */
#if defined(DAC1)
#    define DMA_REQUEST_DAC1_CH1                                               \
        LL_DMAMUX_REQ_DAC1_CH1 /*!< DMAMUX DAC_CH1 request     */
#    define DMA_REQUEST_DAC1_CH2                                               \
        LL_DMAMUX_REQ_DAC1_CH2 /*!< DMAMUX DAC_CH2 request     */
#endif                         /* DAC1 */
...
#define DMA_REQUEST_TIM1_TRIG_COM                                              \
    LL_DMAMUX_REQ_TIM1_TRIG_COM /*!< DMAMUX TIM1 TRIG COM request */
...
#    define DMA_REQUEST_TIM2_TRIG                                              \
        LL_DMAMUX_REQ_TIM2_TRIG /*!< DMAMUX TIM2 TRIG request   */
#    define DMA_REQUEST_TIM2_UP                                                \
        LL_DMAMUX_REQ_TIM2_UP /*!< DMAMUX TIM2 UP request     */
#endif                        /* TIM2 */
#define DMA_REQUEST_TIM3_CH1                                                   \
    LL_DMAMUX_REQ_TIM3_CH1 /*!< DMAMUX TIM3 CH1 request    */
#define DMA_REQUEST_TIM3_CH2                                                   \
    LL_DMAMUX_REQ_TIM3_CH2 /*!< DMAMUX TIM3 CH2 request    */
#define DMA_REQUEST_TIM3_CH3                                                   \
    LL_DMAMUX_REQ_TIM3_CH3 /*!< DMAMUX TIM3 CH3 request    */
#define DMA_REQUEST_TIM3_CH4                                                   \
    LL_DMAMUX_REQ_TIM3_CH4 /*!< DMAMUX TIM3 CH4 request    */
#define DMA_REQUEST_TIM3_TRIG                                                  \
    LL_DMAMUX_REQ_TIM3_TRIG /*!< DMAMUX TIM3 TRIG request   */
#define DMA_REQUEST_TIM3_UP                                                    \
    LL_DMAMUX_REQ_TIM3_UP /*!< DMAMUX TIM3 UP request     */
#if defined(TIM6)
#    define DMA_REQUEST_TIM6_UP                                                \
        LL_DMAMUX_REQ_TIM6_UP /*!< DMAMUX TIM6 UP request     */
#endif                        /* TIM6 */
#if defined(TIM7)
#    define DMA_REQUEST_TIM7_UP                                                \
        LL_DMAMUX_REQ_TIM7_UP /*!< DMAMUX TIM7 UP request     */
#endif                        /* TIM7 */
#if defined(TIM15)
#    define DMA_REQUEST_TIM15_CH1                                              \
        LL_DMAMUX_REQ_TIM15_CH1 /*!< DMAMUX TIM15 CH1 request   */
#    define DMA_REQUEST_TIM15_CH2                                              \
        LL_DMAMUX_REQ_TIM15_CH2 /*!< DMAMUX TIM15 CH2 request   */
#    define DMA_REQUEST_TIM15_TRIG_COM                                         \
        LL_DMAMUX_REQ_TIM15_TRIG_COM /*!< DMAMUX TIM15 TRIG COM request */
#    define DMA_REQUEST_TIM15_UP                                               \
...
#define DMA_REQUEST_TIM16_COM                                                  \
    LL_DMAMUX_REQ_TIM16_COM /*!< DMAMUX TIM16 COM request   */
...
#define DMA_REQUEST_TIM17_COM                                                  \
    LL_DMAMUX_REQ_TIM17_COM /*!< DMAMUX TIM17 COM request   */
...
#if defined(USART3)
#    define DMA_REQUEST_USART3_RX                                              \
        LL_DMAMUX_REQ_USART3_RX /*!< DMAMUX USART3 RX request  */
#    define DMA_REQUEST_USART3_TX                                              \
        LL_DMAMUX_REQ_USART3_TX /*!< DMAMUX USART3 TX request  */
#endif                          /* USART3 */
#if defined(USART4)
#    define DMA_REQUEST_USART4_RX                                              \
        LL_DMAMUX_REQ_USART4_RX /*!< DMAMUX USART4 RX request  */
#    define DMA_REQUEST_USART4_TX                                              \
        LL_DMAMUX_REQ_USART4_TX /*!< DMAMUX USART4 TX request  */
#endif                          /* USART4 */
#if defined(UCPD1)
#    define DMA_REQUEST_UCPD1_RX                                               \
        LL_DMAMUX_REQ_UCPD1_RX /*!< DMAMUX UCPD1 RX request  */
#    define DMA_REQUEST_UCPD1_TX                                               \
        LL_DMAMUX_REQ_UCPD1_TX /*!< DMAMUX UCPD1 TX request  */
#endif                         /* UCPD1 */
#if defined(UCPD2)
#    define DMA_REQUEST_UCPD2_RX                                               \
        LL_DMAMUX_REQ_UCPD2_RX /*!< DMAMUX UCPD2 RX request  */
#    define DMA_REQUEST_UCPD2_TX                                               \
        LL_DMAMUX_REQ_UCPD2_TX /*!< DMAMUX UCPD2 TX request  */
#endif                         /* UCPD2 */
...
#if defined(LPUART2)
#    define DMA_REQUEST_LPUART2_RX                                             \
        LL_DMAMUX_REQ_LPUART2_RX /*!< DMAMUX LPUART2 RX request  */
#    define DMA_REQUEST_LPUART2_TX                                             \
        LL_DMAMUX_REQ_LPUART2_TX /*!< DMAMUX LPUART2 TX request  */
#endif                           /* LPUART2 */

#if defined(SPI3)
#    define DMA_REQUEST_SPI3_RX                                                \
        LL_DMAMUX_REQ_SPI3_RX /*!< DMAMUX SPI3 RX request     */
#    define DMA_REQUEST_SPI3_TX                                                \
        LL_DMAMUX_REQ_SPI3_TX /*!< DMAMUX SPI3 TX request     */
#endif                        /* SPI3 */

#if defined(TIM4)
#    define DMA_REQUEST_TIM4_CH1                                               \
        LL_DMAMUX_REQ_TIM4_CH1 /*!< DMAMUX TIM4 CH1 request    */
#    define DMA_REQUEST_TIM4_CH2                                               \
        LL_DMAMUX_REQ_TIM4_CH2 /*!< DMAMUX TIM4 CH2 request    */
#    define DMA_REQUEST_TIM4_CH3                                               \
        LL_DMAMUX_REQ_TIM4_CH3 /*!< DMAMUX TIM4 CH3 request    */
#    define DMA_REQUEST_TIM4_CH4                                               \
        LL_DMAMUX_REQ_TIM4_CH4 /*!< DMAMUX TIM4 CH4 request    */
#    define DMA_REQUEST_TIM4_TRIG                                              \
        LL_DMAMUX_REQ_TIM4_TRIG /*!< DMAMUX TIM4 TRIG request   */
#    define DMA_REQUEST_TIM4_UP                                                \
        LL_DMAMUX_REQ_TIM4_UP /*!< DMAMUX TIM4 UP request     */
#endif                        /* TIM4 */

#if defined(USART5)
#    define DMA_REQUEST_USART5_RX                                              \
        LL_DMAMUX_REQ_USART5_RX /*!< DMAMUX USART5 RX request  */
#    define DMA_REQUEST_USART5_TX                                              \
        LL_DMAMUX_REQ_USART5_TX /*!< DMAMUX USART5 TX request  */
#endif                          /* USART5 */

#if defined(USART6)
#    define DMA_REQUEST_USART6_RX                                              \
        LL_DMAMUX_REQ_USART6_RX /*!< DMAMUX USART6 RX request  */
#    define DMA_REQUEST_USART6_TX                                              \
        LL_DMAMUX_REQ_USART6_TX /*!< DMAMUX USART6 TX request  */
#endif                          /* USART6 */
...
#    define DMA_FLAG_GI6                                                       \
        DMA_ISR_GIF6 /*!< Global Interrupt flag for Channel 6  */
#    define DMA_FLAG_TC6                                                       \
        DMA_ISR_TCIF6 /*!< Transfer Complete flag for Channel 6 */
#    define DMA_FLAG_HT6                                                       \
        DMA_ISR_HTIF6 /*!< Half Transfer flag for Channel 6     */
#    define DMA_FLAG_TE6                                                       \
        DMA_ISR_TEIF6 /*!< Transfer Error flag for Channel 6    */
#endif                /* DMA1_Channel6 */
#if defined(DMA1_Channel7)
#    define DMA_FLAG_GI7                                                       \
        DMA_ISR_GIF7 /*!< Global Interrupt flag for Channel 7  */
#    define DMA_FLAG_TC7                                                       \
        DMA_ISR_TCIF7 /*!< Transfer Complete flag for Channel 7 */
#    define DMA_FLAG_HT7                                                       \
        DMA_ISR_HTIF7 /*!< Half Transfer flag for Channel 7     */
#    define DMA_FLAG_TE7                                                       \
        DMA_ISR_TEIF7 /*!< Transfer Error flag for Channel 7    */
#endif                /* DMA1_Channel7 */
/**
 * @}
 */
