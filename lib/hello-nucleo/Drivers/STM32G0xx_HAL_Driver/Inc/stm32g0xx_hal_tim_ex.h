...
#define TIM_TIM1_ETR_ADC1_AWD1                                                 \
    (TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_0) /* !< TIM1_ETR is connected to     \
                                               ADC1 AWD1 */
#define TIM_TIM1_ETR_ADC1_AWD2                                                 \
    TIM1_AF1_ETRSEL_2 /* !< TIM1_ETR is connected to ADC1 AWD2 */
#define TIM_TIM1_ETR_ADC1_AWD3                                                 \
    (TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_0) /* !< TIM1_ETR is connected to     \
                                               ADC1 AWD3 */
#if defined(COMP3)
#    define TIM_TIM1_ETR_COMP3                                                 \
        (TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_1) /* !< TIM1_ETR is connected to \
                                                   COMP3 output */
#endif                                          /* COMP3 */
#if defined(TIM2)
#    define TIM_TIM2_ETR_GPIO                                                  \
        0x00000000U /* !< TIM2_ETR is connected to GPIO      */
...
#    define TIM_TIM2_ETR_LSE                                                   \
        (TIM2_AF1_ETRSEL_1 | TIM2_AF1_ETRSEL_0) /* !< TIM2_ETR is connected to \
                                                   LSE */
#    if defined(COMP3)
#        define TIM_TIM2_ETR_MCO                                               \
            TIM2_AF1_ETRSEL_2 /* !< TIM2_ETR is connected to MCO */
#        define TIM_TIM2_ETR_MCO2                                              \
            (TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_0) /* !< TIM2_ETR is          \
                                                       connected to MCO2 */
#        define TIM_TIM2_ETR_COMP3                                             \
            (TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_1) /* !< TIM2_ETR is          \
                                                       connected to COMP3      \
                                                       output */
#    endif                                          /* COMP3 */
#endif                                              /*  TIM2 */
#if defined(TIM3)
#    define TIM_TIM3_ETR_GPIO                                                  \
        0x00000000U /* !< TIM3_ETR is connected to GPIO                        \
                     */
#    if defined(COMP1) && defined(COMP2)
#        define TIM_TIM3_ETR_COMP1                                             \
            TIM3_AF1_ETRSEL_0 /* !< TIM3_ETR is connected to COMP1 output */
#        define TIM_TIM3_ETR_COMP2                                             \
            TIM3_AF1_ETRSEL_1 /* !< TIM3_ETR is connected to COMP2 output */
#    endif                    /* COMP1 && COMP2 */
#    if defined(COMP3)
#        define TIM_TIM3_ETR_COMP3                                             \
            (TIM3_AF1_ETRSEL_1 | TIM3_AF1_ETRSEL_0) /* !< TIM3_ETR is          \
                                                       connected to COMP3      \
                                                       output */
#    endif                                          /* COMP3 */
#endif                                              /* TIM3 */
#if defined(TIM4)
#    define TIM_TIM4_ETR_GPIO                                                  \
        0x00000000U /* !< TIM4_ETR is connected to GPIO                        \
                     */
#    if defined(COMP1) && defined(COMP2)
#        define TIM_TIM4_ETR_COMP1                                             \
            TIM4_AF1_ETRSEL_0 /* !< TIM4_ETR is connected to COMP1 output */
#        define TIM_TIM4_ETR_COMP2                                             \
            TIM4_AF1_ETRSEL_1 /* !< TIM4_ETR is connected to COMP2 output */
#    endif                    /* COMP1 && COMP2 */
#    if defined(COMP3)
#        define TIM_TIM4_ETR_COMP3                                             \
            (TIM4_AF1_ETRSEL_1 | TIM4_AF1_ETRSEL_0) /* !< TIM4_ETR is          \
                                                       connected to COMP3      \
                                                       output */
#    endif                                          /* COMP3 */
#endif                                              /* TIM4 */
...
#    define TIM_TIM1_TI1_COMP1                                                 \
        0x00000001U /* !< TIM1_TI1 is connected to COMP1 OUT */
#endif              /* COMP1 */

#define TIM_TIM1_TI2_GPIO 0x00000000U /* !< TIM1_TI2 is connected to GPIO */
#if defined(COMP2)
#    define TIM_TIM1_TI2_COMP2                                                 \
        0x00000100U /* !< TIM1_TI2 is connected to COMP2 OUT */
#endif              /* COMP2 */

#define TIM_TIM1_TI3_GPIO 0x00000000U /* !< TIM1_TI3 is connected to GPIO */
#if defined(COMP3)
#    define TIM_TIM1_TI3_COMP3                                                 \
        0x00010000U /* !< TIM1_TI3 is connected to COMP3 OUT */
#endif              /* COMP3 */

#if defined(TIM2)
#    define TIM_TIM2_TI1_GPIO                                                  \
        0x00000000U /* !< TIM2_TI1 is connected to GPIO                        \
                     */
#    define TIM_TIM2_TI1_COMP1                                                 \
        0x00000001U /* !< TIM2_TI1 is connected to COMP1 OUT */

#    define TIM_TIM2_TI2_GPIO                                                  \
        0x00000000U /* !< TIM2_TI2 is connected to GPIO                        \
                     */
#    define TIM_TIM2_TI2_COMP2                                                 \
        0x00000100U /* !< TIM2_TI2 is connected to COMP2 OUT */

#    define TIM_TIM2_TI3_GPIO                                                  \
        0x00000000U /* !< TIM2_TI3 is connected to GPIO                        \
                     */
#    if defined(COMP3)
#        define TIM_TIM2_TI3_COMP3                                             \
            0x00010000U /* !< TIM2_TI3 is connected to COMP3 OUT */
#    endif              /* COMP3 */
#endif                  /* TIM2 */
...
#    define TIM_TIM3_TI1_COMP1                                                 \
        0x00000001U /* !< TIM3_TI1 is connected to COMP1 OUT */
#endif              /* COMP1 */

#define TIM_TIM3_TI2_GPIO 0x00000000U /* !< TIM3_TI2 is connected to GPIO */
#if defined(COMP2)
#    define TIM_TIM3_TI2_COMP2                                                 \
        0x00000100U /* !< TIM3_TI2 is connected to COMP2 OUT */
#endif              /* COMP2 */

#define TIM_TIM3_TI3_GPIO 0x00000000U /* !< TIM3_TI3 is connected to GPIO */
#if defined(COMP3)
#    define TIM_TIM3_TI3_COMP3                                                 \
        0x00010000U /* !< TIM3_TI3 is connected to COMP3 OUT */
#endif              /* COMP3 */

#if defined(TIM4)
#    define TIM_TIM4_TI1_GPIO                                                  \
        0x00000000U /* !< TIM4_TI1 is connected to GPIO                        \
                     */
#    if defined(COMP1)
#        define TIM_TIM4_TI1_COMP1                                             \
            0x00000001U /* !< TIM4_TI1 is connected to COMP1 OUT */
#    endif              /* COMP1 */

#    define TIM_TIM4_TI2_GPIO                                                  \
        0x00000000U /* !< TIM4_TI2 is connected to GPIO                        \
                     */
#    if defined(COMP2)
#        define TIM_TIM4_TI2_COMP2                                             \
            0x00000100U /* !< TIM4_TI2 is connected to COMP2 OUT */
#    endif              /* COMP2 */

#    define TIM_TIM4_TI3_GPIO                                                  \
        0x00000000U /* !< TIM4_TI3 is connected to GPIO                        \
                     */
#    if defined(COMP3)
#        define TIM_TIM4_TI3_COMP3                                             \
            0x00010000U /* !< TIM4_TI3 is connected to COMP3 OUT */
#    endif              /* COMP3 */
#endif                  /* TIM4 */

#define TIM_TIM14_TI1_GPIO 0x00000000U /* !< TIM14_TI1 is connected to GPIO */
#define TIM_TIM14_TI1_RTC                                                      \
    0x00000001U /* !< TIM14_TI1 is connected to RTC clock */
#define TIM_TIM14_TI1_HSE_32                                                   \
    0x00000002U /* !< TIM14_TI1 is connected to HSE div 32 */
#define TIM_TIM14_TI1_MCO 0x00000003U /* !< TIM14_TI1 is connected to MCO */
#if defined(RCC_MCO2_SUPPORT)
#    define TIM_TIM14_TI1_MCO2                                                 \
        0x00000004U /* !< TIM14_TI1 is connected to MCO2 */
#endif

#if defined(TIM15)
#    define TIM_TIM15_TI1_GPIO                                                 \
        0x00000000U /* !< TIM15_TI1 is connected to GPIO */
#    define TIM_TIM15_TI1_TIM2_CH1                                             \
        0x00000001U /* !< TIM15_TI1 is connected to TIM2 CH1 */
#    define TIM_TIM15_TI1_TIM3_CH1                                             \
        0x00000002U /* !< TIM15_TI1 is connected to TIM3 CH1 */

#    define TIM_TIM15_TI2_GPIO                                                 \
        0x00000000U /* !< TIM15_TI2 is connected to GPIO */
#    define TIM_TIM15_TI2_TIM2_CH2                                             \
        0x00000100U /* !< TIM15_TI2 is connected to TIM2 CH2 */
#    define TIM_TIM15_TI2_TIM3_CH2                                             \
        0x00000200U /* !< TIM15_TI2 is connected to TIM3 CH2 */
#endif              /* TIM15 */
...
#define TIM_TIM16_TI1_RTC_WAKEUP                                               \
    0x00000003U /* !< TIM16_TI1 is connected to TRC wakeup interrupt */
#if defined(RCC_MCO2_SUPPORT)
#    define TIM_TIM16_TI1_MCO2                                                 \
        0x00000004U /* !< TIM16_TI1 is connected to MCO2 */
#endif              /* RCC_MCO2_SUPPORT */

#define TIM_TIM17_TI1_GPIO 0x00000000U /* !< TIM17_TI1 is connected to GPIO */
#if defined(RCC_HSI48_SUPPORT)
#    define TIM_TIM17_TI1_HSI48                                                \
        0x00000001U /* !< TIM17_TI1 is connected to HSI48/256 */
#endif              /* RCC_HSI48_SUPPORT */
#define TIM_TIM17_TI1_HSE_32                                                   \
    0x00000002U /* !< TIM17_TI1 is connected to HSE div 32 */
#define TIM_TIM17_TI1_MCO 0x00000003U /* !< TIM17_TI1 is connected to MCO */
#if defined(RCC_MCO2_SUPPORT)
#    define TIM_TIM17_TI1_MCO2                                                 \
        0x00000004U /* !< TIM17_TI1 is connected to MCO2 */
#endif              /* RCC_MCO2_SUPPORT */
/**
 * @}
 */
