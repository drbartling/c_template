...
typedef struct {
    ...
    uint32_t Alternate; /*!< Specifies the Peripheral to be connected to the
                           ...
                           GPIO_LL_EC_AF.
                             ...
                             GPIO HW configuration can be modified afterwards
                           using unitary function @ref LL_GPIO_SetAFPin_0_7()
                           and LL_GPIO_SetAFPin_8_15().*/
} LL_GPIO_InitTypeDef;
...
#        define LL_GPIO_AF_10                                                  \
            (0x000000AU) /*!< Select alternate function 10                     \
                          */
 ...
 */
#    define LL_GPIO_ReadReg(__INSTANCE__, __REG__)                             \
...
LL_GPIO_GetPinMode(GPIO_TypeDef *GPIOx, uint32_t Pin)
{
 ...
 */
__STATIC_INLINE void
LL_GPIO_SetPinOutputType(GPIO_TypeDef *GPIOx, uint32_t PinMask,
                         uint32_t OutputType)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_GPIO_GetPinOutputType(GPIO_TypeDef *GPIOx, uint32_t Pin)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_GPIO_GetPinSpeed(GPIO_TypeDef *GPIOx, uint32_t Pin)
{
    return (
        uint32_t)(READ_BIT(GPIOx->OSPEEDR, ((Pin * Pin) * GPIO_OSPEEDR_OSPEED0))
                  / (Pin * Pin));
}
 ...
 */
__STATIC_INLINE void
LL_GPIO_SetPinPull(GPIO_TypeDef *GPIOx, uint32_t Pin, uint32_t Pull)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_GPIO_GetPinPull(GPIO_TypeDef *GPIOx, uint32_t Pin)
{
 ...
 */
__STATIC_INLINE void
LL_GPIO_SetAFPin_0_7(GPIO_TypeDef *GPIOx, uint32_t Pin, uint32_t Alternate)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_GPIO_GetAFPin_0_7(GPIO_TypeDef *GPIOx, uint32_t Pin)
{
 ...
 */
__STATIC_INLINE void
LL_GPIO_SetAFPin_8_15(GPIO_TypeDef *GPIOx, uint32_t Pin, uint32_t Alternate)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_GPIO_GetAFPin_8_15(GPIO_TypeDef *GPIOx, uint32_t Pin)
{
 ...
 */
__STATIC_INLINE void
LL_GPIO_LockPin(GPIO_TypeDef *GPIOx, uint32_t PinMask)
{
    __IO uint32_t temp;
 ...
 */
__STATIC_INLINE uint32_t
LL_GPIO_IsPinLocked(GPIO_TypeDef *GPIOx, uint32_t PinMask)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_GPIO_IsAnyPinLocked(GPIO_TypeDef *GPIOx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_GPIO_IsOutputPinSet(GPIO_TypeDef *GPIOx, uint32_t PinMask)
{
